    ...
    implements cbit.vcell.solvers.SolverController, java.rmi.Remote
{
	...
	throws cbit.vcell.server.DataAccessException, cbit.vcell.solver.SolverNotRunningException, java.rmi.RemoteException
    {
	try {
	...
	throws cbit.vcell.server.DataAccessException, cbit.vcell.solvers.SimExecutionException, java.rmi.RemoteException
    {
	try {
