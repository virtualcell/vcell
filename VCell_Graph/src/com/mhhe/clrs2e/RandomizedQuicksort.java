...
/**
 * Implements the {@link Sorter} interface via randomized quicksort
...
class RandomizedQuicksort extends Quicksort implements Sorter
{
    ...
    {
	part = new RandomizedPartitioner();    // use a randomized partitioner
	quicksort(array, 0, array.length - 1); // sort using it
    }
}

// $Id: RandomizedQuicksort.java,v 1.1 2003/10/14 16:56:20 thc Exp $
// $Log: RandomizedQuicksort.java,v $
