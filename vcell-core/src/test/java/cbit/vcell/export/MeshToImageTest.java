...
public class MeshToImageTest {
    ...
    public void testMeshToImage2D(){
        ...
        MeshToImage.ImageData result = MeshToImage.convertMeshIntoImage(exampleData, 3, 4, 0, false);
    ...
    public void testMeshToImage3D(){
        ...
        MeshToImage.ImageData result = MeshToImage.convertMeshIntoImage(exampleData, 2, 3, 4, true);
    ...
    public void testFullRound(){
        ...
        MeshToImage.ImageData imageResult = MeshToImage.convertMeshIntoImage(exampleMesh, 4, 5, 1, false);
        MeshToImage.MeshData meshResult = MeshToImage.convertImageIntoMesh(imageResult.data(), 6, 8, 1, false);
