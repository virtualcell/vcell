 ...
 * @author: Jim Schaff
 */
public class StandardSimulationTask implements SimulationTask {
	private SimulationJob simulationJob = null;
	private int taskID = 0;
	private String computeResource = null;
	private boolean isPowerUser = false;

public StandardSimulationTask(SimulationJob argSimulationJob, int tid) {
	this(argSimulationJob, tid, null,false);
}

public StandardSimulationTask(SimulationJob argSimulationJob, int tid, String comres, boolean isPowerUser) {
 ...
 * @return cbit.vcell.solver.simulation.SimulationJob
 */
...
public boolean compareEqual(Matchable obj) {
	if (obj instanceof StandardSimulationTask){
		StandardSimulationTask other = (StandardSimulationTask)obj;
