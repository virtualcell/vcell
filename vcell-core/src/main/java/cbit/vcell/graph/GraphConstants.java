...
public class GraphConstants {
	...
	public static final int ReactionRuleDisplay_ReservedSpaceForNameOnYAxis = 10;
	public static final int ReactionRuleParticipantDisplay_ReservedSpaceForNameOnYAxis = 16;
	public static final int ObservableDisplay_ReservedSpaceForNameOnYAxis = 2;	// just a little empty spacing above the shape
	...
	public static Color[] bondHtmlColors = {null, 
			GraphConstants.blue,
			GraphConstants.blueviolet,
			GraphConstants.brown,
			GraphConstants.burlywood ,
			GraphConstants.cadetblue,
			GraphConstants.chocolate,
			GraphConstants.coral,
			GraphConstants.cornflowerblue,
			GraphConstants.crimson,
			GraphConstants.darkblue,
			GraphConstants.darkcyan,
			GraphConstants.darkgoldenrod,
			GraphConstants.darkgreen,
			GraphConstants.darkmagenta,
			GraphConstants.darkolivegreen,
			GraphConstants.darkorange,
			GraphConstants.darkorange,
			GraphConstants.darkorchid,
			GraphConstants.darkred,
			GraphConstants.darksalmon,
			GraphConstants.darkviolet,
			GraphConstants.deeppink,
			GraphConstants.deepskyblue,
			GraphConstants.dodgerblue,
			GraphConstants.firebrick,
			GraphConstants.forestgreen,
			GraphConstants.fuchsia,
			GraphConstants.goldenrod,
			GraphConstants.green,
			GraphConstants.hotpink,
			GraphConstants.indianred ,
			GraphConstants.indigo ,
			GraphConstants.magenta,
			GraphConstants.maroon,
			GraphConstants.mediumblue,
			GraphConstants.mediumorchid,
			GraphConstants.mediumseagreen,
			GraphConstants.mediumvioletred,
			GraphConstants.orange,
			GraphConstants.orangered,
			GraphConstants.royalblue,
			GraphConstants.saddlebrown,
			GraphConstants.salmon,
			GraphConstants.seagreen,
			GraphConstants.sienna,
			GraphConstants.steelblue,
			GraphConstants.teal,
			GraphConstants.tomato,
		};
}
