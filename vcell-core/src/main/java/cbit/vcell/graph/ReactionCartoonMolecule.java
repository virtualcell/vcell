...
//				}
    ...
    protected void refreshAll(boolean reallocateShapes) {
        try {
            ...
            for (ReactionStep rs : this.getModel().getReactionSteps()) {
            ...
            ContainerContainerShape containerShape = (ContainerContainerShape) this.getShapeFromModelObject(this.getModel());
            List<ReactionContainerShape> reactionContainerShapeList =
                    new ArrayList<ReactionContainerShape>();
            List<Structure> structureList = new ArrayList<Structure>(this.getStructureSuite().getStructures());
            ...
            for (Structure structure : structureList) {
                if (structure instanceof Membrane membrane) {
                    ReactionContainerShape membraneShape =
                            (ReactionContainerShape) this.getShapeFromModelObject(membrane);
                    if (membraneShape == null) {
                        membraneShape = new ReactionContainerShape(membrane, this.structureSuite, this);
                        this.addShape(membraneShape);
                        membrane.getMembraneVoltage().removePropertyChangeListener(this);
                        membrane.getMembraneVoltage().addPropertyChangeListener(this);
                    } else {
                        membraneShape.setStructureSuite(this.structureSuite);
                    }
                ...
                } else if (structure instanceof Feature feature) {
                    ReactionContainerShape featureShape = (ReactionContainerShape) this.getShapeFromModelObject(feature);
                    if (featureShape == null) {
                        featureShape = new ReactionContainerShape(feature, this.structureSuite, this);
                        this.addShape(featureShape);
                    } else {
                        featureShape.setStructureSuite(this.structureSuite);
                    }
            ...
            if (containerShape == null) {
                containerShape = new ContainerContainerShape(this, this.getModel(), reactionContainerShapeList);
                this.addShape(containerShape);
            } else {
            ...
            for (Structure structure : this.getStructureSuite().getStructures()) {
                ReactionContainerShape reactionContainerShape = (ReactionContainerShape) this.getShapeFromModelObject(structure);
                structure.removePropertyChangeListener(this);
                structure.addPropertyChangeListener(this);
                for (SpeciesContext structSpeciesContext : this.getModel().getSpeciesContexts(structure)) {
                    SpeciesContextShape ss = (SpeciesContextShape) this.getShapeFromModelObject(structSpeciesContext);
                    if (ss == null) {
                    ...
                    if (this.speciesSizeOption == SpeciesSizeOptions.weight) {
                        ...
                        ss.setFilters(this.highlightCatalystOption && scCatalystSet.contains(structSpeciesContext), weight);
                    } else if (this.speciesSizeOption == SpeciesSizeOptions.length) {
                        Integer length = null;
                        ...
                        ss.setFilters(this.highlightCatalystOption && scCatalystSet.contains(structSpeciesContext), length);
                    } else {
                        ss.setFilters(this.highlightCatalystOption && scCatalystSet.contains(structSpeciesContext), null);
                    }
            ...
            // =================================== Rules ================================================
            //
            for (ReactionRule rr : this.getModel().getRbmModelContainer().getReactionRuleList()) {
                rr.removePropertyChangeListener(this);
                rr.addPropertyChangeListener(this);
                Structure structure = rr.getStructure();
                if (this.getStructureSuite().areReactionsShownFor(structure)) {
                    ReactionContainerShape reactionContainerShape = (ReactionContainerShape) this.getShapeFromModelObject(structure);
                    ReactionRuleFullDiagramShape rrShape = (ReactionRuleFullDiagramShape) this.getShapeFromModelObject(rr);
                    if (rrShape == null) {
                        rrShape = new ReactionRuleFullDiagramShape(rr, this);
                        this.addShape(rrShape);
                    ...
                    for (ReactionRuleParticipant participant : participants) {
                        ...
                        if (this.getStructureSuite().getStructures().contains(speciesStructure) && this.getStructureSuite().areReactionsShownFor(reactionStructure)) {
                            //
                            ...
                            if (ruleParticipantShortSignature == null) {
                                ...
                                this.ruleParticipantSignatures.add(ruleParticipantShortSignature);
                                signatureShape = new RuleParticipantSignatureShortDiagramShape(ruleParticipantShortSignature, this);
                                this.addShape(signatureShape);
                                ReactionContainerShape participantContainerShape = (ReactionContainerShape) this.getShapeFromModelObject(participant.getStructure());
                                ...
                                signatureShape = (RuleParticipantSignatureShortDiagramShape) this.getShapeFromModelObject(ruleParticipantShortSignature);
                            }
                            ...
                            //
                            RuleParticipantEdgeDiagramShape ruleParticipantShape = (RuleParticipantEdgeDiagramShape) this.getShapeFromModelObject(participant);
                            if (ruleParticipantShape == null || ruleParticipantShape.getRuleParticipantSignatureShape() != signatureShape) {
                                ...
                                this.addShape(ruleParticipantShape);
                            }
...
//			}
            ...
            for (ReactionStep reactionStep : this.getModel().getReactionSteps()) {
                ...
                if (this.getStructureSuite().areReactionsShownFor(structure)) {
                    ...
                    ReactionStepShape reactionStepShape = (ReactionStepShape) this.getShapeFromModelObject(reactionStep);
                    if (reactionStepShape == null) {
                        if (reactionStep instanceof SimpleReaction) {
                            ...
                            throw new RuntimeException("unknown type of ReactionStep '" + reactionStep.getClass());
                        }
                        this.addShape(reactionStepShape);
                    ...
                    for (ReactionParticipant participant : reactionStep.getReactionParticipants()) {
                        ...
                        if (this.getStructureSuite().getStructures().contains(speciesStructure) &&
                                this.getStructureSuite().areReactionsShownFor(reactionStructure)) {
                            SpeciesContext speciesContext = this.getModel().getSpeciesContext(participant.getSpecies(), speciesStructure);
                            ...
                            SpeciesContextShape speciesContextShape =
                                    (SpeciesContextShape) this.getShapeFromModelObject(speciesContext);
                            if (speciesContextShape == null) {
                                ...
                                this.addShape(speciesContextShape);
                            ...
                            ReactionParticipantShape reactionParticipantShape = (ReactionParticipantShape) this.getShapeFromModelObject(participant);
                            if (reactionParticipantShape == null) {
                                ...
                                this.addShape(reactionParticipantShape);
                            }
            ...
            for (Structure structure : this.structureSuite.getStructures()) {
                Diagram diagram = this.getModel().getDiagram(structure);
                if (diagram != null) {
                    this.applyDefaults(diagram);
                }
            }
            this.fireGraphChanged(new GraphEvent(this));
        } catch (Exception e) {
