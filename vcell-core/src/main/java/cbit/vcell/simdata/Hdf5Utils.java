...
//	}
	public static void insertStrings(int hdf5GroupID,String dataspaceName,long[] dims,ArrayList<String> data) throws NullPointerException, HDF5Exception {
		int largestStrLen = 0;
...
//			return new HDF5WriteHelper(hdf5DataspaceIDValues,hdf5DatasetIDValues);
//		}else 
//			if(data instanceof Object[] && ((Object[])data).length == 7 /*&& ((Object[])data)[0] instanceof Integer*/ && ((Object[])data)[0] instanceof double[] && ((Object[])data)[1] instanceof long[] && ((Object[])data)[2] instanceof long[] && ((Object[])data)[3] instanceof long[] && ((Object[])data)[4] instanceof long[] && ((Object[])data)[5] instanceof long[] && ((Object[])data)[6] instanceof Integer) {
...
//			return H5.H5Gcreate(hdf5GroupID, (String)dataspaceName,HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT, HDF5Constants.H5P_DEFAULT);
//		} else 
//		if(bAttribute && (data instanceof String || (data instanceof List && ((List<?>)data).get(0) instanceof String))) {
//			String[] attr = null;
