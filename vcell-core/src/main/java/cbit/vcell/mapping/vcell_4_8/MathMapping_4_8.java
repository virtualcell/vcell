...
public class MathMapping_4_8 implements ScopedSymbolTable, UnitFactorProvider, IssueSource {
    ...
    MathMapping_4_8.MathMappingParameter addMathMappingParameter(String name, Expression expression, int role, VCUnitDefinition unitDefinition) throws java.beans.PropertyVetoException, ExpressionBindingException{
        ...
        MathMapping_4_8.MathMappingParameter[] newParameters = ArrayUtils.addElement(fieldMathMappingParameters, newParameter);
...
//System.out.println("MathMapping.refresh()");
    ...
    private void refreshKFluxParameters() throws ExpressionException{
        ...
        for(StructureMapping structureMapping : structureMappings){
            if(structureMapping instanceof MembraneMapping membraneMapping && !getResolved(structureMapping)){
                //
                ...
                newMathMappingParameters = ArrayUtils.addElement(newMathMappingParameters, insideKFluxParameter);
                ...
                newMathMappingParameters = ArrayUtils.addElement(newMathMappingParameters, outsideKFluxParameter);
            }
        }
        try {
