...
public abstract class AbstractMathMapping implements ScopedSymbolTable, UnitFactorProvider, IssueSource, MathMapping {
    ...
    public static final String MATH_FUNC_SUFFIX_SPECIES_INIT_COUNT = MathNamingConventions.MATH_FUNC_SUFFIX_SPECIES_INIT_COUNT;
    public static final String MATH_FUNC_SUFFIX_SPECIES_INIT_COUNT_template_replace = MathNamingConventions.MATH_FUNC_SUFFIX_SPECIES_INIT_COUNT_TEMPLATE_REPLACE;
    public static final String PARAMETER_PROBABLIITY_RATE_SUFFIX = "_probabilityRate";
    public static final String PARAMETER_VELOCITY_X_SUFFIX = MathNamingConventions.PARAMETER_VELOCITY_X_SUFFIX;
    public static final String PARAMETER_VELOCITY_Y_SUFFIX = MathNamingConventions.PARAMETER_VELOCITY_Y_SUFFIX;
    public static final String PARAMETER_VELOCITY_Z_SUFFIX = MathNamingConventions.PARAMETER_VELOCITY_Z_SUFFIX;
    public static final String PARAMETER_DIFFUSION_RATE_SUFFIX = MathNamingConventions.PARAMETER_DIFFUSION_RATE_SUFFIX;
