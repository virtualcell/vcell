 ...
 */
public LocalUserMetaDbServerMessaging(UserLoginInfo userLoginInfo, RpcSender rpcSender, SessionLog sessionLog) {
	this.log = sessionLog;
	this.dbServerProxy = new RpcDbServerProxy(userLoginInfo, rpcSender, log);
}
