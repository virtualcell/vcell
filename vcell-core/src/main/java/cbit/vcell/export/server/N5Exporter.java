...
public class N5Exporter implements ExportConstants {
	...
	private ExportOutput exportToN5(OutputContext outputContext, long jobID, N5Specs n5Specs, ExportSpecs exportSpecs, AltFileDataContainerManager fileDataContainerManager) throws MathException, DataAccessException, IOException {
 ...
 * @throws IOException
 */
	public ExportOutput makeN5Data(OutputContext outputContext, JobRequest jobRequest, ExportSpecs exportSpecs, AltFileDataContainerManager fileDataContainerManager)
	...
	public ExportOutput makeN5Data(OutputContext outputContext, long jobID, ExportSpecs exportSpecs, AltFileDataContainerManager fileDataContainerManager)
			throws DataAccessException, IOException, MathException {
		FormatSpecificSpecs formatSpecs = exportSpecs.getFormatSpecificSpecs( );
		if (formatSpecs instanceof N5Specs n5Specs) {
			return exportToN5(
