...
public class GifExportEventGenerator extends GeneralExportEventGenerator {
    private final IMGExporter imgExporter;

    public GifExportEventGenerator(ExportEventCommander eeCommander, ExportServiceImpl exportService){
        super(eeCommander);
