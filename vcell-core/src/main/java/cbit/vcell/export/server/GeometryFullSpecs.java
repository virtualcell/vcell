...
public class GeometryFullSpecs  extends GeometrySpecs {
    private final static Logger lg = LogManager.getLogger(GeometryFullSpecs.class);
    public GeometryFullSpecs(SpatialSelection[] selections, int axis, int sliceNumber) {
    ...
    public boolean equals(Object object) {
        return object instanceof GeometryFullSpecs && super.equals(object);
    }
    ...
    public int[] getPointIndexes() {
        // NB: this seems wrong to me, but this is based off of the previous implementation, so...I guess?
        throw new RuntimeException("GeometrySpecs.getPointIndexes() shouldn't be called for a Geometry Full Specs");
    }
    public int getPointCount(){
        throw new RuntimeException("GeometrySpecs.getPointCount() shouldn't be called for a Geometry Full Specs");
    }
    public SpatialSelection[] getPointSpatialSelections(){
        throw new RuntimeException("GeometrySpecs.getPoints() shouldn't be called for a Geometry Full Specs");
    }
