...
public class JpegExportEventGenerator extends GeneralExportEventGenerator {

    private final IMGExporter imgExporter;

    public JpegExportEventGenerator(ExportEventCommander eeCommander, ExportServiceImpl exportService){
        super(eeCommander);
    ...
    protected ExportEvent createDataAndMakeRemoteFile(OutputContext outputContext, JobRequest newExportJob, User user,
        ...
        ExportOutput[] exportOutputs = this.imgExporter.makeMediaData(outputContext,newExportJob, user, dataServer,
