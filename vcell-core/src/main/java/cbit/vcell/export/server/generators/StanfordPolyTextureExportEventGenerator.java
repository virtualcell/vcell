...
public class StanfordPolyTextureExportEventGenerator extends GeneralExportEventGenerator {
    private final RasterExporter rrExporter;

    public StanfordPolyTextureExportEventGenerator(ExportEventCommander eeCommander, ExportServiceImpl exportService){
        super(eeCommander);
    ...
    protected ExportEvent createDataAndMakeRemoteFile(OutputContext outputContext, JobRequest newExportJob, User user,
        ...
        ExportOutput[] exportOutputs = rrExporter.makePLYWithTexData(outputContext,newExportJob, user, dataServer,
