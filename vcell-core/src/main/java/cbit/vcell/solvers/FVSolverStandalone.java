...
public class FVSolverStandalone extends AbstractCompiledSolver {
    private static final Logger lg = LogManager.getLogger(FVSolverStandalone.class);
    ...
    public Geometry getResampledGeometry() throws SolverException{
        if(resampledGeometry == null){
            ...
            try {
                resampledGeometry = XmlUtil.cloneGeometry(simTask.getSimulation().getMathDescription().getGeometry());
