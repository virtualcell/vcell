...
*/
    ...
    protected ByteArrayOutputStream generateGeometryImage(Geometry geom) throws Exception {
        ...
        return encodeJPEG(newBufferedImage);
    }
...
*/
    ...
    protected ByteArrayOutputStream generateStructureMappingImage(SimulationContext simContext, int width, int height) throws Exception {
        ...
        return encodeJPEG(bufferedImage);
    }
    ...
    private boolean hasReactions(Model model, Structure struct) {
        ...
        for (ReactionStep r : rs) {
            if (r.getStructure().getName().equals(struct.getName())) {
                return true;
            }
        }
    ...
    public static boolean isValidResolutionSetting(String resolution) {

        return HIGH_RESOLUTION.equals(resolution) || MEDIUM_RESOLUTION.equals(resolution) || LOW_RESOLUTION.equals(resolution);
    }
        ...
        for (int i = 0; i < model.getNumStructures(); i++) {
            ...
            for (ReactionStep reactionStep : reactionSteps) {
                if (reactionStep.getStructure() == model.getStructure(i)) {         //can also use structureName1.equals(structureName2)
                    ...
                    Vector<ReactionParticipant> modifiersVector = new Vector<>();
