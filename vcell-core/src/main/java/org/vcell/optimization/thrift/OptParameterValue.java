...
public class OptParameterValue implements org.apache.thrift.TBase<OptParameterValue, OptParameterValue._Fields>, java.io.Serializable, Cloneable, Comparable<OptParameterValue> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OptParameterValue");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new OptParameterValueStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new OptParameterValueTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OptParameterValue.class, metaDataMap);
  }

  public OptParameterValue() {
  }
   ...
   */
  public OptParameterValue(OptParameterValue other) {
  ...
  public OptParameterValue deepCopy() {
    return new OptParameterValue(this);
  }
  ...
  public OptParameterValue setParameterName(java.lang.String parameterName) {
    this.parameterName = parameterName;
    return this;
  }
  ...
  public OptParameterValue setBestValue(double bestValue) {
    this.bestValue = bestValue;
    setBestValueIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof OptParameterValue)
      return this.equals((OptParameterValue)that);
    return false;
  }

  public boolean equals(OptParameterValue that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(OptParameterValue other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("OptParameterValue(");
    boolean first = true;
  ...
  private static class OptParameterValueStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public OptParameterValueStandardScheme getScheme() {
      return new OptParameterValueStandardScheme();
    }
  }

  private static class OptParameterValueStandardScheme extends org.apache.thrift.scheme.StandardScheme<OptParameterValue> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OptParameterValue struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OptParameterValue struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OptParameterValueTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public OptParameterValueTupleScheme getScheme() {
      return new OptParameterValueTupleScheme();
    }
  }

  private static class OptParameterValueTupleScheme extends org.apache.thrift.scheme.TupleScheme<OptParameterValue> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OptParameterValue struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OptParameterValue struct) throws org.apache.thrift.TException {
