...
public class SBMLImporterFactory {
    ...
    public static ISBMLImporter getSBMLImporter(Model sbmlModel, VCLogger argVCLogger, boolean shouldValidateSBML) throws VCLoggerException{
    ...
    public static ISBMLImporter getSBMLImporter(String argSbmlFileName, VCLogger argVCLogger, boolean shouldValidateSBML) throws IOException, VCLoggerException{
    ...
    public static ISBMLImporter getSBMLImporter(InputStream sbmlInputStream, VCLogger argVCLogger, boolean shouldValidateSBML) throws VCLoggerException{
    ...
    public static ISBMLImporter getSBMLImporter(File sbmlModelFile, VCLogger argVCLogger, boolean shouldValidateSBML) throws IOException, VCLoggerException{
