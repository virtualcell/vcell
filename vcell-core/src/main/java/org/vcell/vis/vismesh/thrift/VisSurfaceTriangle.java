...
public class VisSurfaceTriangle implements org.apache.thrift.TBase<VisSurfaceTriangle, VisSurfaceTriangle._Fields>, java.io.Serializable, Cloneable, Comparable<VisSurfaceTriangle> {
   ...
   * @see Face
   */
  public @org.apache.thrift.annotation.Nullable Face face; // required
  ...
  public VisSurfaceTriangle setPointIndices(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> pointIndices) {
    this.pointIndices = pointIndices;
    return this;
  }
   ...
   * @see Face
   */
  public VisSurfaceTriangle setFace(@org.apache.thrift.annotation.Nullable Face face) {
    this.face = face;
    return this;
  }
  ...
  public VisSurfaceTriangle setChomboSurfaceIndex(@org.apache.thrift.annotation.Nullable ChomboSurfaceIndex chomboSurfaceIndex) {
  ...
  public int compareTo(VisSurfaceTriangle other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFace(), other.isSetFace());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFace()) {
