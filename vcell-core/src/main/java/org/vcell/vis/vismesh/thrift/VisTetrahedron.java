...
public class VisTetrahedron implements org.apache.thrift.TBase<VisTetrahedron, VisTetrahedron._Fields>, java.io.Serializable, Cloneable, Comparable<VisTetrahedron> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> pointIndices; // required
  ...
  public VisTetrahedron setPointIndices(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> pointIndices) {
    this.pointIndices = pointIndices;
    return this;
  }
  ...
  public VisTetrahedron setChomboVolumeIndex(@org.apache.thrift.annotation.Nullable ChomboVolumeIndex chomboVolumeIndex) {
  ...
  public VisTetrahedron setFiniteVolumeIndex(@org.apache.thrift.annotation.Nullable FiniteVolumeIndex finiteVolumeIndex) {
  ...
  public int compareTo(VisTetrahedron other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPointIndices(), other.isSetPointIndices());
    if (lastComparison != 0) {
