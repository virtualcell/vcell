...
public class VisPolygon implements org.apache.thrift.TBase<VisPolygon, VisPolygon._Fields>, java.io.Serializable, Cloneable, Comparable<VisPolygon> {
  ...
  public @org.apache.thrift.annotation.Nullable MovingBoundaryVolumeIndex movingBoundaryVolumeIndex; // optional
  ...
  public VisPolygon setPointIndices(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> pointIndices) {
    this.pointIndices = pointIndices;
    return this;
  }
  ...
  public VisPolygon setChomboVolumeIndex(@org.apache.thrift.annotation.Nullable ChomboVolumeIndex chomboVolumeIndex) {
  ...
  public VisPolygon setFiniteVolumeIndex(@org.apache.thrift.annotation.Nullable FiniteVolumeIndex finiteVolumeIndex) {
  ...
  public VisPolygon setMovingBoundaryVolumeIndex(@org.apache.thrift.annotation.Nullable MovingBoundaryVolumeIndex movingBoundaryVolumeIndex) {
  ...
  public int compareTo(VisPolygon other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMovingBoundaryVolumeIndex(), other.isSetMovingBoundaryVolumeIndex());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMovingBoundaryVolumeIndex()) {
