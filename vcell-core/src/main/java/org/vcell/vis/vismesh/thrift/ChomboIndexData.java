...
public class ChomboIndexData implements org.apache.thrift.TBase<ChomboIndexData, ChomboIndexData._Fields>, java.io.Serializable, Cloneable, Comparable<ChomboIndexData> {
  ...
  public java.util.List<ChomboSurfaceIndex> chomboSurfaceIndices; // optional
  public java.util.List<ChomboVolumeIndex> chomboVolumeIndices; // optional
  ...
  public ChomboIndexData setDomainName(java.lang.String domainName) {
    this.domainName = domainName;
    return this;
  }
  ...
  public ChomboIndexData setChomboSurfaceIndices(java.util.List<ChomboSurfaceIndex> chomboSurfaceIndices) {
  ...
  public ChomboIndexData setChomboVolumeIndices(java.util.List<ChomboVolumeIndex> chomboVolumeIndices) {
  ...
  public int compareTo(ChomboIndexData other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetChomboSurfaceIndices()).compareTo(other.isSetChomboSurfaceIndices());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChomboSurfaceIndices()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetChomboVolumeIndices()).compareTo(other.isSetChomboVolumeIndices());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChomboVolumeIndices()) {
