...
public class GsonSEDMLLoggerSerializer implements JsonSerializer<SEDMLLogger> {
    @Override
    public JsonElement serialize(SEDMLLogger src, Type typeOfSrc, JsonSerializationContext context){
