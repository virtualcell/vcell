...
public abstract class Change extends SedBase {
    ...
    public boolean isChangeAttribute() {
        return SedMLTags.CHANGE_ATTRIBUTE_KIND.equals(this.getChangeKind());
    }
    ...
    public boolean isChangeXML() {
        return SedMLTags.CHANGE_XML_KIND.equals(this.getChangeKind());
    }
    ...
    public boolean isAddXML() {
        return SedMLTags.ADD_XML_KIND.equals(this.getChangeKind());
    }
    ...
    public boolean isRemoveXML() {
        return SedMLTags.REMOVE_XML_KIND.equals(this.getChangeKind());
    }
    ...
    public boolean isComputeChange() {
        return SedMLTags.COMPUTE_CHANGE_KIND.equals(this.getChangeKind());
    }

    public boolean isSetValue() {
        return SedMLTags.SET_VALUE_KIND.equals(this.getChangeKind());
    }
