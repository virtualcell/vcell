...
#usage convertSmoldyn.py /path/to/SimID_xxxxxxxxxxx_0_ /path/to/outputfolder/ ImageOutputRootFileName {2|3 dimension} {0=all, 1 or more means number of specified variables} varname1 varname2 
...
particleIncludeList=[]
includeVarNumber=int(sys.argv[argStart+4])
if (includeVarNumber>0):
    for vari in range(1,includeVarNumber+1):
        particleIncludeList.append(sys.argv[(argStart+4+vari)])
