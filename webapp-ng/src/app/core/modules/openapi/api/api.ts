...
export const APIS = [AdminResourceService, BioModelResourceService, FieldDataResourceService, HelloWorldService, PublicationResourceService, SimulationResourceService, SolverResourceService, UsersResourceService];
