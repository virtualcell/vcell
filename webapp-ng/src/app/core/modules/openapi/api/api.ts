...
export * from './spatial-resource.service';
import { SpatialResourceService } from './spatial-resource.service';
export * from './spatial-resource.serviceInterface';
...
export const APIS = [AdminResourceService, BioModelResourceService, FieldDataResourceService, HelloWorldService, PublicationResourceService, SimulationResourceService, SpatialResourceService, UsersResourceService];
