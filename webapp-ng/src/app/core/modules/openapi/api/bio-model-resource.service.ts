...
// @ts-ignore
import { BioModelContext } from '../model/bio-model-context';
// @ts-ignore
...
export class BioModelResourceService implements BioModelResourceServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllBioModelContexts(allVCellContexts?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<BioModelContext>>;
    public getAllBioModelContexts(allVCellContexts?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<BioModelContext>>>;
    public getAllBioModelContexts(allVCellContexts?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<BioModelContext>>>;
    public getAllBioModelContexts(allVCellContexts?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {

        let localVarQueryParameters = new HttpParams({encoder: this.encoder});
        if (allVCellContexts !== undefined && allVCellContexts !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>allVCellContexts, 'allVCellContexts');
        }
        ...
        let localVarPath = `/api/v1/bioModel/contexts`;
        return this.httpClient.request<Array<BioModelContext>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getBioModelContext(bioModelID: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<BioModelContext>;
    public getBioModelContext(bioModelID: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<BioModelContext>>;
    public getBioModelContext(bioModelID: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<BioModelContext>>;
    public getBioModelContext(bioModelID: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (bioModelID === null || bioModelID === undefined) {
            throw new Error('Required parameter bioModelID was null or undefined when calling getBioModelContext.');
        }
        ...
        let localVarPath = `/api/v1/bioModel/${this.configuration.encodeParam({name: "bioModelID", value: bioModelID, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/context`;
        return this.httpClient.request<BioModelContext>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
