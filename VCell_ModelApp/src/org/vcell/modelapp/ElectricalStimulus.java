...
public abstract class ElectricalStimulus implements cbit.util.Matchable, cbit.vcell.parser.ScopedSymbolTable, java.io.Serializable, java.beans.PropertyChangeListener, java.beans.VetoableChangeListener {
	...
	public class ElectricalStimulusParameter extends Parameter {
		...
		public boolean isExpressionEditable(){
			if (ElectricalStimulus.this instanceof org.vcell.modelapp.CurrentClampStimulus && getRole()==ElectricalStimulus.ROLE_Voltage){
				return false;
			}
			if (ElectricalStimulus.this instanceof org.vcell.modelapp.VoltageClampStimulus && getRole()==ElectricalStimulus.ROLE_Current){
				return false;
			}
			return true;
		}
