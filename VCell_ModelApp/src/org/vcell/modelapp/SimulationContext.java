...
public class SimulationContext implements cbit.util.Versionable, Matchable, cbit.vcell.simulation.SimulationOwner, cbit.vcell.parser.ScopedSymbolTable, PropertyChangeListener, VetoableChangeListener, java.io.Serializable {
	...
	private org.vcell.modelapp.ElectricalStimulus[] fieldElectricalStimuli = new ElectricalStimulus[0];
 ...
 */
public org.vcell.modelapp.ElectricalStimulus[] getElectricalStimuli() {
 ...
 */
public void setElectricalStimuli(org.vcell.modelapp.ElectricalStimulus[] electricalStimuli) throws java.beans.PropertyVetoException {
	org.vcell.modelapp.ElectricalStimulus[] oldValue = fieldElectricalStimuli;
