...
public  class GeometryContext implements Serializable, Matchable, PropertyChangeListener {
	...
	private org.vcell.modelapp.StructureMapping[] fieldStructureMappings = new StructureMapping[0];
 ...
 */
public org.vcell.modelapp.StructureMapping[] getStructureMappings() {
 ...
 */
public void setStructureMappings(org.vcell.modelapp.StructureMapping[] structureMappings) throws java.beans.PropertyVetoException {
	org.vcell.modelapp.StructureMapping[] oldValue = fieldStructureMappings;
	if (oldValue!=null){
