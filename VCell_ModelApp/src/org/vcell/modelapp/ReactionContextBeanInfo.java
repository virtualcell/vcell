...
public static java.lang.Class getBeanClass() {
	return org.vcell.modelapp.ReactionContext.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(org.vcell.modelapp.ReactionContext.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
	...
	try {
		try {
			...
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					org.vcell.modelapp.ReactionSpec[].class
				};
...
public java.beans.MethodDescriptor setSpeciesContextSpecs_int_cbitvcellmappingSpeciesContextSpecMethodDescriptor() {
	...
	try {
		...
		try {
			...
			java.lang.Class aParameterTypes[] = {
				int.class,
				org.vcell.modelapp.SpeciesContextSpec.class
			};
