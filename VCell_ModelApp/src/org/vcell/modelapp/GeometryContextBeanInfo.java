...
public static java.lang.Class getBeanClass() {
	return org.vcell.modelapp.GeometryContext.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(org.vcell.modelapp.GeometryContext.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor setStructureMappings_int_cbitvcellmappingStructureMappingMethodDescriptor() {
	...
	try {
		...
		try {
			...
			java.lang.Class aParameterTypes[] = {
				int.class,
				org.vcell.modelapp.StructureMapping.class
			};
