...
public CurrentClampElectricalDevice(CurrentClampStimulus argCurrentClamStimulus, cbit.vcell.mapping.MathMapping argMathMapping) throws cbit.vcell.parser.ExpressionException {
	...
	//
	org.vcell.modelapp.ElectricalStimulus.ElectricalStimulusParameter[] stimulusParameters = currentClampStimulus.getElectricalStimulusParameters();
 ...
 */
public org.vcell.modelapp.CurrentClampStimulus getCurrentClampStimulus() {
