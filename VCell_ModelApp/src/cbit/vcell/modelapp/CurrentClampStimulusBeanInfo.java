...
/**
 * The bean information class for cbit.vcell.mapping.CurrentClampStimulus.
 */
public class CurrentClampStimulusBeanInfo extends java.beans.SimpleBeanInfo {
/**
	...
	try {
		try {
			...
			try {
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setCurrentExpression", 1);
			};
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.modelapp.CurrentClampStimulus.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the CurrentClampStimulusBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.modelapp.CurrentClampStimulus.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
