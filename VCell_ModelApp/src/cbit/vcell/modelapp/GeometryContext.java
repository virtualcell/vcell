...
public  class GeometryContext implements Serializable, Matchable, PropertyChangeListener {
	...
	private cbit.vcell.modelapp.StructureMapping[] fieldStructureMappings = new StructureMapping[0];
 ...
 */
public cbit.vcell.modelapp.StructureMapping[] getStructureMappings() {
 ...
 */
public void setStructureMappings(cbit.vcell.modelapp.StructureMapping[] structureMappings) throws java.beans.PropertyVetoException {
	cbit.vcell.modelapp.StructureMapping[] oldValue = fieldStructureMappings;
	if (oldValue!=null){
