...
public class SimulationContext implements cbit.util.Versionable, Matchable, cbit.vcell.simulation.SimulationOwner, org.vcell.expression.ScopedSymbolTable, PropertyChangeListener, VetoableChangeListener, java.io.Serializable {
	...
	private cbit.vcell.modelapp.ElectricalStimulus[] fieldElectricalStimuli = new ElectricalStimulus[0];
 ...
 */
public cbit.vcell.modelapp.ElectricalStimulus[] getElectricalStimuli() {
 ...
 */
public void setElectricalStimuli(cbit.vcell.modelapp.ElectricalStimulus[] electricalStimuli) throws java.beans.PropertyVetoException {
	cbit.vcell.modelapp.ElectricalStimulus[] oldValue = fieldElectricalStimuli;
