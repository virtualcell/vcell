...
*UsersResourceApi* | [**processMagicLink**](docs/UsersResourceApi.md#processMagicLink) | **POST** /api/v1/users/processMagicLink | Process the magic link and map the user
*UsersResourceApi* | [**processMagicLinkWithHttpInfo**](docs/UsersResourceApi.md#processMagicLinkWithHttpInfo) | **POST** /api/v1/users/processMagicLink | Process the magic link and map the user
