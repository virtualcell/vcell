...
*SpatialResourceApi* | [**retrieveFiniteVolumeInputFromSpatialModel**](docs/SpatialResourceApi.md#retrieveFiniteVolumeInputFromSpatialModel) | **GET** /api/v1/spatial/retrieveFiniteVolumeInputFromSpatialModel | Retrieve finite volume input from spatial model
*SpatialResourceApi* | [**retrieveFiniteVolumeInputFromSpatialModelWithHttpInfo**](docs/SpatialResourceApi.md#retrieveFiniteVolumeInputFromSpatialModelWithHttpInfo) | **GET** /api/v1/spatial/retrieveFiniteVolumeInputFromSpatialModel | Retrieve finite volume input from spatial model
