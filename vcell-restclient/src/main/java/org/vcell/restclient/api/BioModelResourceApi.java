...
public class BioModelResourceApi {
  ...
  private HttpRequest.Builder deleteBioModelRequestBuilder(String bioModelID) throws ApiException {
    ...
    String localVarPath = "/api/bioModel/{bioModelID}"
   ...
   * @throws ApiException if fails to make API call
   */
  public void getBioModelBNGL(String bioModelID) throws ApiException {
    getBioModelBNGLWithHttpInfo(bioModelID);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> getBioModelBNGLWithHttpInfo(String bioModelID) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBioModelBNGLRequestBuilder(bioModelID);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getBioModelBNGL", localVarResponse);
        }
        return new ApiResponse<Void>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder getBioModelBNGLRequestBuilder(String bioModelID) throws ApiException {
    // verify the required parameter 'bioModelID' is set
    if (bioModelID == null) {
      throw new ApiException(400, "Missing the required parameter 'bioModelID' when calling getBioModelBNGL");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/bioModel/{bioModelID}/bngl_download"
        .replace("{bioModelID}", ApiClient.urlEncode(bioModelID.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public void getBioModelDIAGRAM(String bioModelID) throws ApiException {
    getBioModelDIAGRAMWithHttpInfo(bioModelID);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> getBioModelDIAGRAMWithHttpInfo(String bioModelID) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBioModelDIAGRAMRequestBuilder(bioModelID);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getBioModelDIAGRAM", localVarResponse);
        }
        return new ApiResponse<Void>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder getBioModelDIAGRAMRequestBuilder(String bioModelID) throws ApiException {
    // verify the required parameter 'bioModelID' is set
    if (bioModelID == null) {
      throw new ApiException(400, "Missing the required parameter 'bioModelID' when calling getBioModelDIAGRAM");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/bioModel/{bioModelID}/diagram_download"
        .replace("{bioModelID}", ApiClient.urlEncode(bioModelID.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public void getBioModelOMEX(String bioModelID) throws ApiException {
    getBioModelOMEXWithHttpInfo(bioModelID);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> getBioModelOMEXWithHttpInfo(String bioModelID) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBioModelOMEXRequestBuilder(bioModelID);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getBioModelOMEX", localVarResponse);
        }
        return new ApiResponse<Void>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder getBioModelOMEXRequestBuilder(String bioModelID) throws ApiException {
    // verify the required parameter 'bioModelID' is set
    if (bioModelID == null) {
      throw new ApiException(400, "Missing the required parameter 'bioModelID' when calling getBioModelOMEX");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/bioModel/{bioModelID}/omex_download"
        .replace("{bioModelID}", ApiClient.urlEncode(bioModelID.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public void getBioModelSBML(String bioModelID) throws ApiException {
    getBioModelSBMLWithHttpInfo(bioModelID);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> getBioModelSBMLWithHttpInfo(String bioModelID) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBioModelSBMLRequestBuilder(bioModelID);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getBioModelSBML", localVarResponse);
        }
        return new ApiResponse<Void>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder getBioModelSBMLRequestBuilder(String bioModelID) throws ApiException {
    // verify the required parameter 'bioModelID' is set
    if (bioModelID == null) {
      throw new ApiException(400, "Missing the required parameter 'bioModelID' when calling getBioModelSBML");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/bioModel/{bioModelID}/sbml_download"
        .replace("{bioModelID}", ApiClient.urlEncode(bioModelID.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public void getBioModelVCML(String bioModelID) throws ApiException {
    getBioModelVCMLWithHttpInfo(bioModelID);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> getBioModelVCMLWithHttpInfo(String bioModelID) throws ApiException {
  ...
  private HttpRequest.Builder getBioModelVCMLRequestBuilder(String bioModelID) throws ApiException {
    ...
    String localVarPath = "/api/bioModel/{bioModelID}/vcml_download"
        .replace("{bioModelID}", ApiClient.urlEncode(bioModelID.toString()));
  ...
  private HttpRequest.Builder uploadBioModelRequestBuilder(String body) throws ApiException {
    ...
    String localVarPath = "/api/bioModel/upload_bioModel";
