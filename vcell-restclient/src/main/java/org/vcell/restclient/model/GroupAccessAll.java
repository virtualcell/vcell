...
public class GroupAccessAll extends GroupAccess {
  ...
  public GroupAccessAll type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public GroupAccessAll description(@javax.annotation.Nullable String description) {
  ...
  @Override
  public GroupAccessAll groupid(@javax.annotation.Nonnull BigDecimal groupid) {
    this.setGroupid(groupid);
    return this;
  }

  /**
   * Return true if this GroupAccessAll object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(GroupAccessAll.class, "type", mappings);
}
}
