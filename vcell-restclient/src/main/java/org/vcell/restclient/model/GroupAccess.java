...
public class GroupAccess {
  ...
  public GroupAccess groupid(@javax.annotation.Nonnull BigDecimal groupid) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_GROUPID, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_GROUPID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setGroupid(@javax.annotation.Nonnull BigDecimal groupid) {
    this.groupid = groupid;
  }


  public GroupAccess description(@javax.annotation.Nullable String description) {
