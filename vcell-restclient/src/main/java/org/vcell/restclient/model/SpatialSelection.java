...
public class SpatialSelection {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CURVE_SELECTION_INFO, required = false)
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_VAR_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SMALLEST_MESH_CELL_DIMENSION_LENGTH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
