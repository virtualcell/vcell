...
/**
 * The bean information class for cbit.vcell.model.GHKKinetics.
 */
public class GHKKineticsBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.model.GHKKinetics.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the GHKKineticsBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.model.GHKKinetics.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
	...
	try {
		try {
			...
			try {
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setPermeability", 1);
			};
