		...
		for (int i = 0; i < reactionParticipants.length; i++){
			if (reactionParticipants[i] instanceof Reactant){
				...
				if (reactionParticipants[i].getStoichiometry()!=1){
					reactantUnit = reactantUnit.raiseTo(new RationalNumber(reactionParticipants[i].getStoichiometry()));
				}
				...
				if (reactionParticipants[i].getStoichiometry()!=1){
					productUnit = productUnit.raiseTo(new RationalNumber(reactionParticipants[i].getStoichiometry()));
				}
