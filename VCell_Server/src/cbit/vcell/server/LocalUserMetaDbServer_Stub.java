...
public final class LocalUserMetaDbServer_Stub
    ...
    implements UserMetaDbServer, java.rmi.Remote
{
	...
	try {
	    ...
	    $method_saveGeometry_48 = UserMetaDbServer.class.getMethod("saveGeometry", new java.lang.Class[] {cbit.util.BigString.class});
	    $method_saveGeometryAs_49 = UserMetaDbServer.class.getMethod("saveGeometryAs", new java.lang.Class[] {cbit.util.BigString.class, java.lang.String.class});
	    $method_saveMathModel_50 = UserMetaDbServer.class.getMethod("saveMathModel", new java.lang.Class[] {cbit.util.BigString.class, java.lang.String[].class});
	    $method_saveMathModelAs_51 = UserMetaDbServer.class.getMethod("saveMathModelAs", new java.lang.Class[] {cbit.util.BigString.class, java.lang.String.class, java.lang.String[].class});
	    $method_saveSimulation_52 = UserMetaDbServer.class.getMethod("saveSimulation", new java.lang.Class[] {cbit.util.BigString.class, boolean.class});
	    $method_saveVCImage_53 = UserMetaDbServer.class.getMethod("saveVCImage", new java.lang.Class[] {cbit.util.BigString.class});
	    $method_saveVCImageAs_54 = UserMetaDbServer.class.getMethod("saveVCImageAs", new java.lang.Class[] {cbit.util.BigString.class, java.lang.String.class});
    ...
    public cbit.util.ReferenceQueryResult findReferences(cbit.util.ReferenceQuerySpec $param_ReferenceQuerySpec_1)
	throws cbit.util.DataAccessException, cbit.util.ObjectNotFoundException, java.rmi.RemoteException
    {
	try {
	    ...
	    return ((cbit.util.ReferenceQueryResult) $result);
	} catch (java.lang.RuntimeException e) {
	    throw e;
	} catch (java.rmi.RemoteException e) {
	    throw e;
    ...
    public ExportLog[] getExportLogs(boolean $param_boolean_1)
	throws cbit.util.DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public SolverResultSetInfo[] getResultSetInfos(boolean $param_boolean_1)
	throws cbit.util.DataAccessException, java.rmi.RemoteException
    {
	try {
	    ...
	    return ((SolverResultSetInfo[]) $result);
	} catch (java.lang.RuntimeException e) {
	    throw e;
	} catch (java.rmi.RemoteException e) {
	    throw e;
