 ...
 */
private LocalVCellBootstrap(boolean bPrimaryServer, String hostName, AdminDatabaseServer adminDbServer, cbit.vcell.messaging.JmsConnectionFactory jmsConnFactory, boolean bRemoteMode) throws RemoteException, FileNotFoundException, DataAccessException {
	super(PropertyLoader.getIntProperty(PropertyLoader.rmiPortVCellBootstrap,0));
	this.adminDbServer = adminDbServer;
	this.localVCellServer = new LocalVCellServer(bPrimaryServer, hostName, jmsConnFactory, adminDbServer, bRemoteMode);
...
public static void main(java.lang.String[] args) {
	...
	try {
		...
		LocalVCellBootstrap localVCellBootstrap = new LocalVCellBootstrap(bPrimary,host+":"+rmiPort,adminDbServer,jmsConnFactory,bRemoteMode);
