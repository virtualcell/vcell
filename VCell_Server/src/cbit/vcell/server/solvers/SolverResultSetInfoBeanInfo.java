...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.server.solvers.SolverResultSetInfo.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.server.solvers.SolverResultSetInfo.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
