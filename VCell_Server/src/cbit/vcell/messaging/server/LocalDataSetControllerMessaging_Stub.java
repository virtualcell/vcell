...
public final class LocalDataSetControllerMessaging_Stub
    ...
    implements cbit.vcell.server.DataSetController, java.rmi.Remote
{
    ...
    static {
	try {
	    $method_addFunction_0 = cbit.vcell.server.DataSetController.class.getMethod("addFunction", new java.lang.Class[] {VCDataIdentifier.class, cbit.vcell.math.AnnotatedFunction.class});
	    $method_addFunctions_1 = cbit.vcell.server.DataSetController.class.getMethod("addFunctions", new java.lang.Class[] {VCDataIdentifier.class, cbit.vcell.math.AnnotatedFunction[].class});
	    $method_getDataIdentifiers_2 = cbit.vcell.server.DataSetController.class.getMethod("getDataIdentifiers", new java.lang.Class[] {VCDataIdentifier.class});
	    ...
	    $method_getLineScan_6 = cbit.vcell.server.DataSetController.class.getMethod("getLineScan", new java.lang.Class[] {VCDataIdentifier.class, java.lang.String.class, double.class, cbit.vcell.math.CoordinateIndex.class, cbit.vcell.math.CoordinateIndex.class});
    ...
    // constructors
    public LocalDataSetControllerMessaging_Stub(java.rmi.server.RemoteRef ref) {
	super(ref);
    }
    ...
    public void addFunction(VCDataIdentifier $param_VCDataIdentifier_1, cbit.vcell.math.AnnotatedFunction $param_AnnotatedFunction_2)
    ...
    public void addFunctions(VCDataIdentifier $param_VCDataIdentifier_1, cbit.vcell.math.AnnotatedFunction[] $param_arrayOf_AnnotatedFunction_2)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public DataIdentifier[] getDataIdentifiers(VCDataIdentifier $param_VCDataIdentifier_1)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public double[] getDataSetTimes(VCDataIdentifier $param_VCDataIdentifier_1)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public cbit.vcell.math.AnnotatedFunction[] getFunctions(VCDataIdentifier $param_VCDataIdentifier_1)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public boolean getIsODEData(VCDataIdentifier $param_VCDataIdentifier_1)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public cbit.plot.PlotData getLineScan(VCDataIdentifier $param_VCDataIdentifier_1, java.lang.String $param_String_2, double $param_double_3, cbit.vcell.math.CoordinateIndex $param_CoordinateIndex_4, cbit.vcell.math.CoordinateIndex $param_CoordinateIndex_5)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public cbit.plot.PlotData getLineScan(VCDataIdentifier $param_VCDataIdentifier_1, java.lang.String $param_String_2, double $param_double_3, cbit.vcell.simdata.SpatialSelection $param_SpatialSelection_4)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public cbit.vcell.simdata.ParticleDataBlock getParticleDataBlock(VCDataIdentifier $param_VCDataIdentifier_1, double $param_double_2)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public boolean getParticleDataExists(VCDataIdentifier $param_VCDataIdentifier_1)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public cbit.vcell.simdata.SimDataBlock getSimDataBlock(VCDataIdentifier $param_VCDataIdentifier_1, java.lang.String $param_String_2, double $param_double_3)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public void removeFunction(VCDataIdentifier $param_VCDataIdentifier_1, cbit.vcell.math.AnnotatedFunction $param_AnnotatedFunction_2)
	throws DataAccessException, java.rmi.RemoteException
    {
	try {
