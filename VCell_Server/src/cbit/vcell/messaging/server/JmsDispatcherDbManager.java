 ...
 */
public cbit.vcell.solvers.SimulationJobStatus updateDispatchedStatus(cbit.vcell.solvers.SimulationJobStatus oldJobStatus, cbit.vcell.server.AdminDatabaseServerXA adminDbXA, java.sql.Connection con, java.lang.String computeHost, cbit.vcell.simulation.VCSimulationIdentifier vcSimID, int jobIndex, java.lang.String startMsg) throws DataAccessException, cbit.vcell.messaging.db.UpdateSynchronizationException {
 ...
 */
public void updateLatestUpdateDate(cbit.vcell.solvers.SimulationJobStatus oldJobStatus, cbit.vcell.server.AdminDatabaseServerXA adminDbXA, java.sql.Connection con, cbit.vcell.simulation.VCSimulationIdentifier vcSimID, int jobIndex) throws DataAccessException, cbit.vcell.messaging.db.UpdateSynchronizationException {
