...
public class UserTable extends cbit.sql.Table {
	...
	public final Field userid		= new Field("USERID",		"varchar(255)",255,		"NOT NULL");
...
public String getSQLUpdateList(UserInfo userInfo) {
	...
	buffer.append(address2+"='"+userInfo.address2+"',");
	...
	buffer.append(notify+"='"+userInfo.notify+"'");
...
public UserInfo getUserInfo(ResultSet rset) throws SQLException {
	...
	userInfo.notify =	rset.getString(notify.toString());
