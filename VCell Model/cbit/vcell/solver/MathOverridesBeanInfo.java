...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.solver.MathOverrides.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.solver.MathOverrides.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor mathOverridesconstantAdded_javalangObjectMethodEventDescriptor() {
	...
	try {
		...
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.vcell.solver.MathOverridesEvent.class
			};
			aMethod = (cbit.vcell.solver.MathOverridesListener.class).getMethod("constantAdded", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.solver.MathOverridesListener.class), "constantAdded", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
...
public java.beans.MethodDescriptor mathOverridesconstantChanged_javalangObjectMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.solver.MathOverridesListener.class).getMethod("constantChanged", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.solver.MathOverridesListener.class), "constantChanged", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
...
public java.beans.MethodDescriptor mathOverridesconstantRemoved_javalangObjectMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.solver.MathOverridesListener.class).getMethod("constantRemoved", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.solver.MathOverridesListener.class), "constantRemoved", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
		...
		try {
			...
			try {
				...
				java.lang.Class anAddMethodParameterTypes[] = {
					cbit.vcell.solver.MathOverridesListener.class
				};
