 ...
 */
public void addMathOverridesListener(cbit.vcell.simulation.MathOverridesListener newListener) {
	aMathOverridesListener = cbit.vcell.simulation.MathOverridesEventMulticaster.add(aMathOverridesListener, newListener);
	return;
}
 ...
 */
protected void fireConstantAdded(cbit.vcell.simulation.MathOverridesEvent event) {
 ...
 * @param event cbit.vcell.solver.MathOverridesEvent
 */
protected void fireConstantChanged(cbit.vcell.simulation.MathOverridesEvent event) {
	if (aMathOverridesListener == null) {
		return;
	};
 ...
 * @param event cbit.vcell.solver.MathOverridesEvent
 */
protected void fireConstantRemoved(cbit.vcell.simulation.MathOverridesEvent event) {
	if (aMathOverridesListener == null) {
		return;
	};
 ...
 * @param newListener cbit.vcell.solver.MathOverridesListener
 */
public void removeMathOverridesListener(cbit.vcell.simulation.MathOverridesListener newListener) {
	aMathOverridesListener = cbit.vcell.simulation.MathOverridesEventMulticaster.remove(aMathOverridesListener, newListener);
	return;
}
