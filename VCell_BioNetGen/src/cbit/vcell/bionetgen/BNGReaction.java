...
public class BNGReaction {
	private IExpression paramExpression = null; 
 ...
 */
public BNGReaction(BNGSpecies[] argReactants, BNGSpecies[] argPdts, IExpression argExpr) {
	super();
 ...
 */
public IExpression getParamExpression() {
 ...
 * Creation date: (1/13/2006 6:01:30 PM)
 */
public void setParamExpression(IExpression argExpr) {
	paramExpression = argExpr;
}
