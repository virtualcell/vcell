...
public static void main(java.lang.String[] args) {
	try {
		...
		aExportMonitorPanel.addExportEvent(new ExportEvent(
			...
			vcSimDataId.getID(), vcSimDataId.getSimulationKey(), ExportSpecss.ExportProgressType.EXPORT_PROGRESS,
			"CSV", "", new Double(0.47),
			null, null),
		"bogus [application: model]");
		aExportMonitorPanel.addExportEvent(new ExportEvent(
			aExportMonitorPanel, 987654321L, null,
			vcSimDataId.getID(), vcSimDataId.getSimulationKey(), ExportSpecss.ExportProgressType.EXPORT_COMPLETE,
