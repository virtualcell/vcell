    ...
    private javax.swing.JPanel getDefaultOutputPanel() {
        if (ivjDefaultOutputPanel == null) {
            try {
                ...
                constraintsKeepAtMostLabel.gridx = 2;
                constraintsKeepAtMostLabel.gridy = 0;
                ...
                constraintsKeepEveryTextField.gridx = 0;
                constraintsKeepEveryTextField.gridy = 0;
                ...
                constraintsKeepAtMostTextField.gridx = 3;
                constraintsKeepAtMostTextField.gridy = 0;
                ...
                constraintsPointsLabel.gridx = 4;
                constraintsPointsLabel.gridy = 0;
    ...
    private javax.swing.JPanel getUniformOutputPanel() {
        if (ivjUniformOutputPanel == null) {
            try {
                ...
                constraintsTimeStepUnitsLabel.gridx = 1;
                constraintsTimeStepUnitsLabel.gridy = 0;
                ...
                constraintsOutputTimeStepTextField.gridx = 0;
                constraintsOutputTimeStepTextField.gridy = 0;
    ...
    private javax.swing.JPanel getExplicitOutputPanel() {
        if (ivjExplicitOutputPanel == null) {
            try {
                ...
                constraintsOutputTimesTextField.gridx = 0;
                constraintsOutputTimesTextField.gridy = 0;
