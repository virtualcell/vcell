...
//	}
        ...
        SwingWorker worker = new SwingWorker() {
            ...
            public Object construct() {
                ...
                if (requester != null) {
                    this.windowParent = GuiUtils.getWindowForComponent(requester);
                }
                try {
...
//			System.out.println("----------Leave----------entryCounter="+entryCounter);
                ...
                if (this.windowParent != null) {
                    ...
                    if (fw == null && this.focusOwner != null) {
                        ...
                        if (lg.isDebugEnabled()) {
                            lg.debug("FinalWindow built from " + this.windowParent.toString() + " and " + this.focusOwner.toString());
                        }
                    }
                }
                if (fw != null) {
                    if (lg.isDebugEnabled()) {
                        lg.debug("scheduling " + fw.getClass().getName() + ".run on " + fw);
