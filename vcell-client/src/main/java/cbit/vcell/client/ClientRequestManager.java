...
public class ClientRequestManager
    ...
    private CloseOption checkBeforeClosing(DocumentWindowManager windowManager) {
        ...
        try {
            isChanged = this.getDocumentManager().isChanged(vcDocument);
        } catch (Exception exc) {
            exc.printStackTrace();
...
//		String choice = PopupGenerator.showWarningDialog(windowManager, getUserPreferences(), UserMessage.warn_close,null);
    ...
    private boolean closeAllWindows(boolean duringExit) {
        ...
        // window
        ArrayList<TopLevelWindowManager> modificationSafeCopy = new ArrayList<>(this.getMdiManager().getWindowManagers());
...
//				shortData[t][c] = ushortImage.getPixels();
    ...
    public void accessPermissions(Component requester, VCDocument vcDoc) {
        ...
        switch (vcDoc.getDocumentType()) {
            case BIOMODEL_DOC:
                BioModelInfo[] bioModelInfos = this.getDocumentManager().getBioModelInfos();
            ...
            case MATHMODEL_DOC:
                ...
                break;
            case GEOMETRY_DOC:
                GeometryInfo[] geoInfos = this.getDocumentManager().getGeometryInfos();
        ...
        this.getMdiManager().getDatabaseWindowManager().accessPermissions(requester, selectedVersionInfo, false);
    ...
    public void accessPermissionsEx(Component requester, VCDocument vcDoc, boolean bGrantSupportPermissions) {
        ...
        this.getMdiManager().getDatabaseWindowManager().accessPermissions(requester, selectedVersionInfo, true);
    ...
    public static Collection<AsynchClientTask> updateMath(final Component requester,
        ...
        AsynchClientTask task1 = new AsynchClientTask("generating math", AsynchClientTask.TASKTYPE_NONSWING_BLOCKING) {
            ...
            public void run(Hashtable<String, Object> hashTable) throws Exception {
                ...
                MathMappingCallback callback = new MathMappingCallbackTaskAdapter(this.getClientTaskStatusSupport());
