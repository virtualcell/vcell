...
public class ArrayUtils {
    ...
    public static <T> T[] addElement(T[] originalArray, T element) {
        if (originalArray == null) throw new NullPointerException("Cannot invoke \"Object.getClass()\" because \"originalArray\" is null");
    ...
    public static <T> T[] addElements(T[] firstArray, T[] appendingArray) {
        if (firstArray == null) throw new NullPointerException("Cannot invoke \"Object.getClass()\" because \"firstArray\" is null");
        if (appendingArray == null) throw new NullPointerException("Cannot read the array length because \"appendingArray\" is null");
