...
public abstract class Shape extends java.lang.Object {
	...
	protected Vector childShapeList = new Vector();
...
/**
 * This method was created by a SmartGuide.
 * @param featureShape cbit.vcell.graph.Shape
 */
...
public Enumeration getChildren() {
	return childShapeList.elements();
}
...
public final void paint(Graphics2D g2D) {
	...
	while ((parent = parent.getParent())!=null){
		offset.x += parent.screenPos.x;
		offset.y += parent.screenPos.y;
	}	
	paint(g2D,offset.x,offset.y);
}
 ...
 * @param g java.awt.Graphics
 */
public abstract void paint ( java.awt.Graphics2D g, int parentOriginX, int parentOriginY );
