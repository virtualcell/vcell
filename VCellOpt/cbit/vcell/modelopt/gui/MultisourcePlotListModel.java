...
private void refreshAll() {
	...
	for (int i = 0; getDataSources()!=null && i < getDataSources().length; i++){
		...
		if (dataSource.getSource() instanceof cbit.vcell.simdata.ODESolverResultSet){
			cbit.vcell.simdata.ODESolverResultSet odeSolverResultSet = (cbit.vcell.simdata.ODESolverResultSet)dataSource.getSource();
