...
public java.beans.MethodDescriptor databasedatabaseDelete_cbitvcellclientdbDatabaseEventMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.client.database.DatabaseListener.class).getMethod("databaseDelete", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.client.database.DatabaseListener.class), "databaseDelete", 1);
		};
		try {
...
public java.beans.MethodDescriptor databasedatabaseInsert_cbitvcellclientdbDatabaseEventMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.client.database.DatabaseListener.class).getMethod("databaseInsert", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.client.database.DatabaseListener.class), "databaseInsert", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
...
public java.beans.MethodDescriptor databasedatabaseRefresh_cbitvcellclientdbDatabaseEventMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.client.database.DatabaseListener.class).getMethod("databaseRefresh", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.client.database.DatabaseListener.class), "databaseRefresh", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
...
public java.beans.MethodDescriptor databasedatabaseUpdate_cbitvcellclientdbDatabaseEventMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.client.database.DatabaseListener.class).getMethod("databaseUpdate", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.client.database.DatabaseListener.class), "databaseUpdate", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
		...
		try {
			...
			try {
				...
				java.lang.Class anAddMethodParameterTypes[] = {
					cbit.vcell.client.database.DatabaseListener.class
				};
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.database.ClientDocumentManager.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.database.ClientDocumentManager.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
