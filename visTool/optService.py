...
struct OptProblem {
	...
	6: required CopasiOptimizationMethod optimizationMethod;
        ...
        experiment.setFileName(optProblem.experimentalDataFile)     # C:\\TEMP\\ggg\\testing_61.csv
        ...
        print("last column  " + str(objectMap.getLastColumn()))
        ...
        for parameterDescription in parameterDescriptionList:
            ...
            print("parameter cn = " + str(daThing))
        ...
        objectMap2 = experiment.getObjectMap()
        assert (isinstance(objectMap2, COPASI.CExperimentObjectMap))
        obj0 = objectMap2.getObjectCN(0)
        obj1 = objectMap2.getObjectCN(1)
        obj2 = objectMap2.getObjectCN(2)
