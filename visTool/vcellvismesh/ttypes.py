...
class VisIrregularPolyhedron(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'polyhedronFaces', (TType.STRUCT, (PolyhedronFace, PolyhedronFace.thrift_spec), False), None, ),  # 1
        (2, TType.STRUCT, 'chomboVolumeIndex', (ChomboVolumeIndex, ChomboVolumeIndex.thrift_spec), None, ),  # 2
        (3, TType.STRUCT, 'finiteVolumeIndex', (FiniteVolumeIndex, FiniteVolumeIndex.thrift_spec), None, ),  # 3
    )
...
class FiniteVolumeIndexData(object):
    ...
    thrift_spec = (
        ...
        (2, TType.LIST, 'finiteVolumeIndices', (TType.STRUCT, (FiniteVolumeIndex, FiniteVolumeIndex.thrift_spec), False), None, ),  # 2
    )
...
class ChomboIndexData(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'domainName', 'UTF8', None, ),  # 1
        (2, TType.LIST, 'chomboSurfaceIndices', (TType.STRUCT, (ChomboSurfaceIndex, ChomboSurfaceIndex.thrift_spec), False), None, ),  # 2
        (3, TType.LIST, 'chomboVolumeIndices', (TType.STRUCT, (ChomboVolumeIndex, ChomboVolumeIndex.thrift_spec), False), None, ),  # 3
    )
...
class MovingBoundaryIndexData(object):
    ...
    thrift_spec = (
        ...
        (3, TType.LIST, 'movingBoundarySurfaceIndices', (TType.STRUCT, (MovingBoundarySurfaceIndex, MovingBoundarySurfaceIndex.thrift_spec), False), None, ),  # 3
        (4, TType.LIST, 'movingBoundaryVolumeIndices', (TType.STRUCT, (MovingBoundaryVolumeIndex, MovingBoundaryVolumeIndex.thrift_spec), False), None, ),  # 4
    )
...
class VisMesh(object):
    ...
    thrift_spec = (
        ...
        (4, TType.LIST, 'points', (TType.STRUCT, (VisPoint, VisPoint.thrift_spec), False), None, ),  # 4
        (5, TType.LIST, 'polygons', (TType.STRUCT, (VisPolygon, VisPolygon.thrift_spec), False), None, ),  # 5
        (6, TType.LIST, 'irregularPolyhedra', (TType.STRUCT, (VisIrregularPolyhedron, VisIrregularPolyhedron.thrift_spec), False), None, ),  # 6
        (7, TType.LIST, 'tetrahedra', (TType.STRUCT, (VisTetrahedron, VisTetrahedron.thrift_spec), False), None, ),  # 7
        (8, TType.LIST, 'visVoxels', (TType.STRUCT, (VisVoxel, VisVoxel.thrift_spec), False), None, ),  # 8
        (9, TType.LIST, 'surfaceTriangles', (TType.STRUCT, (VisSurfaceTriangle, VisSurfaceTriangle.thrift_spec), False), None, ),  # 9
        (10, TType.LIST, 'visLines', (TType.STRUCT, (VisLine, VisLine.thrift_spec), False), None, ),  # 10
        (11, TType.LIST, 'surfacePoints', (TType.STRUCT, (VisPoint, VisPoint.thrift_spec), False), None, ),  # 11
    )
