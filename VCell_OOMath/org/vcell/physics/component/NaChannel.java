...
public class NaChannel extends IonChannelHH {
	...
	public NaChannel(String argName) {
		...
		Parameter gNa_max = new Parameter("gNa_max",VCUnitDefinition.UNIT_nS_per_um2);
		...
		try {
			...
			addEquation(Expression.valueOf("alpha_m(t) - ((0.1 * (25.0 - V_m(t)) / (-1.0 + exp((0.1 * (25.0 - V_m(t)))))))"));
