...
public class NaChannel extends IonChannelHH {
	...
	public NaChannel(String argName) {
		...
		try {
			...
			addEquation(Expression.valueOf("alpha_m(t) - (((gt(1000*abs(alpha_m_exp_arg(t)),1))*(alpha_m_exp_arg(t) / (-1.0 + exp(alpha_m_exp_arg(t)))))+(le(1000*abs(alpha_m_exp_arg(t)),1))*1.0)"));
			addEquation(Expression.valueOf("alpha_m_exp_arg(t) - ((0.1 * (25.0 - V_m(t))))"));
			addEquation(Expression.valueOf("beta_m(t) - ((4.0 * exp(- (0.05555555555555555 * V_m(t)))))"));
			...
			addEquation(Expression.valueOf("alpha_h(t) - ((0.07 * exp(- (0.05 * V_h(t)))))"));
			addEquation(Expression.valueOf("beta_h(t) - ((1.0 / (1.0 + exp(0.1 * (30.0 - V_h(t))))))"));
