...
public class KChannel extends IonChannelHH {
	...
	public KChannel(String argName) {
		...
		Variable beta_n_exp_arg = new Variable("beta_n_exp_arg(t)",VCUnitDefinition.UNIT_DIMENSIONLESS);
		...
		try {
			...
			addEquation(Expression.valueOf("alpha_n(t) - (0.01 * (10.0 - V(t)) / (-1.0 + exp(alpha_n_exp_arg(t))))"));
			addEquation(Expression.valueOf("alpha_n_exp_arg(t) - (0.1 * (10.0 - V_n(t)))"));
			addEquation(Expression.valueOf("beta_n(t) - (0.125 * exp(beta_n_exp_arg(t)))"));
			addEquation(Expression.valueOf("beta_n_exp_arg(t) - (-0.0125 * V_n(t))"));
