 ...
 */
public static String createModelObjectString(org.vcell.physics.component.Connector connector) {
	return new String(connector.getParent().getName()+"_to_"+connector.getName());
}
/**
 * Insert the method's description here.
 * Creation date: (12/12/2003 12:38:01 PM)
...
public static String createModelObjectString(ConnectorNode devicePinNode) {
	return new String(((org.vcell.physics.component.Connector)devicePinNode.getModelObject()).getParent().getName()+"_to_"+devicePinNode.getLabel());
}
/**
