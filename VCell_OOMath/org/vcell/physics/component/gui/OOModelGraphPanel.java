 ...
 * 
 */
public class OOModelGraphPanel extends JPanel implements java.awt.event.ActionListener, java.beans.PropertyChangeListener {
	...
	private OOModelGraphCartoonTool ivjphysicalModelGraphCartoonTool1 = null;
	private OOModelGraphModel ivjphysicalModelGraphModel = null;
	private org.vcell.physics.component.OOModel fieldModel = null;
	private boolean ivjConnPtoP4Aligning = false;
	private org.vcell.physics.component.OOModel ivjmodel1 = null;

/**
 * Constructor
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public OOModelGraphPanel() {
	super();
	initialize();
}
 ...
 */
public OOModelGraphPanel(java.awt.LayoutManager layout) {
	super(layout);
}
...
/**
 * connEtoM3:  (model1.this --> physicalModelGraphModel.setModel(Lncbc.physics2.component.Model;)V)
 * @param value ncbc.physics2.component.Model
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private void connEtoM3(org.vcell.physics.component.OOModel value) {
	try {
		// user code begin {1}
		// user code end
		getphysicalModelGraphModel().setModel(getmodel1());
		// user code begin {2}
		// user code end
	} catch (java.lang.Throwable ivjExc) {
		// user code begin {3}
...
/**
 * connEtoM8:  (PhysicalModelGraphPanel.initialize() --> physicalModelGraphCartoonTool1.model)
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private void connEtoM8() {
	try {
		...
		// user code end
		if ((getmodel1() != null)) {
			getphysicalModelGraphCartoonTool1().setModel(getmodel1());
		}
		// user code begin {2}
		// user code end
	} catch (java.lang.Throwable ivjExc) {
...
/**
 * connPtoP3SetTarget:  (physicalModelGraphModel.this <--> physicalModelGraphCartoonTool1.physicalModelGraphModel)
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * connPtoP4SetSource:  (PhysicalModelGraphPanel.model <--> model1.this)
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * connPtoP4SetTarget:  (PhysicalModelGraphPanel.model <--> model1.this)
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * Gets the model property (ncbc.physics2.component.Model) value.
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private org.vcell.physics.component.OOModel getmodel1() {
	// user code begin {1}
	// user code end
	return ivjmodel1;
}
 ...
 * @return ncbc.physics2.component.gui.PhysicalModelGraphCartoonTool
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private OOModelGraphCartoonTool getphysicalModelGraphCartoonTool1() {
	if (ivjphysicalModelGraphCartoonTool1 == null) {
		try {
			ivjphysicalModelGraphCartoonTool1 = new org.vcell.physics.component.gui.OOModelGraphCartoonTool();
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
 ...
 * @return ncbc.physics.component.gui.PhysicalModelGraphModel
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private OOModelGraphModel getphysicalModelGraphModel() {
	if (ivjphysicalModelGraphModel == null) {
		try {
			ivjphysicalModelGraphModel = new org.vcell.physics.component.gui.OOModelGraphModel();
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
public static void main(java.lang.String[] args) {
	try {
		...
		frame.show();
		aPhysicalModelGraphPanel.setModel(OOModelTest.getExampleSpineDendrite());
...
/**
 * Sets the model property (ncbc.physics2.component.Model) value.
 * @param oOModel The new value for the property.
 * @see #getModel
 */
 ...
 * @param newValue ncbc.physics2.component.Model
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private void setmodel1(org.vcell.physics.component.OOModel newValue) {
	if (ivjmodel1 != newValue) {
		try {
			org.vcell.physics.component.OOModel oldValue = getmodel1();
			ivjmodel1 = newValue;
			connPtoP4SetSource();
			connEtoM3(ivjmodel1);
