 ...
 * @version $Id: StandardUnitDB.java,v 1.5 2000/07/18 20:15:28 steve Exp $
 */
public final class
StandardUnitDB
    extends	UnitDBImpl
{
     ...
     * @throws UnitParseException	A string specification couldn't be
     *					parsed.
	...
	/*
         * Unit specification strings in the following rely on standard
         * unit syntax.  Additionally, unit specification strings may
         * not reference units that have not yet been defined (i.e.
	...
	/*
	 * God help us!  There's an international foot and a US survey 
	 * foot and they're not the same!
	 */

	// US Survey foot stuff:
	au("US survey foot",		"1200/3937 m",	null,
	    "US survey feet");
	...
	au("international inch",	".0254 m",	null,
	    "international inches");			// exact
     ...
     */
    private void
    au(String name, String definition)
     ...
     */
    private void
    au(String name, String definition, String symbol)
	throws UnitExistsException,
	    NoSuchUnitException,
	    UnitParseException,
	    SpecificationException,
     ...
     */
    private void
    au(String name, String definition, String symbol, String plural)
	throws UnitExistsException,
	    NoSuchUnitException,
	    UnitParseException,
	    SpecificationException,
	    ...
	    UnitSystemException
    {
	Unit	unit = format.parse(definition, this);
	if (unit == null)
     ...
     */
    private void
    aa(String alias, String name, String plural)
	throws UnitExistsException,
	    NoSuchUnitException,
	    UnitParseException,
	    SpecificationException,
     ...
     */
    private void
    aa(String alias, String name, String plural, String symbol)
	throws UnitExistsException,
	    NoSuchUnitException,
	    UnitParseException,
	    SpecificationException,
	...
	throws Exception
    {
	UnitDB	db = StandardUnitDB.instance();
