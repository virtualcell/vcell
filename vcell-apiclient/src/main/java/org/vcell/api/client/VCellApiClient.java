...
public class VCellApiClient implements AutoCloseable {
        ...
        public String handleResponse(HttpResponse response) throws IOException {
            ...
            if (status >= 200 && status < 300) {
                ...
                if (this.httpget != null) {
                    uri = this.httpget.getURI();
                } else {
                    uri = this.httppost.getURI();
                }
                lg.error(this.methodCallString + " (" + uri + ") failed: response status: " + status + "\nreason: " + message);
                throw new HttpResponseException(status, this.methodCallString + " failed: response status: " + status + "\nreason: " + message);
            }
        }
    }
    ...
    private void initClient() throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        ...
        if (this.bIgnoreCertProblems) {
            builder.loadTrustMaterial(null, new TrustSelfSignedStrategy());
        }
        SSLConnectionSocketFactory sslsf = null;

        if (this.bIgnoreHostMismatch) {
...
//				System.getProperty(NetworkProxyUtils.PROXY_SOCKS_HOST);
        ...
        this.httpclient = httpClientBuilder.setRedirectStrategy(new DefaultRedirectStrategy()).build();
    ...
    public SimulationTaskRepresentation[] getSimTasks(SimTasksQuerySpec simTasksQuerySpec) throws IOException {
        ...
        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/simtask?" + simTasksQuerySpec.getQueryString());
        httpget.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));

        if (lg.isInfoEnabled()) {
            lg.info("Executing request to retrieve simulation tasks " + httpget.getRequestLine());
        }

        String responseBody = this.httpclient.execute(httpget, new VCellStringResponseHandler("getSimTasks()", httpget), this.httpClientContext);
    ...
    private String getApiUrlPrefix() {
        final String scheme = this.httpHost.getSchemeName();
        if (this.httpHost.getPort() != 443) {
            return scheme + "://" + this.httpHost.getHostName() + ":" + this.httpHost.getPort() + this.pathPrefix_v0;
        } else {
            return scheme + "://" + this.httpHost.getHostName() + this.pathPrefix_v0;
        }
    }

    public BiomodelRepresentation[] getBioModels(BioModelsQuerySpec bioModelsQuerySpec) throws IOException {

        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/biomodel?" + bioModelsQuerySpec.getQueryString());
        httpget.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httpget, new VCellStringResponseHandler("getBioModels()", httpget), this.httpClientContext);
    ...
    public EventWrapper[] getEvents(long beginTimestamp) throws IOException {
        ...
        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/events?beginTimestamp=" + beginTimestamp);
        httpget.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httpget, new VCellStringResponseHandler("getEvents()", httpget), this.httpClientContext);
    ...
    public BiomodelRepresentation getBioModel(String bmId) throws IOException {
        ...
        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/biomodel/" + bmId);
        httpget.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httpget, new VCellStringResponseHandler("getBioModel()", httpget), this.httpClientContext);
        String bimodelsJson = responseBody;
        if (lg.isInfoEnabled()) {
            lg.info("returned: " + toStringTruncated(bimodelsJson));
        }
    ...
    public String getBioModelVCML(String bmId) throws IOException {
        ...
        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/biomodel/" + bmId + "/biomodel.vcml");
        httpget.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httpget, new VCellStringResponseHandler("getBioModelVCML()", httpget), this.httpClientContext);
    ...
    public SimulationRepresentation getSimulation(String bmId, String simKey) throws IOException {
        ...
        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/biomodel/" + bmId + "/simulation/" + simKey);
        httpget.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httpget, new VCellStringResponseHandler("getSimulation()", httpget), this.httpClientContext);
    ...
    public String getOptRunJson(String optimizationId, boolean bStop) throws IOException {
        ...
        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/optimization/" + optimizationId + "?bStop=" + bStop);
        httpget.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httpget, new VCellStringResponseHandler("getOptRunJson()", httpget), this.httpClientContext);
        if (lg.isInfoEnabled()) {
    ...
    public String submitOptimization(String optProblemJson) throws IOException, URISyntaxException {
        ...
        HttpPost httppost = new HttpPost(this.getApiUrlPrefix() + "/optimization");
        httppost.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
...
//					return uri.toString();
        ...
        String responseUri = this.httpclient.execute(httppost, handler, this.httpClientContext);
        if (lg.isInfoEnabled()) {
...
//		return optimizationId;
    ...
    public SimulationTaskRepresentation[] startSimulation(String bmId, String simKey) throws IOException {
        ...
        HttpPost httppost = new HttpPost(this.getApiUrlPrefix() + "/biomodel/" + bmId + "/simulation/" + simKey + "/startSimulation");
        httppost.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httppost, new VCellStringResponseHandler("startSimulation()", httppost), this.httpClientContext);
    ...
    public SimulationTaskRepresentation[] stopSimulation(String bmId, String simKey) throws IOException {
        ...
        HttpPost httppost = new HttpPost(this.getApiUrlPrefix() + "/biomodel/" + bmId + "/simulation/" + simKey + "/stopSimulation");
        httppost.addHeader("Authorization", "Bearer " + this.httpClientContext.getUserToken(String.class));
        ...
        String responseBody = this.httpclient.execute(httppost, new VCellStringResponseHandler("stopSimulation()", httppost), this.httpClientContext);
        String simTaskReps = responseBody;
        if (lg.isInfoEnabled()) {
            lg.info("returned: " + toStringTruncated(simTaskReps));
        }
    ...
    public void createDefaultQuarkusClient(boolean bIgnoreCertProblems) {
        this.apiClient = new ApiClient() {{
            if (bIgnoreCertProblems) {
                this.setHttpClientBuilder(CustomApiClientCode.createInsecureHttpClientBuilder());
            }
            this.setHost(VCellApiClient.this.quarkusURL.getHost());
            this.setPort(VCellApiClient.this.quarkusURL.getPort());
            this.setBasePath(VCellApiClient.this.quarkusURL.getPath());
            this.setScheme(VCellApiClient.this.quarkusURL.getProtocol());
        }};
    }

    public void authenticate(boolean ignoreSSLCertProblems) throws URISyntaxException, IOException, ParseException, ApiException {
        this.apiClient = InteractiveLogin.login(authClientID, new URI(authDomain + "/authorize"),
                this.quarkusURL.toURI(), ignoreSSLCertProblems);
        this.apiClient.setScheme(this.quarkusURL.getProtocol());
    }
...
//		httpRequestBuilder.method("GET");
    ...
    public String getVCellUserNameFromAuth0Mapping() throws ApiException {
        try {
            UsersResourceApi usersResourceApi = new UsersResourceApi(this.apiClient);
    ...
    public boolean isVCellIdentityMapped() throws ApiException {
        return this.getVCellUserNameFromAuth0Mapping() != null;
    }
    ...
    public AccesTokenRepresentationRecord getLegacyToken() throws ApiException {
        ...
        this.httpClientContext = HttpClientContext.create();
        this.httpClientContext.setUserToken(accesTokenRepresentationRecord.getToken());
    ...
    public UserInfo insertUserInfo(UserInfo newUserInfo) throws IOException, IllegalArgumentException {

        HttpPost httppost = new HttpPost(this.getApiUrlPrefix() + "/newuser");
        Gson gson = new Gson();
        ...
        ResponseHandler<UserInfo> handler = new ResponseHandler<UserInfo>() {
            ...
            public UserInfo handleResponse(final HttpResponse response) throws IOException {
                int status = response.getStatusLine().getStatusCode();
        ...
        UserInfo insertedUserInfo = this.httpclient.execute(httppost, handler, this.httpClientContext);
        if (lg.isInfoEnabled()) {
    ...
    public void sendLostPassword(String userid) throws IOException {
        HttpPost httppost = new HttpPost(this.getApiUrlPrefix() + "/lostpassword");
        ...
        String message = this.httpclient.execute(httppost, handler, this.httpClientContext);
        if (lg.isInfoEnabled()) {
    ...
    public Serializable sendRpcMessage(RpcDestination rpcDestination, VCellApiRpcRequest rpcRequest, boolean returnRequired, int timeoutMS, String[] specialProperties, Object[] specialValues) throws IOException {
        HttpPost httppost = new HttpPost(this.getApiUrlPrefix() + "/rpc");
        ...
        ResponseHandler<Serializable> handler = new ResponseHandler<Serializable>() {
            ...
            public Serializable handleResponse(final HttpResponse response) throws IOException {
                int status = response.getStatusLine().getStatusCode();
                if (lg.isInfoEnabled()) {
                ...
                if (status == 200) {
                    ...
                    try {
                        ...
                        if (returnRequired) {
                            if (returnValue instanceof Exception e) {
                                e.printStackTrace();
        ...
        Serializable returnedValue = this.httpclient.execute(httppost, handler, this.httpClientContext);
        if (lg.isInfoEnabled()) {
    ...
    public String getServerSoftwareVersion() throws IOException {

        HttpGet httpget = new HttpGet(this.getApiUrlPrefix() + "/swversion");

        if (lg.isInfoEnabled()) {
            lg.info("Executing request to retrieve server software version " + httpget.getRequestLine());
        }

        String vcellSoftwareVersion = this.httpclient.execute(httpget, new VCellStringResponseHandler("getServerSoftwareVersion()", httpget), this.httpClientContext);
        return vcellSoftwareVersion;
    }

    public static Serializable throwExceptionWithCause(HttpEntity entity, String rpcDestinationStr, String rpcRequestMethodName, int status) throws IOException {
//		HttpEntity entity = response.getEntity();
