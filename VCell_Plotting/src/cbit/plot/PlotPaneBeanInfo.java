...
©*/
/**
 * The bean information class for cbit.plot.PlotPane.
 */
public class PlotPaneBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.plot.PlotPane.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the PlotPaneBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.plot.PlotPane.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
