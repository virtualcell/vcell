 ...
 */
protected Plot2D(String[] names, double[][] dataValues, String[] labels, boolean[] visiblePlots) {
	/*
	...
	*/
	...
	initialize(names, plotDatas, labels, visiblePlots, null);
}
 ...
 */
public Plot2D(String[] names, PlotData[] plotDatas) {
	this(names, plotDatas, null, null);
}
 ...
 * @param labels java.lang.String[]
 */
public Plot2D(String[] names, PlotData[] plotDatas, String[] labels) {
	this(names, plotDatas, labels, null);
}
 ...
 * @param visiblePlots boolean[]
 */
public Plot2D(String[] names, PlotData[] plotDatas, String[] labels, boolean[] visiblePlots) {
	this(names, plotDatas, labels, visiblePlots, null);
}
 ...
 * @param visiblePlots boolean[]
 */
public Plot2D(String[] names, PlotData[] plotDatas, String[] labels, boolean[] visiblePlots, int[] argRenderHints) {
	initialize(names, plotDatas, labels, visiblePlots, argRenderHints);
}
 ...
 * @param visiblePlots boolean[]
 */
private void initialize(String[] names, PlotData[] plotDatas, String[] labels, boolean[] visiblePlots, int[] renderHints) {
