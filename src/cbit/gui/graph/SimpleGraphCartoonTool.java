...
public void layoutGlg() {
	...
	//
	java.util.Enumeration shapeEnum = getSimpleGraphModel().getShapes();
	...
	while (shapeEnum.hasMoreElements()) {
		...
		if (shape instanceof GraphEdgeShape) {
			GraphEdgeShape eShape = (GraphEdgeShape)shape;
			graph.AddEdge((com.genlogic.GraphLayout.GlgGraphNode)nodeMap.get(eShape.getNode1Shape()),(com.genlogic.GraphLayout.GlgGraphNode)nodeMap.get(eShape.getNode2Shape()),null, 0 ,null);
		}
	}
