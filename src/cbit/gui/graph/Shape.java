...
public abstract class Shape implements VisualState.Owner {
	...
	public final String getLabel() {
		if (label==null){ refreshLabel(); }
		return label;
	}

	public Point getLocation() { return relativePos; }

	public Point getLocationOnScreen(java.awt.Point canvasLoc) {
	...
	public Dimension getSize() { return shapeSize; }
	...
	public void removeAllChildren() { childShapeList.clear(); }
	...
	public void setDirty(boolean isDirty) { bDirty = isDirty; }
	...
	public String toString() {
		return getClass().getName()+"@"+Integer.toHexString(hashCode())+"("+getLabel()+")"; 
		// ="+getModelObject();
	}
