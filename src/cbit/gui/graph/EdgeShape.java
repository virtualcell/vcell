...
public abstract class EdgeShape extends Shape implements EdgeVisualState.Owner {
	...
	protected static final BasicStroke DASHED_STROKE =
		new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10f, new float[] { 5,3 }
		/*DASH_ARRAY*/, 10f);
	...
	protected CubicCurve2D.Double getCurve() {
		...
		if(lastCurve != null && 
			...
			lastCurve = 
				new CubicCurve2D.Double(start.getX(), start.getY(), p1ctrl.getX(), p1ctrl.getY(),
	...
	protected int getEndAttachment() { return ATTACH_CENTER; }
	public int getLineStyle() { return LINE_STYLE_SOLID; }
	...
	protected int getStartAttachment() { return ATTACH_CENTER; }
	...
	@Override public final boolean isOnBorder(Point p) { return isInside(p); }
	...
	@Override public void paintSelf(Graphics2D g2D, int xPos, int yPos) {
