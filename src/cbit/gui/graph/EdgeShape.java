 ...
 * 
 */
public abstract class EdgeShape extends Shape {
 ...
 * Creation date: (8/12/2002 10:32:35 PM)
 * @return java.awt.geom.Point2D
 * @param curve java.awt.geom.CubicCurve2D
 * @param t double
 */
...
public void layout() {
	...
	if (startShape!=null){
		...
		start.x += startShape.getParent().getAbsLocation().x;
		start.y += startShape.getParent().getAbsLocation().y;
	}
	
	if (endShape!=null){
		end = endShape.getAttachmentLocation(getEndAttachment());
		end.x += endShape.getParent().getAbsLocation().x;
		end.y += endShape.getParent().getAbsLocation().y;
	}
	
	screenPos.x = Math.min(start.x,end.x);
	screenPos.y = Math.min(start.y,end.y);
	screenSize.width = Math.abs(start.x-end.x);
	screenSize.height = Math.abs(start.y-end.y);
...
public void paint(java.awt.Graphics2D g2D, int parentOffsetX, int parentOffsetY) {
    ...
    paint0(g2D,parentOffsetX,parentOffsetY);
}
 ...
 * @param g java.awt.Graphics
 */
public void paint_NoAntiAlias(java.awt.Graphics2D g2D, int parentOffsetX, int parentOffsetY) {
 ...
 * @param g java.awt.Graphics
 */
private void paint0(java.awt.Graphics2D g2D, int parentOffsetX, int parentOffsetY) {
