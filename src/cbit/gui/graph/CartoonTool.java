...
public abstract class CartoonTool implements MouseListener, MouseMotionListener, ActionListener, KeyListener {
	...
	protected static final java.awt.Container getDialogOwner(GraphPane graphPaneSeekingOwner) {
		...
		Container dialogOwner = BeanUtils.findTypeParentOfComponent(graphPaneSeekingOwner,javax.swing.JDesktopPane.class);
		if (dialogOwner!=null){
			return dialogOwner;
		}

		dialogOwner = BeanUtils.findTypeParentOfComponent(graphPaneSeekingOwner,javax.swing.JFrame.class);
		if (dialogOwner!=null){
