...
public abstract class CartoonTool implements GraphView, MouseListener,
	...
	public final void actionPerformed(ActionEvent event) {
		...
		Shape[] popupMenuShape = getGraphModel().getSelectedShapes().toArray(new Shape[0]);
	...
	public void keyPressed(KeyEvent e) {
		...
		if ((e.getKeyCode() == KeyEvent.VK_C)
			...
			menuAction(getGraphModel().getSelectedShapes().toArray(new Shape[0]), CartoonToolEditActions.Copy.MENU_ACTION);
		}
		if ((e.getKeyCode() == KeyEvent.VK_X)
				&& ((e.getModifiers() & Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()) != 0)) {
			menuAction(getGraphModel().getSelectedShapes().toArray(new Shape[0]), CartoonToolEditActions.Cut.MENU_ACTION);
		}
		if ((e.getKeyCode() == KeyEvent.VK_V)
				&& ((e.getModifiers() & Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()) != 0)) {
			menuAction(getGraphModel().getSelectedShapes().toArray(new Shape[0]), CartoonToolEditActions.PasteNew.MENU_ACTION);
		}
		if ((e.getKeyCode() == KeyEvent.VK_DELETE) || (e.getKeyCode() == KeyEvent.VK_BACK_SPACE)) {
			menuAction(getGraphModel().getSelectedShapes().toArray(new Shape[0]), CartoonToolEditActions.Delete.MENU_ACTION);
		}
	}
	...
	protected abstract void menuAction(Shape[] shapes, String menuAction);
