...
©*/
/**
 * The bean information class for cbit.gui.ButtonGroupCivilized.
 */
public class ButtonGroupCivilizedBeanInfo extends java.beans.SimpleBeanInfo {
/**
 * Gets the add(javax.swing.AbstractButton) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor add_javaxswingAbstractButtonMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the add(javax.swing.AbstractButton) method descriptor. */
		...
		/* aDescriptor.setDisplayName("add(javax.swing.AbstractButton)"); */
		/* aDescriptor.setShortDescription("add(javax.swing.AbstractButton)"); */
...
public static java.lang.Class getBeanClass() {
	return cbit.gui.ButtonGroupCivilized.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ButtonGroupCivilizedBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.gui.ButtonGroupCivilized.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			add_javaxswingAbstractButtonMethodDescriptor()
			,setSelection_javalangStringMethodDescriptor()
		};
		return aDescriptorList;
	} catch (Throwable exception) {
		handleException(exception);
...
/**
 * Gets the selection property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor selectionPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the selection property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getSelection", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getSelection", 0);
			};
			...
			try {
				...
				aSetMethod = getBeanClass().getMethod("setSelection", aSetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setSelection", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("selection"
		...
		/* aDescriptor.setDisplayName("selection"); */
		/* aDescriptor.setShortDescription("selection"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		aDescriptor.setValue("preferred", new Boolean(true));
...
/**
 * Gets the setSelection(java.lang.String) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor setSelection_javalangStringMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the setSelection(java.lang.String) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
			...
			aMethod = getBeanClass().getMethod("setSelection", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "setSelection", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			aParameterDescriptor1.setName("arg1");
			aParameterDescriptor1.setDisplayName("actionCommand");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1
			};
			aDescriptor = new java.beans.MethodDescriptor(aMethod, aParameterDescriptors);
		...
		/* aDescriptor.setDisplayName("setSelection(java.lang.String)"); */
		/* aDescriptor.setShortDescription("setSelection(java.lang.String)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		aDescriptor.setValue("preferred", new Boolean(true));
	} catch (Throwable exception) {
