    ...
    implements cbit.vcell.server.VCellServer, java.rmi.Remote
{
    ...
    static {
	try {
	    $method_createSolverController_0 = cbit.vcell.server.VCellServer.class.getMethod("createSolverController", new java.lang.Class[] {cbit.vcell.server.User.class, cbit.vcell.solver.SimulationJob.class});
	    ...
	    $method_getVCellConnection_10 = cbit.vcell.server.VCellServer.class.getMethod("getVCellConnection", new java.lang.Class[] {cbit.vcell.server.User.class});
    ...
    public cbit.vcell.solvers.SolverController createSolverController(cbit.vcell.server.User $param_User_1, cbit.vcell.solver.SimulationJob $param_SimulationJob_2)
    ...
    public cbit.vcell.simdata.CacheStatus getCacheStatus()
	throws java.rmi.RemoteException
    {
	try {
	    Object $result = ref.invoke(this, $method_getCacheStatus_2, null, 7428034578312212220L);
	    return ((cbit.vcell.simdata.CacheStatus) $result);
	} catch (java.lang.RuntimeException e) {
	    throw e;
	} catch (java.rmi.RemoteException e) {
	    throw e;
    ...
    public cbit.vcell.server.User[] getConnectedUsers()
	throws java.rmi.RemoteException
    {
	try {
	...
	throws cbit.vcell.server.AuthenticationException, cbit.vcell.server.ConnectionException, cbit.vcell.server.DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public cbit.vcell.server.VCellConnection getVCellConnection(cbit.vcell.server.User $param_User_1)
