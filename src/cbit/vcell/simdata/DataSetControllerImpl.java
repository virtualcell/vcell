...
public VCData getVCData(VCDataIdentifier vcdID) throws DataAccessException, IOException {
	...
	if (vcData==null){
		if (vcdID instanceof MergedDataInfo) {
			...
			vcData = new SimulationData(vcdID, getPrimaryUserDir(vcdID.getOwner(), false), getSecondaryUserDir(vcdID.getOwner()),AmplistorUtils.getSimDataAmplistorInfoFromPropertyLoader());
