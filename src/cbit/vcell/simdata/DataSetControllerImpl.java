...
//			//Determine source VCSimulationDataIdentifier Style (old or new)
//			{
//				SimulationData tempSimData =
//					new SimulationData(sourceSimDataID,sourceDir);
//				isOldStyle =
//					(tempSimData.getResultsInfoObject() instanceof VCSimulationDataIdentifierOldStyle);
//			}
			//
			//log,mesh,zip,func
			//
...
//			VCDataIdentifier sourceSimDataID = fieldDataFileOperationSpec.specEDI;
//			if(sourceSimDataID == null && fieldDataFileOperationSpec.simInfo != null){
//				sourceSimDataID =
//					new VCSimulationDataIdentifier(
//						new VCSimulationIdentifier(
//								fieldDataFileOperationSpec.simInfo.getSimulationVersion().getVersionKey(),
//								fieldDataFileOperationSpec.simInfo.getOwner()),
//						0);
//			}
			...
			e.printStackTrace();
			throw new RuntimeException("Error during FieldDataFileOperationSpec INFO Operation\n"+e.getMessage());
		}
	}
