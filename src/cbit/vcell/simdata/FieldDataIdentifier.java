...
public class FieldDataIdentifier implements java.io.Serializable  {
	private cbit.sql.KeyValue key = null;
...
public static FieldDataIdentifier fromCSVString(String inputString) {
	...
	return new FieldDataIdentifier(new cbit.sql.KeyValue(st.nextToken()), st.nextToken(), st.nextToken(), st.nextToken(), 
 ...
 * @return java.lang.String
 */
public static String getGlobalVariableName_C(cbit.vcell.field.FieldDataIdentifierSpec fdis) {
 ...
 * @return java.lang.String
 */
public static String getLocalVariableName_C(cbit.vcell.field.FieldDataIdentifierSpec fdis) {
