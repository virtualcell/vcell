...
©*/
/**
 * The bean information class for cbit.vcell.simdata.gui.PDEPlotControlPanel.
 */
public class PDEPlotControlPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.simdata.gui.PDEPlotControlPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the PDEPlotControlPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.simdata.gui.PDEPlotControlPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
