...
/**
 * The bean information class for cbit.vcell.constraints.gui.ConstraintsGraphModelPanel.
 */
public class ConstraintsGraphModelPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.constraints.gui.ConstraintsGraphModelPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ConstraintsGraphModelPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.constraints.gui.ConstraintsGraphModelPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
