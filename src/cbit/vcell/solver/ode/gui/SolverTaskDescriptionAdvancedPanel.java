...
private void enableOutputOptionPanel() {
	...
	} else if (solverTaskDescription.getSolverDescription().equals(SolverDescription.LSODA) || solverTaskDescription.getSolverDescription().equals(SolverDescription.CVODE)) {
