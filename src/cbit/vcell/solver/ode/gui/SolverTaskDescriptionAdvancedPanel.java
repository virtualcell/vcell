...
import cbit.vcell.export.quicktime.atoms.SampleDescriptionEntry;
...
public class SolverTaskDescriptionAdvancedPanel extends javax.swing.JPanel implements java.awt.event.ActionListener, java.awt.event.FocusListener, java.awt.event.ItemListener, java.beans.PropertyChangeListener {
	...
	private final static String HYBRIDEM_DESCRIPTION = "This is a hybrid stochastic method. It partitions the system into subsets of fast and slow reactions and approximates the fast reactions as a continuous Markov process, using a chemical Langevin equation, and accurately describes the slow dynamics using the Gibson algorithm. Fixed time step Euler-Maruyama is used for approximate numerical solution of CLE.\n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
	                                                 "ENDING TIME: the time when simulation ends.\n"+
	...
	private final static String HYBRIDMIL_DESCRIPTION = "This is a hybrid stochastic method. It partitions the system into subsets of fast and slow reactions and approximates the fast reactions as a continuous Markov process, using a chemical Langevin equation, and accurately describes the slow dynamics using the Gibson algorithm. Fixed time step Milstein is used for approximate numerical solution of CLE.\n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
												     "ENDING TIME: the time when simulation ends.\n"+
												     "Default (SDE)TIME STEP: the maximum time step of the SDE numerical integrator.\n"+
	                                                 ...
	                                                 "H.Salis and Y.Kaznessis,'Accurate hybrid stochastic simulation of a system of coupled chemical or biochemical reactions', J. Chem. Phys. 122, 054103(2005).\n"+
	                                                 "H.Salis, V. Sotiropoulos and Y. Kaznessis,'Multiscale Hy3S: Hybrid stochastic simulation for supercomputers',BMC Bioinformatics 7:93(2006).";
	private final static String HYBRIDMILADAPTIVE_DESCRIPTION = "This is a hybrid stochastic method. It partitions the system into subsets of fast and slow reactions and approximates the fast reactions as a continuous Markov process, using a chemical Langevin equation, and accurately describes the slow dynamics using the Gibson algorithm. Adaptive time step Milstein is used for approximate numerical solution of CLE.\n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
												     "ENDING TIME: the time when simulation ends.\n"+
	                                                 ...
	                                                 "H.Salis and Y.Kaznessis,'Accurate hybrid stochastic simulation of a system of coupled chemical or biochemical reactions' ,J. Chem. Phys. 122, 054103(2005).\n"+
	                                                 "H.Salis, V. Sotiropoulos and Y. Kaznessis,'Multiscale Hy3S: Hybrid stochastic simulation for supercomputers' ,BMC Bioinformatics 7:93(2006).";
	private final static String FORWARDEULER_DESCRIPTION = "Forward Euler method is a fixed time step mehtod to solve ordinary differential equations. \n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
													 "ENDING TIME: the time when simulation ends.\n"+
	...
	private final static String RKSECOND_DESCRIPTION = "The Runge Kutta methods provide further systematic improvement in the spirit of the modified Euler method. Second order fixed time step method is also called the midpoint method.\n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
													 "ENDING TIME: the time when simulation ends.\n"+
												     "Default TIME STEP: the time step to numerically solve ODEs.\n\n"+
												     "Output options: use keep every number of samples among maximum number of time samples.";
	private final static String RKFOURTH_DESCRIPTION = "The Runge Kutta methods provide further systematic improvement in the spirit of the modified Euler method. the fourth order Runge Kutta method does four function evaluations per step to give a method with fourth order accuracy. It is a fixed time step method.\n\n"+
												  	 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
													 "ENDING TIME: the time when simulation ends.\n"+
												     "Default TIME STEP: the time step to numerically solve ODEs.\n\n"+
												     "Output options: use keep every number of samples among maximum number of time samples.";
	private final static String AMFIFTH_DESCRIPTION = "The methods such as Foward Euler, Runge-Kutta etc. are called single-step methods because they use only the information from one previous point to compute the successive point. Adams-Moulton methods are explicit linear multistep methods that depend on multiple previous solution points to generate a new approximate solution point. It is a fixed time step method.\n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
													 "ENDING TIME: the time when simulation ends.\n"+
												     "Default TIME STEP: the time step to numerically solve ODEs.\n\n"+
												     "Output options: use keep every number of samples among maximum number of time samples.";
	private final static String RKFEHLBERG_DESCRIPTION = "The Runge-Kutta-Fehlberg integrator is primarily designed to solve non-stiff and mildly stiff differential equations when derivative evaluations are inexpensive. It should generally not be used when the user is demanding high accuracy. It is a variable time step method.\n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
													 "ENDING TIME: the time when simulation ends.\n"+
												     ...
												     "Output options: use keep every number of samples among maximum number of time samples.";
	private final static String LSODA_DESCRIPTION =  "IDA addresses systems of differential-algebraic equations (DAEs), and uses Backward Differentiation Formula methods. ODEs are a subset of DAEs, therefore IDA may be used for solving ODEs. \n\n"+
													 "Parameters to be set for the method are,\n"+
	                                                 "STARTING TIME: the time when simulation starts.\n"+
													 "ENDING TIME: the time when simulation ends.\n"+
												     "Minimum TIME STEP: the minimum time stepsize that the LSODA should attempt to use.\n"+
												     "Maximum TIME STEP: the maxmum time stepsize that the LSODA should attempt to use.\n"+
												     "ABSOLUTE TOLERANCE: LSODA adjusts the stepsize in such a way as to keep the absolute error in a step less than absolute tolerance.\n"+
												     "RELATIVE TOLERANCE: LSODA adjusts the stepsize in such a way as to keep the fractional error in a step less than relative tolerance.\n\n"+
...
private void displayHelpInfo()
{
	if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.StochGibson))
		DialogUtils.showInfoDialog(GIBSON_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.HybridEuler))
		DialogUtils.showInfoDialog(HYBRIDEM_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.HybridMilstein))
		DialogUtils.showInfoDialog(HYBRIDMIL_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.HybridMilAdaptive))
		DialogUtils.showInfoDialog(HYBRIDMILADAPTIVE_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.ForwardEuler))
		DialogUtils.showInfoDialog(FORWARDEULER_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.RungeKutta2))
		DialogUtils.showInfoDialog(RKSECOND_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.RungeKutta4))
		DialogUtils.showInfoDialog(RKFOURTH_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.RungeKuttaFehlberg))
		DialogUtils.showInfoDialog(RKFEHLBERG_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.AdamsMoulton))
		DialogUtils.showInfoDialog(AMFIFTH_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.LSODA))
		DialogUtils.showInfoDialog(LSODA_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.CVODE))
		DialogUtils.showInfoDialog(CVODE_DESCRIPTION);
	else if(getTornOffSolverTaskDescription().getSolverDescription().equals(SolverDescription.FiniteVolume))
		DialogUtils.showInfoDialog(FINITEVOLUME_DESCRIPTION);
}
