...
©*/
/**
 * The bean information class for cbit.vcell.solver.ode.gui.SolverTaskDescriptionPanel.
 */
public class SolverTaskDescriptionPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.solver.ode.gui.SolverTaskDescriptionPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the SolverTaskDescriptionPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.solver.ode.gui.SolverTaskDescriptionPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
