...
public class SolverDescription implements java.io.Serializable, cbit.util.Matchable {
	...
	private static final int TYPE_IDA_NOT_USED = 100;
	private static final String IDA_DESCRIPTION = "IDA (Variable Order, Variable Time Step, ODE/DAE)"; 
...
public static SolverDescription fromName(String solverName) {
	...
	if (solverName.equals(IDA_DESCRIPTION)) {
		throw new IllegalArgumentException("IDA Solver not supported in this version.\nPlease use VCell 4.5 or later to open this model.");
	}
