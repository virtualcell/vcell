 ...
 * 
 */
public class MathDescription implements cbit.sql.Versionable, Matchable, SymbolTable, Serializable {
 ...
 */
public cbit.vcell.field.FieldDataIdentifierSpec[] getFieldDataIdentifierSpecs(cbit.vcell.solver.Simulation simulation) throws Exception {
	...
	while (enum1.hasMoreElements()){
		...
		while (enum_equ.hasMoreElements()){
			...
			for (int i = 0; i < exs.size(); i ++) {
				...
				cbit.vcell.field.FieldDataIdentifierSpec[] fieldIDSpecs = exp2.getFieldDataIdentifierSpecs();
	...
	cbit.vcell.field.FieldDataIdentifierSpec[] fdiss = new cbit.vcell.field.FieldDataIdentifierSpec[v.size()];
	v.copyInto(fdiss);
	return fdiss;
}
