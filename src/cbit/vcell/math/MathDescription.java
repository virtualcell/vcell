...
public class MathDescription implements Versionable, Matchable, SymbolTable, Serializable,FieldFunctionContainer {
	...
	private HashMap<String, SymbolTableFunctionEntry> functionHashTable = new HashMap<String, SymbolTableFunctionEntry>();
	...
	public final static SymbolTableFunctionEntry Function_regionArea_indexed = MathFunctionDefinitions.createDeferedFunctionEntry(MathFunctionDefinitions.FUNCTION_regionarea_indexed, VCUnitDefinition.UNIT_um2, null);
	public final static SymbolTableFunctionEntry Function_regionArea_current = MathFunctionDefinitions.createDeferedFunctionEntry(MathFunctionDefinitions.FUNCTION_regionarea_current, VCUnitDefinition.UNIT_um2, null);
	public final static SymbolTableFunctionEntry Function_regionVolume_indexed = MathFunctionDefinitions.createDeferedFunctionEntry(MathFunctionDefinitions.FUNCTION_regionvolume_indexed, VCUnitDefinition.UNIT_um3, null);
	public final static SymbolTableFunctionEntry Function_regionVolume_current = MathFunctionDefinitions.createDeferedFunctionEntry(MathFunctionDefinitions.FUNCTION_regionvolume_current, VCUnitDefinition.UNIT_um3, null);
	public final static SymbolTableFunctionEntry Function_field = MathFunctionDefinitions.createDeferedFunctionEntry(MathFunctionDefinitions.FUNCTION_field, VCUnitDefinition.UNIT_TBD, null);
...
public SymbolTableEntry getEntry(String id) throws ExpressionBindingException {
	...
	entry = functionHashTable.get(id);
	if (entry!=null){
		return entry;
	}
...
private void rebuildFunctionList(){
	functionHashTable.clear();
	functionHashTable.put(Function_regionArea_indexed.getName(),Function_regionArea_indexed);
	functionHashTable.put(Function_regionArea_current.getName(),Function_regionArea_current);
	functionHashTable.put(Function_regionVolume_indexed.getName(),Function_regionVolume_indexed);
	functionHashTable.put(Function_regionVolume_current.getName(),Function_regionVolume_current);
	functionHashTable.put(Function_field.getName(),Function_field);
}
