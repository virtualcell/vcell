...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			...
			,readFromFile_cbitvcellmathCommentStringTokenizer_cbitvcellserverUserMetaDbServerMethodDescriptor()
...
/**
 * Gets the readFromFile(cbit.vcell.math.CommentStringTokenizer, cbit.vcell.server.UserMetaDbServer) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor readFromFile_cbitvcellmathCommentStringTokenizer_cbitvcellserverUserMetaDbServerMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the readFromFile(cbit.vcell.math.CommentStringTokenizer, cbit.vcell.server.UserMetaDbServer) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.vcell.math.CommentStringTokenizer.class,
				cbit.vcell.server.UserMetaDbServer.class
			};
			aMethod = getBeanClass().getMethod("readFromFile", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "readFromFile", 2);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			...
			java.beans.ParameterDescriptor aParameterDescriptor2 = new java.beans.ParameterDescriptor();
			aParameterDescriptor2.setName("arg2");
			aParameterDescriptor2.setDisplayName("userDbServer");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1,
				aParameterDescriptor2
			};
		...
		/* aDescriptor.setDisplayName("readFromFile(cbit.vcell.math.CommentStringTokenizer, cbit.vcell.server.UserMetaDbServer)"); */
		/* aDescriptor.setShortDescription("readFromFile(cbit.vcell.math.CommentStringTokenizer, cbit.vcell.server.UserMetaDbServer)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
