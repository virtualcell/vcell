...
private void connEtoM20() {
	try {
		// user code begin {1}
		// user code end
		getFlattenButton().setVisible(this.getFlattenVisibility());
		// user code begin {2}
		// user code end
	} catch (java.lang.Throwable ivjExc) {
		// user code begin {3}
...
private javax.swing.JButton getCreateConstrSolnButton() {
	if (ivjCreateConstrSolnButton == null) {
		try {
			...
			ivjCreateConstrSolnButton.setText("=>constr");
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private javax.swing.JButton getExpandFunctionButton() {
	if (ivjExpandFunctionButton == null) {
		try {
			...
			ivjExpandFunctionButton.setText("f()=>");
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private javax.swing.JButton getSensitivitySolnButton() {
	if (ivjSensitivitySolnButton == null) {
		try {
			...
			ivjSensitivitySolnButton.setText("=>sens");
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
public void search() {
    ...
    String content = getlineNumberedTextArea1().getText();
