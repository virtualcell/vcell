 ...
 * @author: Ion Moraru
 */
public class WorkingServiceDatabase extends AbstractVCellWorkingService {

/**
 * DaemonService constructor comment.
 */
public WorkingServiceDatabase() {
...
void startWork() throws java.lang.Throwable {
	new cbit.vcell.messaging.server.DatabaseServer(getName()).start();
