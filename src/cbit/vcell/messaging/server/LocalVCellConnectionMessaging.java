...
public class LocalVCellConnectionMessaging extends UnicastRemoteObject implements VCellConnection, ExportListener ,DataJobListener{
	...
	messageService = new SimpleMessageServiceMessaging(jmsConn, this.userLoginInfo.getUser(), sessionLog);	
	sessionLog.print("new LocalVCellConnectionMessaging(" + this.userLoginInfo.getUser().getName() + ")");	
