    ...
    implements cbit.vcell.server.DataSetController, java.rmi.Remote
{
	...
	try {
	    ...
	    $method_getLineScan_7 = cbit.vcell.server.DataSetController.class.getMethod("getLineScan", new java.lang.Class[] {cbit.vcell.server.VCDataIdentifier.class, java.lang.String.class, double.class, cbit.vcell.simdata.gui.SpatialSelection.class});
    ...
    public cbit.plot.PlotData getLineScan(cbit.vcell.server.VCDataIdentifier $param_VCDataIdentifier_1, java.lang.String $param_String_2, double $param_double_3, cbit.vcell.simdata.gui.SpatialSelection $param_SpatialSelection_4)
	throws cbit.vcell.server.DataAccessException, java.rmi.RemoteException
    {
	try {
