 ...
 * @author: Fei Gao
 */
public class SimpleJobStatusPersistent implements ComparableObject {
	private String simname = null;
	private String userID = null;
	private SimulationJobStatusPersistent jobStatus = null;
 ...
 */
public SimpleJobStatusPersistent(String simname, String user, SimulationJobStatusPersistent arg_jobStatus, SolverTaskDescription arg_solverTaskDesc, Integer meshSpecX, Integer meshSpecY, Integer meshSpecZ, Integer scanCount, BioModelLink bioModelLink, MathModelLink mathModelLink) {	
	super();
