...
public class PDEDataViewerPostProcess extends JPanel implements DataJobListener{
	...
	public static PostProcessDataPDEDataContext createPostProcessPDEDataContext(final NewClientPDEDataContext parentPDEDataContext) throws Exception{
...
//						}
	...
	public static class PostProcessDataPDEDataContext extends NewClientPDEDataContext{
...
//				System.out.println("showing "+childwindows[i].getTitle()+" "+childwindows[i].getContentPane().getClass().getName());
	...
	public void setParentPDEDataContext(NewClientPDEDataContext parentPdeDataContext){
