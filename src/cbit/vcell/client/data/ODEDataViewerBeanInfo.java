...
/**
 * The bean information class for cbit.vcell.client.data.ODEDataViewer.
 */
public class ODEDataViewerBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the exportMonitorPanel property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor exportMonitorPanelPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the exportMonitorPanel property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getExportMonitorPanel", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getExportMonitorPanel", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			aDescriptor = new java.beans.PropertyDescriptor("exportMonitorPanel"
			, aGetMethod, aSetMethod);
		} catch (Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		/* aDescriptor.setBound(false); */
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("exportMonitorPanel"); */
		/* aDescriptor.setShortDescription("exportMonitorPanel"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
		/* aDescriptor.setValue("ivjDesignTimeProperty", new Boolean(true)); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.data.ODEDataViewer.class;
}
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.client.data.ODEDataViewer";
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ODEDataViewerBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.data.ODEDataViewer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.PropertyDescriptor[] getPropertyDescriptors() {
	try {
		java.beans.PropertyDescriptor aDescriptorList[] = {
			...
			,exportMonitorPanelPropertyDescriptor()
	...
	try {
		try {
			...
			try {
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setSimulation", 1);
			};
