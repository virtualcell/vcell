...
/**
 * The bean information class for cbit.vcell.client.data.PDEDataViewer.
 */
public class PDEDataViewerBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.data.PDEDataViewer.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the PDEDataViewerBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.data.PDEDataViewer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
