...
public class PlotData implements org.apache.thrift.TBase<PlotData, PlotData._Fields>, java.io.Serializable, Cloneable, Comparable<PlotData> {
  ...
  static {
    schemes.put(StandardScheme.class, new PlotDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PlotDataTupleSchemeFactory());
  }

  public List<Double> timePoints; // required
  ...
  public PlotData setTimePoints(List<Double> timePoints) {
    this.timePoints = timePoints;
    return this;
  }
  ...
  public PlotData setData(List<Double> data) {
    this.data = data;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TIME_POINTS:
      if (value == null) {
        ...
        setTimePoints((List<Double>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_timePoints = true && (isSetTimePoints());
    list.add(present_timePoints);
  ...
  public int compareTo(PlotData other) {
    ...
    lastComparison = Boolean.valueOf(isSetTimePoints()).compareTo(other.isSetTimePoints());
    if (lastComparison != 0) {
  ...
  private static class PlotDataStandardSchemeFactory implements SchemeFactory {
    public PlotDataStandardScheme getScheme() {
      return new PlotDataStandardScheme();
    }
  }

  private static class PlotDataStandardScheme extends StandardScheme<PlotData> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.timePoints = new ArrayList<Double>(_list0.size);
                double _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new ArrayList<Double>(_list3.size);
                double _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = iprot.readDouble();
                  struct.data.add(_elem4);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PlotData struct) throws org.apache.thrift.TException {
      ...
      if (struct.timePoints != null) {
        oprot.writeFieldBegin(TIME_POINTS_FIELD_DESC);
        {
          ...
          for (double _iter6 : struct.timePoints)
          {
  ...
  private static class PlotDataTupleSchemeFactory implements SchemeFactory {
    public PlotDataTupleScheme getScheme() {
      return new PlotDataTupleScheme();
    }
  }

  private static class PlotDataTupleScheme extends TupleScheme<PlotData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PlotData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (double _iter8 : struct.timePoints)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PlotData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.timePoints = new ArrayList<Double>(_list10.size);
        double _elem11;
        for (int _i12 = 0; _i12 < _list10.size; ++_i12)
        {
          _elem11 = iprot.readDouble();
          struct.timePoints.add(_elem11);
        }
      }
      struct.setTimePointsIsSet(true);
      {
        ...
        struct.data = new ArrayList<Double>(_list13.size);
        double _elem14;
