...
public class SimulationDataSetRef implements org.apache.thrift.TBase<SimulationDataSetRef, SimulationDataSetRef._Fields>, java.io.Serializable, Cloneable, Comparable<SimulationDataSetRef> {
  ...
  public List<VariableInfo> variableList; // optional
  ...
  public SimulationDataSetRef setVariableList(List<VariableInfo> variableList) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.variableList = new ArrayList<VariableInfo>(_list0.size);
                VariableInfo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new VariableInfo();
                  _elem1.read(iprot);
      ...
      if (struct.variableList != null) {
        if (struct.isSetVariableList()) {
          oprot.writeFieldBegin(VARIABLE_LIST_FIELD_DESC);
          {
            ...
            for (VariableInfo _iter3 : struct.variableList)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetVariableList()) {
        {
          ...
          for (VariableInfo _iter4 : struct.variableList)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.variableList = new ArrayList<VariableInfo>(_list5.size);
          VariableInfo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new VariableInfo();
            _elem6.read(iprot);
