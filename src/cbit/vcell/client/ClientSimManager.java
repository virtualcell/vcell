 ...
 */
public cbit.vcell.solver.ode.gui.SimulationStatus getSimulationStatus(cbit.vcell.solver.Simulation simulation) {
 ...
 * @param simulations cbit.vcell.solver.Simulation[]
 */
public void showSimulationStatusDetails(cbit.vcell.solver.Simulation[] simulations) {
	if (simulations != null) {
		//Vector v = new Vector();
		//for (int i = 0; i < simulations.length; i++){
