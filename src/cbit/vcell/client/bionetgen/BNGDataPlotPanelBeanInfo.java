...
/**
 * The bean information class for cbit.vcell.client.bionetgen.BNGDataPlotPanel.
 */
public class BNGDataPlotPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.bionetgen.BNGDataPlotPanel.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the BNGDataPlotPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.bionetgen.BNGDataPlotPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
