...
public class BioPaxObjectShape extends ElipseShape {
	...
	public void paintSelf(Graphics2D g, int absPosX, int absPosY ) {
		...
		absPosX = Math.abs(new Random().nextInt())%300;
		absPosY = Math.abs(new Random().nextInt())%300;
