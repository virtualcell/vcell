...
/**
 * The bean information class for cbit.vcell.client.desktop.biomodel.MathViewer.
 */
public class MathViewerBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.desktop.biomodel.MathViewer.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the MathViewerBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.desktop.biomodel.MathViewer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
