...
public class BioModelEditorModelParameterTableModel extends BioModelEditorRightSideTableModel<Parameter> implements java.beans.PropertyChangeListener {

	static class ParameterColumnComparator implements Comparator<Parameter> {
		protected int index;
