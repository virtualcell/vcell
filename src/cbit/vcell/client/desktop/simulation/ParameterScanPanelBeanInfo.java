...
/**
 * The bean information class for cbit.vcell.client.desktop.simulation.ParameterScanPanel.
 */
public class ParameterScanPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the constantArraySpec property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor constantArraySpecPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the constantArraySpec property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getConstantArraySpec", aGetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getConstantArraySpec", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setConstantArraySpec", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("constantArraySpec"
			, aGetMethod, aSetMethod);
		} catch (java.lang.Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("constantArraySpec"); */
		/* aDescriptor.setShortDescription("constantArraySpec"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.desktop.simulation.ParameterScanPanel.class;
}
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.client.desktop.simulation.ParameterScanPanel";
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ParameterScanPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.desktop.simulation.ParameterScanPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.PropertyDescriptor[] getPropertyDescriptors() {
	try {
		java.beans.PropertyDescriptor aDescriptorList[] = {
			...
			,constantArraySpecPropertyDescriptor()
		};
		return aDescriptorList;
	} catch (java.lang.Throwable exception) {
		handleException(exception);
