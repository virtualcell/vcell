	...
	switch (connStatus.getStatus()) {
		...
		case ConnectionStatus.CONNECTED: {
			...
			getSaveMenuItem().setEnabled(
				...
				!(
					getWindowManager().getVCDocument().getVersion().getFlag().compareEqual(org.vcell.util.document.VersionFlag.Archived) ||
					getWindowManager().getVCDocument().getVersion().getFlag().compareEqual(org.vcell.util.document.VersionFlag.Published)
				)
			);
