...
//		topPanel.add(paramPanel, BorderLayout.CENTER);
		...
		showROIbutton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				DialogUtils.showComponentCloseDialog(EstParams_OneDiffComponentPanel.this, roiImagePanel, "FRAP Model ROIs");
			}
		});
...
//	}
	...
	public FRAPDiffOneParamPanel getPureDiffusionPanel() {
