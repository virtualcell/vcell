...
public class ConfidenceIntervalTableModel extends AbstractTableModel
{
    ...
    public Object getValueAt(int row, int col) 
    {
    	...
    	{
			return summaryData.getConfidenceIntervals()[FRAPOptData.IDX_DELTA_ALPHA_80].toString();
    	}
    	else if(col == COLUMN_90PERCENT_CI)
    	{
    		return summaryData.getConfidenceIntervals()[FRAPOptData.IDX_DELTA_ALPHA_90].toString();
    	}
    	else if(col == COLUMN_95PERCENT_CI)
    	{
    		return summaryData.getConfidenceIntervals()[FRAPOptData.IDX_DELTA_ALPHA_95].toString();
    	}
    	else if(col == COLUMN_99PERCENT_CI)
    	{
    		return summaryData.getConfidenceIntervals()[FRAPOptData.IDX_DELTA_ALPHA_99].toString();
    	}
