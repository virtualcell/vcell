...
public java.beans.MethodDescriptor addImageSettingsPanelListener_cbitvcellexportImageSettingsPanelListenerMethodDescriptor() {
	...
	try {
		...
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.vcell.export.ImageSettingsPanelListener.class
			};
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.export.ImageSettingsPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.export.ImageSettingsPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor imageSettingsPanelJButtonCancelAction_actionPerformed_javautilEventObjectMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.export.ImageSettingsPanelListener.class).getMethod("JButtonCancelAction_actionPerformed", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.export.ImageSettingsPanelListener.class), "JButtonCancelAction_actionPerformed", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
...
public java.beans.MethodDescriptor imageSettingsPanelJButtonOKAction_actionPerformed_javautilEventObjectMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.export.ImageSettingsPanelListener.class).getMethod("JButtonOKAction_actionPerformed", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.export.ImageSettingsPanelListener.class), "JButtonOKAction_actionPerformed", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
