		...
		try {
			...
			try {
				...
				java.lang.Class anAddMethodParameterTypes[] = {
					cbit.vcell.export.ExportSettingsListener.class
				};
...
public java.beans.MethodDescriptor exportSettingsSettingsOK_ActionPerformed_javautilEventObjectMethodEventDescriptor() {
	...
	try {
		...
		try {
			...
			aMethod = (cbit.vcell.export.ExportSettingsListener.class).getMethod("SettingsOK_ActionPerformed", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.vcell.export.ExportSettingsListener.class), "SettingsOK_ActionPerformed", 1);
		};
		try {
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.export.ExportSettings.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.export.ExportSettings.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
