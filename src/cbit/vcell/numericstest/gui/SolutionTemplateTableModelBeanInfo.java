...
/**
 * The bean information class for cbit.vcell.numericstest.gui.SolutionTemplateTableModel.
 */
public class SolutionTemplateTableModelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the constructedSolutionTemplate property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor constructedSolutionTemplatePropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the constructedSolutionTemplate property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getConstructedSolutionTemplate", aGetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getConstructedSolutionTemplate", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					cbit.vcell.numericstest.ConstructedSolutionTemplate.class
				};
				aSetMethod = getBeanClass().getMethod("setConstructedSolutionTemplate", aSetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setConstructedSolutionTemplate", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("constructedSolutionTemplate"
			, aGetMethod, aSetMethod);
		} catch (java.lang.Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		aDescriptor.setBound(true);
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("constructedSolutionTemplate"); */
		/* aDescriptor.setShortDescription("constructedSolutionTemplate"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
		/* aDescriptor.setValue("ivjDesignTimeProperty", new java.lang.Boolean(true)); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.numericstest.gui.SolutionTemplateTableModel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the SolutionTemplateTableModelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.numericstest.gui.SolutionTemplateTableModel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.PropertyDescriptor[] getPropertyDescriptors() {
	try {
		java.beans.PropertyDescriptor aDescriptorList[] = {
			...
			,constructedSolutionTemplatePropertyDescriptor()
