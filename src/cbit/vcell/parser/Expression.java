...
parseCount++;
	try {
		if (exp.indexOf("vcRegionVolume('") >= 0 || exp.indexOf("vcRegionArea('") >= 0) {
			throw new SizeFunctionNotSupportedException("Size functions are not supported in VCell 4.7. Please use VCell 4.8 or later.\nExpression is " + exp);
		}
