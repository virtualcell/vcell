...
public final class AnonymizerBootstrap_Stub
    ...
    implements cbit.vcell.server.VCellBootstrap, java.rmi.Remote
{
	...
	try {
	    ...
	    $method_getVCellServer_1 = cbit.vcell.server.VCellBootstrap.class.getMethod("getVCellServer", new java.lang.Class[] {cbit.vcell.server.User.class, java.lang.String.class});
    ...
    // constructors
    public AnonymizerBootstrap_Stub(java.rmi.server.RemoteRef ref) {
	super(ref);
    }
	...
	throws cbit.vcell.server.AuthenticationException, cbit.vcell.server.DataAccessException, java.rmi.RemoteException
    {
	try {
    ...
    public cbit.vcell.server.VCellServer getVCellServer(cbit.vcell.server.User $param_User_1, java.lang.String $param_String_2)
	throws cbit.vcell.server.AuthenticationException, cbit.vcell.server.DataAccessException, cbit.vcell.server.PermissionException, java.rmi.RemoteException
    {
	try {
