...
public class VCellBuildIncludes {
	...
	private cbit.vcell.server.VCellServerTest vcellServerTest = null;  // needed by Servlets for AdminMain
	...
	private cbit.vcell.applets.ServerMonitor serverMonitor = null; // needed for standalone adminTool
	...
	private cbit.vcell.vcml.VCellSemanticTest vcellSemanticTest = null;		// Needed for SBML validation test suite ...
}