...
//	reaction = model.getReaction("IP3_Volume");
	sr = new SimpleReaction(model, cytosol, "IP3_DEGRADATION");
	sr.setModel(model);
	...
	sr = new SimpleReaction(model, cytosol, "IP3_BASAL_CREATION");
	sr.setModel(model);
	...
	sr1 = new SimpleReaction(model, cytosol, "IP3_DEGRADATION1");
	sr1.setModel(model);
...
//	reaction = model.getReaction("IP3_Receptor");
	sr = new SimpleReaction(model, erMembrane, "IP3_BINDING");
	sr.setModel(model);
...
//	reaction = model.getReaction("IP3_Volume");
	...
	sr1 = new SimpleReaction(model, cytosol, "IP3_DEGRADATION2");
	sr1.addReactant(ip3_cytosol,1);
	sr1.setKinetics(new HMM_IRRKinetics(sr1));
	HMM_IRRKinetics hmmKinetics = (HMM_IRRKinetics)sr1.getKinetics();
	hmmKinetics.setParameterValue(hmmKinetics.getVmaxParameter(),new Expression("10.0")); 
...
public static Model getExample_Wagner() throws Exception {
	...
	// Calcium Buffering
	//
	sr = new SimpleReaction(model, cytosol, "CA_BUFFERING");
...
//	massAct.setFast(true);
	...
	//
	sr = new SimpleReaction(model, ERmem, "CA_BINDING_ACT");
	sr.addReactant(Ca_cyt,1);
...
//	massAct.setFast(true);
	...
	//
	sr = new SimpleReaction(model, ERmem, "CA_BINDING_INH");
	sr.addReactant(Ca_cyt,1);
...
public static Model getExample2() throws Exception {
	...
	sr = new SimpleReaction(model, cytosol, "SIMPLE_REACTION_ABC");
	...
	sr = new SimpleReaction(model, cytosol, "SIMPLE_REACION_CDA");
...
//	massAct.setFast(false);
	...
	sr = new SimpleReaction(model, cytosol, "SIMPLE_REACTION_CDE");
	sr.addReactant(C_cyt,1);
	sr.addReactant(D_cyt,1);
...
//	massAct.setFast(true);
	...
	sr = new SimpleReaction(model, cytosol, "SIMPLE_REACTION_EAF");
...
public static Model getExampleForFluorescenceIndicatorProtocol() throws Exception {
	...
	sr = new SimpleReaction(model, cytosol, "SIMPLE_REACION_CDE");
	sr.addReactant(C_cyt,1);
	sr.addReactant(D_cyt,1);
	sr.addProduct(E_cyt,1);
	massAct = new MassActionKinetics(sr);
