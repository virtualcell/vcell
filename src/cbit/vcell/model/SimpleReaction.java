...
public SimpleReaction(Structure structure, KeyValue key, String name, String argAnnotation) throws PropertyVetoException {
...
public SimpleReaction(Structure structure, KeyValue key, String name) throws PropertyVetoException {
	this(structure, key, name, null);
}
public SimpleReaction(Structure structure, String name, String argAnnotation) throws PropertyVetoException {
	this(structure, null, name, argAnnotation);
}
public SimpleReaction(Structure structure, String name) throws PropertyVetoException {
	this(structure, null, name, null);
}
