...
public final void fromTokens(CommentStringTokenizer tokens) throws ExpressionException, PropertyVetoException {
	...
	try {
		...
		while (tokens.hasMoreTokens()){
			...
			// ignore token 'ChargeValence' : this is a role defined to store chargeValence in kinetics in VCell 5.3 and later. VCell versions < 5.3 do not have this token.
			if (token.equalsIgnoreCase(VCMODL.ChargeValence)){
				token = tokens.nextToken();
				KineticsParameter valenceParameter = getKineticsParameter(token);
