 ...
 * 
 */
public class Geometry implements cbit.vcell.document.VCDocument, cbit.sql.Versionable {
...
public String getVCML() {
	...
	if (getVersion() != null) {
		buffer.append(VCML.Geometry + " " + getVersion().getName() + " {\n");
	} else {
		buffer.append(VCML.Geometry + " <null geometryName> {\n");
	}
	// Delegate the rest to the child...
	buffer.append(getGeometrySpec().getVCML());
	//
	buffer.append("}\n");
