...
/**
 * The bean information class for cbit.vcell.geometry.gui.ResolvedLocationTableModel.
 */
public class ResolvedLocationTableModelBeanInfo extends java.beans.SimpleBeanInfo {
/**
	...
	try {
		try {
			...
			try {
				...
				aSetMethod = getBeanClass().getMethod("setGeometrySurfaceDescription", aSetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.geometry.gui.ResolvedLocationTableModel.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ResolvedLocationTableModelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.geometry.gui.ResolvedLocationTableModel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
