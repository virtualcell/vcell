...
/**
 * The bean information class for cbit.vcell.geometry.gui.SurfaceViewer.
 */
public class SurfaceViewerBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.geometry.gui.SurfaceViewer.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.geometry.gui.SurfaceViewer";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the SurfaceViewerBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.geometry.gui.SurfaceViewer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
	...
	try {
		try {
			...
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					cbit.vcell.geometry.surface.SurfaceCollection.class
				};
