...
©*/
/**
 * The bean information class for cbit.vcell.geometry.SubVolume.
 */
public class SubVolumeBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the SubVolumeBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.geometry.SubVolume.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the getHandle() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor getHandleMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the getHandle() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			...
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "getHandle", 0);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptors[] = {};
		...
		/* aDescriptor.setDisplayName("getHandle()"); */
		/* aDescriptor.setShortDescription("getHandle()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			getHandleMethodDescriptor()
			,getKeyMethodDescriptor()
			,getNameMethodDescriptor()
			,isInside_double_double_double_cbitvcellgeometryGeometryMethodDescriptor()
		};
		return aDescriptorList;
	} catch (Throwable exception) {
		handleException(exception);
...
/**
 * Gets the handle property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor handlePropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the handle property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getHandle", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getHandle", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			aDescriptor = new java.beans.PropertyDescriptor("handle"
		...
		/* aDescriptor.setDisplayName("handle"); */
		/* aDescriptor.setShortDescription("handle"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
...
/**
 * Gets the isInside(double, double, double, cbit.vcell.geometry.Geometry) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor isInside_double_double_double_cbitvcellgeometryGeometryMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the isInside(double, double, double, cbit.vcell.geometry.Geometry) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
			...
			aMethod = getBeanClass().getMethod("isInside", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "isInside", 4);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			...
			aParameterDescriptor4.setDisplayName("geometry");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
		...
		/* aDescriptor.setDisplayName("isInside(double, double, double, cbit.vcell.geometry.Geometry)"); */
		/* aDescriptor.setShortDescription("isInside(double, double, double, cbit.vcell.geometry.Geometry)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
...
/**
 * Gets the setName(java.lang.String, cbit.vcell.geometry.Geometry) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor setName_javalangString_cbitvcellgeometryGeometryMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the setName(java.lang.String, cbit.vcell.geometry.Geometry) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
			...
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "setName", 2);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
		...
		/* aDescriptor.setDisplayName("setName(java.lang.String, cbit.vcell.geometry.Geometry)"); */
		/* aDescriptor.setShortDescription("setName(java.lang.String, cbit.vcell.geometry.Geometry)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
