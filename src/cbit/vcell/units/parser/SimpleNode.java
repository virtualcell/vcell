...
public abstract class SimpleNode implements Node, Serializable {
  ...
  protected int id;
  protected UnitSymbolParser parser;

  public SimpleNode(int i) {
    id = i;
  }

  public SimpleNode(UnitSymbolParser p, int i) {
    this(i);
    parser = p;
  }
  ...
  public String toString() { return UnitSymbolParserTreeConstants.jjtNodeName[id] + "      " + toInfix(); }
