 ...
 */
@Override
public Expression getNormalizedConcentrationCorrection(SimulationContext simulationContext, UnitFactorProvider unitFactorProvider, StructureSizeValueProvider mathMapping) throws ExpressionException, MappingException {
	Expression exp = getSizeCorrection(simulationContext, mathMapping);
...
@Override
public Expression getStructureSizeCorrection(SimulationContext simulationContext, UnitFactorProvider unitFactorProvider, StructureSizeValueProvider mathMapping) throws ExpressionException, MappingException {
	return getSizeCorrection(simulationContext, mathMapping);
}

private Expression getSizeCorrection(SimulationContext simulationContext, StructureSizeValueProvider mathMapping) throws ExpressionException, MappingException {
	if (getGeometryClass() instanceof CompartmentSubVolume){
		if (simulationContext.getGeometryContext().isAllSizeSpecifiedPositive()) {
			...
			return mathMapping.computeAbsoluteStructureSizeValues(simulationContext, getStructure().getName()).sizeExp;
