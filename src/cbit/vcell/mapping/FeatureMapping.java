...
public String getVCML() throws Exception {
	...
	buffer.append("\t"+VCMODL.FeatureMapping+" "+getFeature().getName()+" {\n");
	buffer.append("\t\t"+VCML.SubVolume+" "+getSubVolume().getName()+"\n");
	buffer.append("\t\t"+VCMODL.Resolved+" "+getResolved()+"\n");
	//
	...
	for (int i=BoundaryLocation.FIRST;i<=BoundaryLocation.LAST;i++){
		...
		buffer.append("\t\t"+VCMODL.BoundaryCondition+" "+bl.toString()+" "+getBoundaryCondition(bl).toString()+"\n");
	}
	buffer.append("\t}\n");
