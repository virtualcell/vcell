...
©*/
/**
 * The bean information class for cbit.vcell.mapping.gui.ReactionSpecsPanel.
 */
public class ReactionSpecsPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.mapping.gui.ReactionSpecsPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ReactionSpecsPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.mapping.gui.ReactionSpecsPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
