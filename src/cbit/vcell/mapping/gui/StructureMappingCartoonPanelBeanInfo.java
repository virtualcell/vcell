...
©*/
/**
 * The bean information class for cbit.vcell.mapping.StructureMappingCartoonPanel.
 */
public class StructureMappingCartoonPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.mapping.gui.StructureMappingCartoonPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the StructureMappingCartoonPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.mapping.gui.StructureMappingCartoonPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			hasMappableGeometryMethodDescriptor()
...
/**
 * Gets the hasMappableGeometry() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor hasMappableGeometryMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the hasMappableGeometry() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("hasMappableGeometry", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "hasMappableGeometry", 0);
		};
		try {
		...
		/* aDescriptor.setDisplayName("hasMappableGeometry()"); */
		/* aDescriptor.setShortDescription("hasMappableGeometry()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
...
/**
 * Gets the init(cbit.vcell.mapping.SimulationContext) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor init_cbitvcellmappingSimulationContextMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the init(cbit.vcell.mapping.SimulationContext) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
		...
		try {
			...
			aParameterDescriptor1.setDisplayName("aSimulationContext");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
		...
		/* aDescriptor.setDisplayName("init(cbit.vcell.mapping.SimulationContext)"); */
		/* aDescriptor.setShortDescription("init(cbit.vcell.mapping.SimulationContext)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
