...
class PotentialMapping {
	...
	private MathMapping_4_8 fieldMathMapping = null;
 ...
 */
PotentialMapping(SimulationContext argSimContext, MathMapping_4_8 argMathMapping) {
	super();
 ...
 */
void computeMath() throws MathException, MappingException, ExpressionException, MatrixException {
 ...
 */
MembraneElectricalDevice getCapacitiveDevice(Membrane membrane) {
 ...
 */
ElectricalDevice[] getElectricalDevices() {
 ...
 * @return cbit.vcell.mapping.potential.Edge[]
 */
ElectricalDevice[] getElectricalDevices(Membrane membrane) {
 ...
 */
Expression getOdeRHS(MembraneElectricalDevice capacitiveDevice, MathMapping_4_8 mathMapping_4_8) throws ExpressionException, MappingException {
	NameScope nameScope = mathMapping_4_8.getNameScope();
