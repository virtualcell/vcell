...
/**
 */
class FastSystemAnalyzer implements SymbolTable {
	//
 ...
 */
FastSystemAnalyzer(FastSystem argFastSystem, SymbolTable argSymbolTable) throws MathException, ExpressionException {
	super();
 ...
 */
Enumeration<Expression> getDependencyExps() {
//	refreshAll();
 ...
 * @return java.util.Enumeration
 */
final Enumeration<Variable> getDependentVariables() {
//	refreshAll();
 ...
 * @return java.util.Enumeration
 */
final Enumeration<Variable> getIndependentVariables() {
//	refreshAll();
	return independentVarList.elements();
}

final Variable getIndependentVariable(int indx) {
//	refreshAll();
 ...
 */
PseudoConstant getPseudoConstant(String id) {
//	refreshAll();
 ...
 * @return java.util.Enumeration
 */
Enumeration<PseudoConstant> getPseudoConstants() {
//	refreshAll();
 ...
 * @return java.util.Enumeration
 */
Enumeration<Expression> getFastRateExpressions() {
