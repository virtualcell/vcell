...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.mapping.FeatureMapping.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.mapping.FeatureMapping.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor getBoundaryCondition_cbitvcellmappingBoundaryLocationMethodDescriptor() {
	...
	try {
		...
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.vcell.mapping.BoundaryLocation.class
			};
