...
/**
 * The bean information class for cbit.vcell.namescope.SimContextNameScopeTreeModel.
 */
public class SimContextNameScopeTreeModelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.namescope.SimContextNameScopeTreeModel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the SimContextNameScopeTreeModelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.namescope.SimContextNameScopeTreeModel.class);
