 ...
 * @author: Fei Gao
 */
public class CondorSolver extends HTCSolver {
	private static String CONDOR_SUBMIT_FILE_EXT = ".condor.sub";
/**
 ...
 */
public CondorSolver(cbit.vcell.messaging.server.SimulationTask simTask, java.io.File directory, cbit.vcell.server.SessionLog sessionLog) throws cbit.vcell.solver.SolverException {
...
public String submit2Condor() {
	...
	try {
		...
		String subFile = new File(getBaseName()).getPath() + CONDOR_SUBMIT_FILE_EXT;
		
		jobid = CondorUtils.submitJob(simulationTask.getComputeResource(), subFile, exeFile, cmdArguments);
		if (jobid == null) {
