...
public SolverControllerInfo(SolverProxy solverProxy) {
	try {
		this.simulationInfo = solverProxy.getSimulationJob().getSimulation().getSimulationInfo();
	...
	try {
		this.taskType = solverProxy.getSimulationJob().getSimulation().getSolverTaskDescription().getVCML();
	}catch (RemoteException e){}
	try {
