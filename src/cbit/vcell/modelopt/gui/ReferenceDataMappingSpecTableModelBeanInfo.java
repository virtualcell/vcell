...
/**
 * The bean information class for cbit.vcell.modelopt.gui.ReferenceDataMappingSpecTableModel.
 */
public class ReferenceDataMappingSpecTableModelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.modelopt.gui.ReferenceDataMappingSpecTableModel.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ReferenceDataMappingSpecTableModelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.modelopt.gui.ReferenceDataMappingSpecTableModel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
