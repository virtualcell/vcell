...
//added in Match 2008, to be used 
public void clearPane()
{
	this.remove(getplotPane());
	ivjplotPane = null;
	this.add(getplotPane(), "Center" );
}
...
//		setSize(568, 498);
//		setPreferredSize(new Dimension(((int)Toolkit.getDefaultToolkit().getScreenSize().getWidth()-400),650));
...
public void setListVisible(boolean arg1) {
	...
	getplotPane().invalidate();
	getplotPane().repaint();
	getReferenceDataListScrollPane().invalidate();
//	repaint();
