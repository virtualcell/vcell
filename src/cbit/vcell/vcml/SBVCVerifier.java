...
//	User user = new User("Administrator", new cbit.sql.KeyValue("2"));
	User user = new User("anu", new cbit.sql.KeyValue("2302355"));
		...
		try {
			...
			for (int k = 0; k < simContexts.length; k++){
				if (simContexts[k].getGeometry().getDimension() > 0) {
			        ...
			        SimulationVersion simVersion_1 = new SimulationVersion(new KeyValue("100"), "sim_1_1", simContexts[k].getVersion().getOwner(), new cbit.vcell.server.GroupAccessNone(), null, new java.math.BigDecimal(1.0), new java.util.Date(), VersionFlag.Archived, "", null);
			        ...
			        SimulationVersion simVersion_2 = new SimulationVersion(new KeyValue("100"), "sim_1_2", bioModel_1.getVersion().getOwner(), new cbit.vcell.server.GroupAccessNone(), null, new java.math.BigDecimal(1.0), new java.util.Date(), VersionFlag.Archived, "", null);
