...
public static void main(java.lang.String[] args) {
    try {
        ...
        vcell_simulate(sbmlString,endTime,numTimeSteps,outputFile,speciesNames);
    } catch (Throwable e) {
...
public static void vcell_simulate(String sbmlString, double endTime, int numTimeSteps, File outputFile, String[] speciesNames) throws Exception{
