	...
	try {
		try {
			...
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					cbit.vcell.geometry.gui.CurveRenderer.class
				};
	...
	try {
		try {
			...
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					cbit.vcell.simdata.gui.CurveValueProvider.class
				};
...
public static java.lang.Class getBeanClass() {
	return cbit.image.ImagePlaneManagerPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.image.ImagePlaneManagerPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor setSourceDataInfo_cbitimageSourceDataInfoMethodDescriptor() {
	...
	try {
		...
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.image.SourceDataInfo.class
			};
