 ...
 */
public VCImageUncompressed(cbit.sql.Version aVersion,byte pixels[], org.vcell.util.Extent aExtent, int aNumX, int aNumY, int aNumZ) throws ImageException {
 ...
 * @param annot java.lang.String
 */
public VCImageUncompressed(cbit.sql.Version aVersion,int sourceValues[], org.vcell.util.Extent aExtent, int aNumX, int aNumY, int aNumZ) throws ImageException {
	super(aVersion, aExtent, aNumX, aNumY, aNumZ);
