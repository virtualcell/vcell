...
©*/
/**
 * The bean information class for cbit.vcell.xml.XmlTreeViewer.
 */
public class XmlTreeViewerBeanInfo extends java.beans.SimpleBeanInfo {
/**
	...
	try {
		try {
			...
			try {
				...
				aSetMethod = getBeanClass().getMethod("setDocument", aSetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setDocument", 1);
			};
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.xml.XmlTreeViewer";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the XmlTreeViewerBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(XmlTreeViewer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
