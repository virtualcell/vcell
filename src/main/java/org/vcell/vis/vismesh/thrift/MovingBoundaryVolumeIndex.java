...
public class MovingBoundaryVolumeIndex implements org.apache.thrift.TBase<MovingBoundaryVolumeIndex, MovingBoundaryVolumeIndex._Fields>, java.io.Serializable, Cloneable, Comparable<MovingBoundaryVolumeIndex> {
  ...
  static {
    schemes.put(StandardScheme.class, new MovingBoundaryVolumeIndexStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MovingBoundaryVolumeIndexTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MovingBoundaryVolumeIndex(");
    boolean first = true;
  ...
  private static class MovingBoundaryVolumeIndexStandardSchemeFactory implements SchemeFactory {
    public MovingBoundaryVolumeIndexStandardScheme getScheme() {
      return new MovingBoundaryVolumeIndexStandardScheme();
    }
  }

  private static class MovingBoundaryVolumeIndexStandardScheme extends StandardScheme<MovingBoundaryVolumeIndex> {
  ...
  private static class MovingBoundaryVolumeIndexTupleSchemeFactory implements SchemeFactory {
    public MovingBoundaryVolumeIndexTupleScheme getScheme() {
      return new MovingBoundaryVolumeIndexTupleScheme();
    }
  }

  private static class MovingBoundaryVolumeIndexTupleScheme extends TupleScheme<MovingBoundaryVolumeIndex> {
