...
public class ShrinkCanvasLayouter extends ContainedGraphLayouter {

	public static final double SCALE = 1/1.1;
	public static final String LAYOUT_NAME = "Contained Graph Layout Shrink Canvas";
