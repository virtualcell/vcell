...
public class ImportRawTimeSeriesFromExperimentImagesOp {
	...
	public ImageTimeSeries<UShortImage> importRawTimeSeries(File[] expTimeSeriesFiles, double timeInterval) throws Exception {
		...
		ImageDataset rawTimeData = ImageDatasetReaderFactory.createImageDatasetReader().readImageDatasetFromMultiFiles(expTimeSeriesFiles, clientTaskStatusSupport , isTimeSeries, timeInterval);
