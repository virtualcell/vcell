...
public class ImportRawTimeSeriesFromExperimentImageOp {
	...
	public ImageTimeSeries<UShortImage> importRawTimeSeries(File expTimeSeriesFile) throws Exception {
		...
		ImageDataset rawTimeData = ImageDatasetReaderFactory.createImageDatasetReader().readImageDataset(expTimeSeriesFile.getAbsolutePath(), clientTaskStatusSupport);
