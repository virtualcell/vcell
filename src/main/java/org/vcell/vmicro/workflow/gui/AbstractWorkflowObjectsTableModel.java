...
public abstract class AbstractWorkflowObjectsTableModel<T> extends VCellSortTableModel<T> implements PropertyChangeListener, AutoCompleteTableModel {
	...
	public AbstractWorkflowObjectsTableModel(EditorScrollTable table) {
		super(table);
