 ...
 */
public class OptionPaneHandler implements PropertyChangeListener, WindowListener, WindowFocusListener, ComponentListener {
	//this was back ported from the logicalwindow system in 6.0+ to support Reconnect dialog
	final JOptionPane jOptionPane;
	private boolean gotFocus = false;
	private final Frame container;


	public OptionPaneHandler(Frame container, JOptionPane jOptionPane) {
