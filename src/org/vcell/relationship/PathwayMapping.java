 ...
 * @author vasilescu
 *
 *  WARNING! Major bug fixes were ported down here from v5.3
 *  		However, several helper classes were redesigned in 5.3 to support SABIO and kinetics and a complete porting was not possible because 
 *  		of the sheer size and side effects on the UI.
 *  		The compromise was to port only the code needed for the bug fixes and ignore/comment out the rest at the cost of spaghetti code
 *  		and sacrifices with the completeness of some classes.
 */
