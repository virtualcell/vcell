	...
	try {
		...
		if (args[0].equals("-import")) {
	        ...
	        try {
				...
				SBMLImporter sbmlImporter = new SBMLImporter(pathName, logger);
...
*/
		...
		CVodeFileWriter cvodeFileWriter = new CVodeFileWriter(cvodePW, new SimulationTask(simJob,0));
		...
		// String sundialsSolverExecutable = "C:\\Developer\\Eclipse\\workspace\\VCell5.2\\resources\\cbit\\vcell\\resource\\windows\\SundialsSolverStandalone.exe";
		Executable executable = new Executable(new String[]{"SundialsSolverStandalone", cvodeInputFile.getAbsolutePath(), cvodeOutputFile.getAbsolutePath()});
		executable.start();
