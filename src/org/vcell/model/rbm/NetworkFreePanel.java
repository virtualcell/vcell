...
public class NetworkFreePanel extends JPanel implements ApplicationSpecificationsPanel.Specifier {
	...
	private static String infoText = "<html>"
			...
			+ "existing Molecules, rules, species consisting of Molecules and Observables to the new BioModel.<br> "
			+ "For every species that had no molecular details, a new Molecule and a new Observable will be generated,<br> " 
...
//		gbc.fill = GridBagConstraints.HORIZONTAL;
	...
	private void refreshInterface() {
		...
		//		speciesText = s1 + "";
		//		speciesMoleculesText = s2 + "";
		//		futureSpeciesText = (s1+s2) + "";
...
//		futureRulesText = (r1+r2) + "";
		...
		futureMolecularTypesLabel.setText((m1+s1) + "");
		futureObservablesLabel.setText((o1+s1) +"");
