		...
		try { 
			...
			if (kind.equals(CELLMLTags.noDimUnit)) {             
				...
				if (unitDef != null) { 
					...
					Iterator siblingIterator = siblings.iterator();
					Element cellUnitDef = null;
					while (siblingIterator.hasNext()) {
						cellUnitDef = (Element)siblingIterator.next();
