...
public final boolean stopCellEditing() {
	...
	//
	if(lastTable.getModel() instanceof org.vcell.util.gui.TableCellValidator){
		final org.vcell.util.gui.TableCellValidator editValidate = (org.vcell.util.gui.TableCellValidator)lastTable.getModel();
		try{
			Object newValue = delegate.getCellEditorValue();
			org.vcell.util.gui.TableCellValidator.EditValidation editValidation = null;
