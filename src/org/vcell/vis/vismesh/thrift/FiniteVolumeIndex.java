...
public class FiniteVolumeIndex implements org.apache.thrift.TBase<FiniteVolumeIndex, FiniteVolumeIndex._Fields>, java.io.Serializable, Cloneable, Comparable<FiniteVolumeIndex> {
  ...
  static {
    schemes.put(StandardScheme.class, new FiniteVolumeIndexStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FiniteVolumeIndexTupleSchemeFactory());
  }
  ...
  public void unsetGlobalIndex() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __GLOBALINDEX_ISSET_ID);
  }

  /** Returns true if field globalIndex is set (has been assigned a value) and false otherwise */
  public boolean isSetGlobalIndex() {
    return EncodingUtils.testBit(__isset_bitfield, __GLOBALINDEX_ISSET_ID);
  }

  public void setGlobalIndexIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __GLOBALINDEX_ISSET_ID, value);
  }
  ...
  public void unsetRegionIndex() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __REGIONINDEX_ISSET_ID);
  }

  /** Returns true if field regionIndex is set (has been assigned a value) and false otherwise */
  public boolean isSetRegionIndex() {
    return EncodingUtils.testBit(__isset_bitfield, __REGIONINDEX_ISSET_ID);
  }

  public void setRegionIndexIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __REGIONINDEX_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case GLOBAL_INDEX:
      return Integer.valueOf(getGlobalIndex());

    case REGION_INDEX:
      return Integer.valueOf(getRegionIndex());
  ...
  public int hashCode() {
    ...
    boolean present_globalIndex = true;
    list.add(present_globalIndex);
    if (present_globalIndex)
      list.add(globalIndex);

    boolean present_regionIndex = true;
    list.add(present_regionIndex);
    if (present_regionIndex)
  ...
  public int compareTo(FiniteVolumeIndex other) {
    ...
    lastComparison = Boolean.valueOf(isSetGlobalIndex()).compareTo(other.isSetGlobalIndex());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetRegionIndex()).compareTo(other.isSetRegionIndex());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRegionIndex()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FiniteVolumeIndex(");
    boolean first = true;
  ...
  private static class FiniteVolumeIndexStandardSchemeFactory implements SchemeFactory {
    public FiniteVolumeIndexStandardScheme getScheme() {
      return new FiniteVolumeIndexStandardScheme();
    }
  }

  private static class FiniteVolumeIndexStandardScheme extends StandardScheme<FiniteVolumeIndex> {
  ...
  private static class FiniteVolumeIndexTupleSchemeFactory implements SchemeFactory {
    public FiniteVolumeIndexTupleScheme getScheme() {
      return new FiniteVolumeIndexTupleScheme();
    }
  }

  private static class FiniteVolumeIndexTupleScheme extends TupleScheme<FiniteVolumeIndex> {
