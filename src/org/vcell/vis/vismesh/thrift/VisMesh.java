            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.points = new ArrayList<VisPoint>(_list72.size);
                VisPoint _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new VisPoint();
                  _elem73.read(iprot);
                  struct.points.add(_elem73);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.polygons = new ArrayList<VisPolygon>(_list75.size);
                VisPolygon _elem76;
                for (int _i77 = 0; _i77 < _list75.size; ++_i77)
                {
                  _elem76 = new VisPolygon();
                  _elem76.read(iprot);
                  struct.polygons.add(_elem76);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.irregularPolyhedra = new ArrayList<VisIrregularPolyhedron>(_list78.size);
                VisIrregularPolyhedron _elem79;
                for (int _i80 = 0; _i80 < _list78.size; ++_i80)
                {
                  _elem79 = new VisIrregularPolyhedron();
                  _elem79.read(iprot);
                  struct.irregularPolyhedra.add(_elem79);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tetrahedra = new ArrayList<VisTetrahedron>(_list81.size);
                VisTetrahedron _elem82;
                for (int _i83 = 0; _i83 < _list81.size; ++_i83)
                {
                  _elem82 = new VisTetrahedron();
                  _elem82.read(iprot);
                  struct.tetrahedra.add(_elem82);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.visVoxels = new ArrayList<VisVoxel>(_list84.size);
                VisVoxel _elem85;
                for (int _i86 = 0; _i86 < _list84.size; ++_i86)
                {
                  _elem85 = new VisVoxel();
                  _elem85.read(iprot);
                  struct.visVoxels.add(_elem85);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.surfaceTriangles = new ArrayList<VisSurfaceTriangle>(_list87.size);
                VisSurfaceTriangle _elem88;
                for (int _i89 = 0; _i89 < _list87.size; ++_i89)
                {
                  _elem88 = new VisSurfaceTriangle();
                  _elem88.read(iprot);
                  struct.surfaceTriangles.add(_elem88);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.visLines = new ArrayList<VisLine>(_list90.size);
                VisLine _elem91;
                for (int _i92 = 0; _i92 < _list90.size; ++_i92)
                {
                  _elem91 = new VisLine();
                  _elem91.read(iprot);
                  struct.visLines.add(_elem91);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.surfacePoints = new ArrayList<VisPoint>(_list93.size);
                VisPoint _elem94;
                for (int _i95 = 0; _i95 < _list93.size; ++_i95)
                {
                  _elem94 = new VisPoint();
                  _elem94.read(iprot);
                  struct.surfacePoints.add(_elem94);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.points != null) {
        if (struct.isSetPoints()) {
          oprot.writeFieldBegin(POINTS_FIELD_DESC);
          {
            ...
            for (VisPoint _iter96 : struct.points)
            {
              _iter96.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.polygons != null) {
        if (struct.isSetPolygons()) {
          oprot.writeFieldBegin(POLYGONS_FIELD_DESC);
          {
            ...
            for (VisPolygon _iter97 : struct.polygons)
            {
              _iter97.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.irregularPolyhedra != null) {
        if (struct.isSetIrregularPolyhedra()) {
          oprot.writeFieldBegin(IRREGULAR_POLYHEDRA_FIELD_DESC);
          {
            ...
            for (VisIrregularPolyhedron _iter98 : struct.irregularPolyhedra)
            {
              _iter98.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.tetrahedra != null) {
        if (struct.isSetTetrahedra()) {
          oprot.writeFieldBegin(TETRAHEDRA_FIELD_DESC);
          {
            ...
            for (VisTetrahedron _iter99 : struct.tetrahedra)
            {
              _iter99.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.visVoxels != null) {
        if (struct.isSetVisVoxels()) {
          oprot.writeFieldBegin(VIS_VOXELS_FIELD_DESC);
          {
            ...
            for (VisVoxel _iter100 : struct.visVoxels)
            {
      ...
      if (struct.surfaceTriangles != null) {
        if (struct.isSetSurfaceTriangles()) {
          oprot.writeFieldBegin(SURFACE_TRIANGLES_FIELD_DESC);
          {
            ...
            for (VisSurfaceTriangle _iter101 : struct.surfaceTriangles)
            {
      ...
      if (struct.visLines != null) {
        if (struct.isSetVisLines()) {
          oprot.writeFieldBegin(VIS_LINES_FIELD_DESC);
          {
            ...
            for (VisLine _iter102 : struct.visLines)
            {
      ...
      if (struct.surfacePoints != null) {
        if (struct.isSetSurfacePoints()) {
          oprot.writeFieldBegin(SURFACE_POINTS_FIELD_DESC);
          {
            ...
            for (VisPoint _iter103 : struct.surfacePoints)
            {
      ...
      if (struct.isSetPoints()) {
        {
          ...
          for (VisPoint _iter104 : struct.points)
          {
      ...
      if (struct.isSetPolygons()) {
        {
          ...
          for (VisPolygon _iter105 : struct.polygons)
          {
      ...
      if (struct.isSetIrregularPolyhedra()) {
        {
          ...
          for (VisIrregularPolyhedron _iter106 : struct.irregularPolyhedra)
          {
      ...
      if (struct.isSetTetrahedra()) {
        {
          ...
          for (VisTetrahedron _iter107 : struct.tetrahedra)
          {
      ...
      if (struct.isSetVisVoxels()) {
        {
          ...
          for (VisVoxel _iter108 : struct.visVoxels)
          {
      ...
      if (struct.isSetSurfaceTriangles()) {
        {
          ...
          for (VisSurfaceTriangle _iter109 : struct.surfaceTriangles)
          {
      ...
      if (struct.isSetVisLines()) {
        {
          ...
          for (VisLine _iter110 : struct.visLines)
          {
      ...
      if (struct.isSetSurfacePoints()) {
        {
          ...
          for (VisPoint _iter111 : struct.surfacePoints)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.points = new ArrayList<VisPoint>(_list112.size);
          VisPoint _elem113;
          for (int _i114 = 0; _i114 < _list112.size; ++_i114)
          {
            _elem113 = new VisPoint();
            _elem113.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.polygons = new ArrayList<VisPolygon>(_list115.size);
          VisPolygon _elem116;
          for (int _i117 = 0; _i117 < _list115.size; ++_i117)
          {
            _elem116 = new VisPolygon();
            _elem116.read(iprot);
            struct.polygons.add(_elem116);
          }
        }
        struct.setPolygonsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.irregularPolyhedra = new ArrayList<VisIrregularPolyhedron>(_list118.size);
          VisIrregularPolyhedron _elem119;
          for (int _i120 = 0; _i120 < _list118.size; ++_i120)
          {
            _elem119 = new VisIrregularPolyhedron();
            _elem119.read(iprot);
            struct.irregularPolyhedra.add(_elem119);
          }
        }
        struct.setIrregularPolyhedraIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.tetrahedra = new ArrayList<VisTetrahedron>(_list121.size);
          VisTetrahedron _elem122;
          for (int _i123 = 0; _i123 < _list121.size; ++_i123)
          {
            _elem122 = new VisTetrahedron();
            _elem122.read(iprot);
            struct.tetrahedra.add(_elem122);
          }
        }
        struct.setTetrahedraIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.visVoxels = new ArrayList<VisVoxel>(_list124.size);
          VisVoxel _elem125;
          for (int _i126 = 0; _i126 < _list124.size; ++_i126)
          {
            _elem125 = new VisVoxel();
            _elem125.read(iprot);
            struct.visVoxels.add(_elem125);
          }
        }
        struct.setVisVoxelsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.surfaceTriangles = new ArrayList<VisSurfaceTriangle>(_list127.size);
          VisSurfaceTriangle _elem128;
          for (int _i129 = 0; _i129 < _list127.size; ++_i129)
          {
            _elem128 = new VisSurfaceTriangle();
            _elem128.read(iprot);
            struct.surfaceTriangles.add(_elem128);
          }
        }
        struct.setSurfaceTrianglesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.visLines = new ArrayList<VisLine>(_list130.size);
          VisLine _elem131;
          for (int _i132 = 0; _i132 < _list130.size; ++_i132)
          {
            _elem131 = new VisLine();
            _elem131.read(iprot);
            struct.visLines.add(_elem131);
          }
        }
        struct.setVisLinesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.surfacePoints = new ArrayList<VisPoint>(_list133.size);
          VisPoint _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new VisPoint();
            _elem134.read(iprot);
            struct.surfacePoints.add(_elem134);
          }
        }
        struct.setSurfacePointsIsSet(true);
      }
