            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.points = new ArrayList<VisPoint>(_list80.size);
                VisPoint _elem81;
                for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                {
                  _elem81 = new VisPoint();
                  _elem81.read(iprot);
                  struct.points.add(_elem81);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.polygons = new ArrayList<VisPolygon>(_list83.size);
                VisPolygon _elem84;
                for (int _i85 = 0; _i85 < _list83.size; ++_i85)
                {
                  _elem84 = new VisPolygon();
                  _elem84.read(iprot);
                  struct.polygons.add(_elem84);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.irregularPolyhedra = new ArrayList<VisIrregularPolyhedron>(_list86.size);
                VisIrregularPolyhedron _elem87;
                for (int _i88 = 0; _i88 < _list86.size; ++_i88)
                {
                  _elem87 = new VisIrregularPolyhedron();
                  _elem87.read(iprot);
                  struct.irregularPolyhedra.add(_elem87);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tetrahedra = new ArrayList<VisTetrahedron>(_list89.size);
                VisTetrahedron _elem90;
                for (int _i91 = 0; _i91 < _list89.size; ++_i91)
                {
                  _elem90 = new VisTetrahedron();
                  _elem90.read(iprot);
                  struct.tetrahedra.add(_elem90);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.visVoxels = new ArrayList<VisVoxel>(_list92.size);
                VisVoxel _elem93;
                for (int _i94 = 0; _i94 < _list92.size; ++_i94)
                {
                  _elem93 = new VisVoxel();
                  _elem93.read(iprot);
                  struct.visVoxels.add(_elem93);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.surfaceTriangles = new ArrayList<VisSurfaceTriangle>(_list95.size);
                VisSurfaceTriangle _elem96;
                for (int _i97 = 0; _i97 < _list95.size; ++_i97)
                {
                  _elem96 = new VisSurfaceTriangle();
                  _elem96.read(iprot);
                  struct.surfaceTriangles.add(_elem96);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.visLines = new ArrayList<VisLine>(_list98.size);
                VisLine _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = new VisLine();
                  _elem99.read(iprot);
                  struct.visLines.add(_elem99);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.surfacePoints = new ArrayList<VisPoint>(_list101.size);
                VisPoint _elem102;
                for (int _i103 = 0; _i103 < _list101.size; ++_i103)
                {
                  _elem102 = new VisPoint();
                  _elem102.read(iprot);
                  struct.surfacePoints.add(_elem102);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.points = new ArrayList<VisPoint>(_list120.size);
          VisPoint _elem121;
          for (int _i122 = 0; _i122 < _list120.size; ++_i122)
          {
            _elem121 = new VisPoint();
            _elem121.read(iprot);
            struct.points.add(_elem121);
          }
        }
        struct.setPointsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.polygons = new ArrayList<VisPolygon>(_list123.size);
          VisPolygon _elem124;
          for (int _i125 = 0; _i125 < _list123.size; ++_i125)
          {
            _elem124 = new VisPolygon();
            _elem124.read(iprot);
            struct.polygons.add(_elem124);
          }
        }
        struct.setPolygonsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.irregularPolyhedra = new ArrayList<VisIrregularPolyhedron>(_list126.size);
          VisIrregularPolyhedron _elem127;
          for (int _i128 = 0; _i128 < _list126.size; ++_i128)
          {
            _elem127 = new VisIrregularPolyhedron();
            _elem127.read(iprot);
            struct.irregularPolyhedra.add(_elem127);
          }
        }
        struct.setIrregularPolyhedraIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.tetrahedra = new ArrayList<VisTetrahedron>(_list129.size);
          VisTetrahedron _elem130;
          for (int _i131 = 0; _i131 < _list129.size; ++_i131)
          {
            _elem130 = new VisTetrahedron();
            _elem130.read(iprot);
            struct.tetrahedra.add(_elem130);
          }
        }
        struct.setTetrahedraIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.visVoxels = new ArrayList<VisVoxel>(_list132.size);
          VisVoxel _elem133;
          for (int _i134 = 0; _i134 < _list132.size; ++_i134)
          {
            _elem133 = new VisVoxel();
            _elem133.read(iprot);
            struct.visVoxels.add(_elem133);
          }
        }
        struct.setVisVoxelsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.surfaceTriangles = new ArrayList<VisSurfaceTriangle>(_list135.size);
          VisSurfaceTriangle _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = new VisSurfaceTriangle();
            _elem136.read(iprot);
            struct.surfaceTriangles.add(_elem136);
          }
        }
        struct.setSurfaceTrianglesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.visLines = new ArrayList<VisLine>(_list138.size);
          VisLine _elem139;
          for (int _i140 = 0; _i140 < _list138.size; ++_i140)
          {
            _elem139 = new VisLine();
            _elem139.read(iprot);
            struct.visLines.add(_elem139);
          }
        }
        struct.setVisLinesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.surfacePoints = new ArrayList<VisPoint>(_list141.size);
          VisPoint _elem142;
          for (int _i143 = 0; _i143 < _list141.size; ++_i143)
          {
            _elem142 = new VisPoint();
            _elem142.read(iprot);
            struct.surfacePoints.add(_elem142);
          }
        }
        struct.setSurfacePointsIsSet(true);
      }
