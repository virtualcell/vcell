...
public class VisLine implements org.apache.thrift.TBase<VisLine, VisLine._Fields>, java.io.Serializable, Cloneable, Comparable<VisLine> {
  ...
  static {
    schemes.put(StandardScheme.class, new VisLineStandardSchemeFactory());
    schemes.put(TupleScheme.class, new VisLineTupleSchemeFactory());
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case P1:
      return Integer.valueOf(getP1());

    case P2:
      return Integer.valueOf(getP2());
  ...
  public int hashCode() {
    ...
    boolean present_movingBoundarySurfaceIndex = true && (isSetMovingBoundarySurfaceIndex());
    list.add(present_movingBoundarySurfaceIndex);
    if (present_movingBoundarySurfaceIndex)
      list.add(movingBoundarySurfaceIndex);
  ...
  public int compareTo(VisLine other) {
    ...
    lastComparison = Boolean.valueOf(isSetMovingBoundarySurfaceIndex()).compareTo(other.isSetMovingBoundarySurfaceIndex());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("VisLine(");
    boolean first = true;
  ...
  private static class VisLineStandardSchemeFactory implements SchemeFactory {
    public VisLineStandardScheme getScheme() {
      return new VisLineStandardScheme();
    }
  }

  private static class VisLineStandardScheme extends StandardScheme<VisLine> {
  ...
  private static class VisLineTupleSchemeFactory implements SchemeFactory {
    public VisLineTupleScheme getScheme() {
      return new VisLineTupleScheme();
    }
  }

  private static class VisLineTupleScheme extends TupleScheme<VisLine> {
