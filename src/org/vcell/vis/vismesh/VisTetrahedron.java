...
public class VisTetrahedron implements VisPolyhedron {
	...
	public VisTetrahedron(int[] pointIndices, int level, int boxNumber, int boxIndex, double fraction, int regionIndex) {
		this.level = level;
	...
	public String toString(){
		return "VisTetrahedron@"+hashCode()+": level="+level+", box="+boxNumber+", boxIndex="+boxIndex+", fraction="+fraction+", vertices="+pointIndices;
	}
