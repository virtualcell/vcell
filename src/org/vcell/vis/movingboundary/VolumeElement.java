 ...
 */
public class VolumeElement implements java.io.Serializable, org.vcell.util.Matchable {
 ...
 */
public VolumeElement(int argIndex, int argVolIndex, Coordinate argBegin, Coordinate argEnd, int argPrevNeighbor, int argNextNeighbor) {
...
public boolean compareEqual(org.vcell.util.Matchable object) {
	...
	if (!(object instanceof VolumeElement)){
		return false;
	}
	VolumeElement contourElement = (VolumeElement)object;
