 ...
 * @author: Tracy LI
 */
public class SmoldynFileWriter extends SmoldynSurfaceTessellator
{
	...
	@SuppressWarnings("serial") class NotAConstantException extends Exception {
	}
