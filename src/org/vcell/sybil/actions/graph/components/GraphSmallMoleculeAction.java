...
/*   GraphSmallMoleculeAction  --- by Oliver Ruebenacker, UCHC --- July 2007 to March 2010
...
public class GraphSmallMoleculeAction<S extends UIShape<S>, G extends UIGraph<S, G>> 
extends GraphAction<S, G> {

	private static final long serialVersionUID = -7879075958296944998L;

	public GraphSmallMoleculeAction(ActionSpecs newSpecs, CoreManager coreManager,
