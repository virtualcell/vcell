...
/*   GraphTransportAction  --- by Oliver Ruebenacker, UCHC --- July 2007 to March
...
public class GraphTransportAction<S extends UIShape<S>, G extends UIGraph<S, G>> 
extends GraphAction<S, G> {

	private static final long serialVersionUID = -7879075958296944998L;

	public GraphTransportAction(ActionSpecs newSpecs, CoreManager coreManager,
			ModelGraphManager<S, G> graphManager) {
		super(newSpecs, coreManager, graphManager);
	}

	public void actionPerformed(ActionEvent event) {
		GraphCompSelector.select(graph(), NodeShapeTransport.class);
	}
