...
/*   GraphProteinAction  --- by Oliver Ruebenacker, UCHC --- July 2007 to February 2009
...
public class GraphProteinAction<S extends UIShape<S>, G extends UIGraph<S, G>> 
extends GraphAction<S, G> {

	private static final long serialVersionUID = -7879075958296944998L;

	public GraphProteinAction(ActionSpecs newSpecs, CoreManager coreManager,
