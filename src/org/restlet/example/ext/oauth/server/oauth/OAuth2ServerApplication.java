...
import org.vcell.rest.VCellApiMain;
...
public class OAuth2ServerApplication extends Application {
    ...
    public synchronized Restlet createInboundRoot(){
        ...
        getContext().getAttributes().put(ClientManager.class.getName(), VCellApiMain.getClientManager());
        getContext().getAttributes().put(TokenManager.class.getName(), VCellApiMain.getTokenManager());
