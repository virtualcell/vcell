...
public Component getTableCellRendererComponent(JTable table,Object value,boolean isSelected,boolean hasFocus,int row,int column) {
	...
	if (value instanceof org.vcell.expression.ui.ScopedExpression){
		JLabel fakeLabel = (JLabel)super.getTableCellRendererComponent(table,"",isSelected,hasFocus,row,column);
		org.vcell.expression.ui.ScopedExpression scopedExpression = (org.vcell.expression.ui.ScopedExpression)value;
		if (scopedExpression.getExpression()!=null){
			...
			try {
				org.vcell.expression.ui.ExpressionPrintFormatter expPrintFormatter = new org.vcell.expression.ui.ExpressionPrintFormatter(((org.vcell.expression.ui.ScopedExpression)value).getExpression(),expressionCanvas.getNameScope());
