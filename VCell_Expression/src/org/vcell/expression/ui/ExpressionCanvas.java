...
public class ExpressionCanvas extends javax.swing.JPanel implements javax.swing.Scrollable {
	...
	private org.vcell.expression.IExpression[] fieldExpressions = null;
 ...
 * @see #setExpressions
 */
public IExpression getExpressions(int index) {
		...
		try {
			...
			if (fieldExpressions != null)
			{
				for (int i=0;i<fieldExpressions.length;i++){
					ExpressionPrintFormatter expPrintFormatter = new ExpressionPrintFormatter(fieldExpressions[i],getNameScope());
...
//		g.setRenderingHint(RenderingHints.KEY_ANTIALIASING,RenderingHints.VALUE_ANTIALIAS_ON);
		...
		if (fieldExpressions!=null){
			...
			for (int i=0;i<fieldExpressions.length;i++){
				int prefixWidth = 0;
				org.vcell.expression.ui.ExpressionPrintFormatter expPrintFormatter = new org.vcell.expression.ui.ExpressionPrintFormatter(fieldExpressions[i], getNameScope());
				java.awt.Dimension expressionDim = expPrintFormatter.getSize(g);
...
public void setExpression(IExpression expression) {
	IExpression expList[] = null;
	if (expression != null){
		expList = new IExpression[1];
 ...
 * @see #getExpressions
 */
public void setExpressions(org.vcell.expression.IExpression[] expressions) {
 ...
 * @see #getExpressions
 */
public void setExpressions(org.vcell.expression.IExpression[] expressions, String prefixLabels[], String suffixLabels[]) {
 ...
 * @see #getNameScope
 */
public void setNameScope(org.vcell.expression.NameScope nameScope) {
	org.vcell.expression.NameScope oldValue = fieldNameScope;
