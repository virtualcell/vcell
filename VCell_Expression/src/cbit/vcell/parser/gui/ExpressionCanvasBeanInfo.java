...
©*/
/**
 * The bean information class for cbit.vcell.math.gui.ExpressionCanvas.
 */
public class ExpressionCanvasBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the expressions property descriptor.
 * @return java.beans.IndexedPropertyDescriptor
 */
public java.beans.IndexedPropertyDescriptor expressionsPropertyDescriptor() {
	java.beans.IndexedPropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the expressions property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getExpressions", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getExpressions", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setExpressions", 1);
			};
			...
			try {
				...
				aGetIndexedMethod = getBeanClass().getMethod("getExpressions", aGetIndexedMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetIndexedMethod = findMethod(getBeanClass(), "getExpressions", 1);
			};
			java.lang.reflect.Method aSetIndexedMethod = null;
			aDescriptor = new java.beans.IndexedPropertyDescriptor("expressions"
		...
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("expressions"); */
		/* aDescriptor.setShortDescription("expressions"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
		/* aDescriptor.setValue("ivjDesignTimeProperty", new Boolean(true)); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.parser.gui.ExpressionCanvas.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.math.gui.ExpressionCanvas";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the ExpressionCanvasBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.parser.gui.ExpressionCanvas.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the getExpressions(int) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor getExpressions_intMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the getExpressions(int) method descriptor. */
		...
		try {
			...
			aMethod = getBeanClass().getMethod("getExpressions", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "getExpressions", 1);
		};
		try {
		...
		/* aDescriptor.setDisplayName("getExpressions(int)"); */
		/* aDescriptor.setShortDescription("getExpressions(int)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			getExpressions_intMethodDescriptor()
			,setExpressions_cbitvcellparserExpression___javalangString___javalangString__MethodDescriptor()
...
public java.beans.MethodDescriptor init_cbitvcellparserExpression__MethodDescriptor() {
	...
	try {
		...
		try {
			...
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			aParameterDescriptor1.setName("arg1");
			aParameterDescriptor1.setDisplayName("expList");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1
			};
			aDescriptor = new java.beans.MethodDescriptor(aMethod, aParameterDescriptors);
	...
	try {
		try {
			...
			try {
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setNameScope", 1);
			};
...
public java.beans.MethodDescriptor setExpressions_cbitvcellparserExpression___javalangString___javalangString__MethodDescriptor() {
	...
	try {
		...
		try {
			...
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "setExpressions", 3);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			aParameterDescriptor1.setName("arg1");
			aParameterDescriptor1.setDisplayName("expressions");
			...
			aParameterDescriptor2.setDisplayName("prefixLabels");
			...
			aParameterDescriptor3.setDisplayName("suffixLabels");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1,
...
public java.beans.MethodDescriptor setExpressions_cbitvcellparserExpression___javalangString__MethodDescriptor() {
	...
	try {
		...
		try {
			...
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "setExpressions", 2);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			...
			java.beans.ParameterDescriptor aParameterDescriptor2 = new java.beans.ParameterDescriptor();
			aParameterDescriptor2.setName("arg2");
			aParameterDescriptor2.setDisplayName("labels");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1,
				aParameterDescriptor2
			};
...
public java.beans.MethodDescriptor setExpressions_int_cbitvcellparserExpressionMethodDescriptor() {
	...
	try {
		...
		try {
			...
			java.beans.ParameterDescriptor aParameterDescriptor2 = new java.beans.ParameterDescriptor();
			aParameterDescriptor2.setName("arg2");
			aParameterDescriptor2.setDisplayName("expressions");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1,
				aParameterDescriptor2
			};
...
public java.beans.MethodDescriptor update_javautilObservable_javalangObjectMethodDescriptor() {
	...
	try {
		...
		try {
			...
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			aParameterDescriptor1.setName("arg1");
			aParameterDescriptor1.setDisplayName("observable");
			java.beans.ParameterDescriptor aParameterDescriptor2 = new java.beans.ParameterDescriptor();
			aParameterDescriptor2.setName("arg2");
			aParameterDescriptor2.setDisplayName("object");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1,
				aParameterDescriptor2
			};
