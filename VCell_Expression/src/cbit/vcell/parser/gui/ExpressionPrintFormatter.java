...
import cbit.vcell.parser.ASTAssignNode;
	...
	try {
		...
		if (expArray != null){
			...
			for (int i=0;i<expArray.length;i++){
				int prefixWidth = 0;
				cbit.vcell.parser.gui.ExpressionPrintFormatter expPrintFormatter = new cbit.vcell.parser.gui.ExpressionPrintFormatter(expArray[i]);
