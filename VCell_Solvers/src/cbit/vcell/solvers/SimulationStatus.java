 ...
 */
public static SimulationStatus updateFromJobEvent(SimulationStatus oldStatus, SimulationJobStatus jobStatusFromEvent, Double progressFromEvent) {

	// ignore empty messages
	if (jobStatusFromEvent == null) {
		return oldStatus;
	}

	SimulationJobStatus newJobStatus = jobStatusFromEvent;
	...
	if (oldJobStatus.isDone()) {
		...
		if (oldJobStatus.isRunning() &&
			...
			oldProgress > progressFromEvent.doubleValue()
			) {
		return oldStatus;
		}
	}
