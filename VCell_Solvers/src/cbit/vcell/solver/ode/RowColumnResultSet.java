...
public class RowColumnResultSet implements java.io.Serializable {
	...
	private cbit.vcell.solver.ode.ColumnDescription[] fieldColumnDescriptions = new ColumnDescription[0];
/**
 ...
 */
public cbit.vcell.solver.ode.ColumnDescription[] getColumnDescriptions() {
 ...
 */
private void setColumnDescriptions(cbit.vcell.solver.ode.ColumnDescription[] columnDescriptions) {
	cbit.vcell.solver.ode.ColumnDescription[] oldValue = fieldColumnDescriptions;
