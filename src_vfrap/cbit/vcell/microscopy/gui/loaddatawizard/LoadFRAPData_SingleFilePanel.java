...
public class LoadFRAPData_SingleFilePanel extends JPanel
{
	private JTextField fileNameTextField;
	public LoadFRAPData_SingleFilePanel() {
		super();
		...
		browserButton.addActionListener(new ActionListener()
		{
			...
			{
				int option = VirtualFrapLoader.loadFRAPImageFileChooser.showOpenDialog(LoadFRAPData_SingleFilePanel.this);
				if(option == JFileChooser.APPROVE_OPTION)
				{
					String fileStr = VirtualFrapLoader.loadFRAPImageFileChooser.getSelectedFile().getAbsolutePath();
