...
- Saving a model no longer fails because the connection to the server was recycled
  underneath it. The error mentioned "GOAWAY received" and could stop a save
