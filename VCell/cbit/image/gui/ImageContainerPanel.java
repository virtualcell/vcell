 ...
 * Comment
 */
public void checkScaleSettingsHistory() throws java.rmi.RemoteException, cbit.util.DataAccessException {
...
public void refreshImage() {
	...
	try {
		...
		int nZ = 1;
		SourceDataInfo sourceData = new SourceDataInfo(SourceDataInfo.INT_RGB_TYPE,getImageContainer().getPixels(),new cbit.util.Extent(1,1,1),new cbit.util.Origin(0,0,0),getImageContainer().getDataRange(),0,nX,1,nY,nX,nZ,nX*nY);
