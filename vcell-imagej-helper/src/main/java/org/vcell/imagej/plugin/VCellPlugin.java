...
public class VCellPlugin extends ContextCommand {
	...
	public void run() {
      ...
      VCellHelper.VCellModelSearch vcms = new VCellHelper.VCellModelSearch(VCellHelper.ModelType.bm,"colreeze","Monkeyflower_pigmentation_v2","Pattern_formation","WT",null,null);
      try {
		...
		// TODO Auto-generated catch block
		//e.printStackTrace();
		uiService.showDialog("VCellHelper.ModelType.bm,\"colreeze\",\"Monkeyflower_pigmentation_v2\",\"Pattern_formation\",\"WT\",null,null\n"+e.getMessage(), "Search failed", MessageType.ERROR_MESSAGE);
		displayProgressBar(false, null, null);
	}
