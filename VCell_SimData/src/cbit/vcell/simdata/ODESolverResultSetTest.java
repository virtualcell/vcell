...
public static ODESolverResultSet getExample(double times[], String[] varNames, IExpression[] expressions) throws ExpressionException {
	...
	for (int i = 0; i < varNames.length; i++){
		r.addDataColumn(new cbit.vcell.simdata.ODESolverResultSetColumnDescription (varNames[i]));
 ...
 */
public static void plot(cbit.vcell.simdata.ODESimData odeSimData) throws ExpressionException {
	//
	// create PlotDatas
	//
 ...
 * @param rowColumnResultSet cbit.vcell.util.RowColumnResultSet
 */
public static void plot(cbit.vcell.simdata.ODESolverResultSet odeSolverResultSet) throws ExpressionException {
	//
	// create PlotDatas
	//
