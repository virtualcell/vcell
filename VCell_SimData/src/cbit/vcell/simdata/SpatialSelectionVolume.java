...
private static Coordinate lineMeshFaceIntersect3D(Coordinate mesh1,Coordinate mesh2,Coordinate cp1,Coordinate cp2) {
	...
	Vect3d p1 = new Vect3d(cp1.getX(),cp1.getY(),cp1.getZ());
	Vect3d p2 = new Vect3d(cp2.getX(),cp2.getY(),cp2.getZ());
	
	Vect3d n1 = new Vect3d(mesh1.getX(),mesh1.getY(),mesh1.getZ());
	Vect3d n2 = new Vect3d(mesh2.getX(),mesh2.getY(),mesh2.getZ());

	Vect3d n = Vect3d.sub(n2,n1);
	Vect3d p3 = new Vect3d(n);
	p3.scale(.5);
	p3.add(n1);
	n.unit();

	Vect3d p3minp1 = Vect3d.sub(p3,p1);
	Vect3d p2minp1 = Vect3d.sub(p2,p1);
