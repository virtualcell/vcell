...
public class MeshDisplayAdapter {
	...
	public static class MeshRegionSurfaces {
		private SurfaceCollection allMembraneSurfaces;
		private int[][] surface_polygon_MembraneIndexes;
		
		public MeshRegionSurfaces(SurfaceCollection argSurfCollection,int[][] argSPMembraneIndexes){
...
public MeshRegionSurfaces generateMeshRegionSurfaces() throws cbit.image.ImageException{
	...
	cbit.vcell.geometry.surface.SurfaceGenerator surfaceGenerator =
		new cbit.vcell.geometry.surface.SurfaceGenerator(new NullSessionLog());
