...
props="${props} -Dvcell.bioformatsJarFileName=vcell-bioformats-0.0.6-jar-with-dependencies.jar"
props="${props} -Dvcell.bioformatsJarDownloadURL=http://vcell.org/webstart/vcell-bioformats-0.0.6-jar-with-dependencies.jar"
