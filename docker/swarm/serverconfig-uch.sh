...
VCELL_BIOFORMATS_JAR_FILE=vcell-bioformats-0.0.7-jar-with-dependencies.jar
VCELL_BIOFORMATS_JAR_URL=http://vcell.org/webstart/vcell-bioformats-0.0.7-jar-with-dependencies.jar
