...
VCELL_SINGULARITY_IMAGE_EXTERNAL="/state/partition1/singularityImages/${VCELL_SINGULARITY_FILENAME}"
...
VCELL_MAX_ODE_JOBS_PER_USER=50
VCELL_MAX_PDE_JOBS_PER_USER=20
...
VCELL_BIOFORMATS_JAR_FILE=vcell-bioformats-0.0.4-jar-with-dependencies.jar
VCELL_BIOFORMATS_JAR_URL=http://vcell.org/webstart/vcell-bioformats-0.0.4-jar-with-dependencies.jar
