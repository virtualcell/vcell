...
\i '/base/sources/views/PUBLIC_SIMULATIONS_view.sql'
\i '/base/sources/views/STAT_TOTAL_MODELS_view.sql'
\i '/base/sources/views/STAT_USERS_WITH_SIMULATION_view.sql'
