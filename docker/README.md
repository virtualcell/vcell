...
```bash
export VCELL_REPO_NAMESPACE=vcell-docker.cam.uchc.edu:5000/schaff VCELL_TAG=abe3f96
...
```bash
export VCELL_VERSION=7.0.0 VCELL_BUILD=3 VCELL_SITE=beta
...
```bash
export VCELL_VERSION=7.0.0 VCELL_BUILD=25 VCELL_SITE=alpha
