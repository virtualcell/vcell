...
VCELL_JMS_RESTPORT=$((8161 + $_site_port_offset))
VCELL_JMS_HOST=$((8161 + $_site_port_offset))
VCELL_MONGO_PORT=$((27017 + $_site_port_offset))
VCELL_MONGO_HOST=$((27017 + $_site_port_offset))
