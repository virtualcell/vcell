...
show_help() {
	...
	echo "*************************************************"
	echo ""
	echo "usage: docker run --rm -e v1=a -e v2=b -v /host/path/to/file:/simdata ghcr.io/virtualcell/vcell-batch:latest [OPTIONS] command <args>"
	echo "  or   singularity run --bind /host/path/to/file:/simdata docker://ghcr.io/virtualcell/vcell-batch:latest [OPTIONS] command <args>"
	echo ""
