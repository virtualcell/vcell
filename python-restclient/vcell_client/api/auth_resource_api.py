...
class AuthResourceApi:
    ...
    def code_exchange(
        ...
        _param = self._code_exchange_serialize(
            code=code,
    ...
    @validate_call
    def code_exchange_with_http_info(
        self,
        code: Optional[StrictStr] = None,
        redirect_url: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def code_exchange_without_preload_content(
        self,
        code: Optional[StrictStr] = None,
        redirect_url: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _code_exchange_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/auth/code-flow',
