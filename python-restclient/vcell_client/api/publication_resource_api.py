...
class PublicationResourceApi:
    ...
    def publish_bio_models(
        ...
        _param = self._publish_bio_models_serialize(
            id=id,
            publish_models_request=publish_models_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _publish_bio_models_serialize(
        self,
        id,
        publish_models_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if publish_models_request is not None:
            _body_params = publish_models_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v1/publications/{id}/publish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
