...
class FieldDataResourceApi:
    ...
    def advanced_create(
        ...
        _param = self._advanced_create_serialize(
            file=file,
            file_name=file_name,
            extent=extent,
            i_size=i_size,
    ...
    def _advanced_create_serialize(
        self,
        file,
        file_name,
        extent,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/fieldData/advancedCreate',
    ...
    def create_from_file(
        ...
        :param file:
        :type file: bytearray
        :param field_data_name:
        :type field_data_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_from_file_serialize(
            file=file,
    ...
    def _create_from_file_serialize(
        self,
        file,
        field_data_name,
        _request_auth,
        ...
        if file is not None:
            _files['file'] = file
        if field_data_name is not None:
            _form_params.append(('fieldDataName', field_data_name))
        # process the body parameter
    ...
    def _save_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/fieldData/save',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
