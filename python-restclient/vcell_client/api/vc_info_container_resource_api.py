...
class VCInfoContainerResourceApi:
    ...
    def get_vc_info_container(
        ...
        _param = self._get_vc_info_container_serialize(
    ...
    @validate_call
    def get_vc_info_container_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VCInfoContainerSummary]:
        """Return a single bulk collection of metadata summaries (BioModels, MathModels, Geometries, Images) visible to the requester. Anonymous requests return public records only; an authenticated request additionally includes the requester's own and shared records.
    ...
    @validate_call
    def get_vc_info_container_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_vc_info_container_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/vcInfoContainer',
