...
class UserSimCount(BaseModel):
    """
    UserSimCount
    """ # noqa: E501
    username: Optional[StrictStr] = None
    sim_count: Optional[StrictInt] = Field(default=None, alias="simCount")
    __properties: ClassVar[List[str]] = ["username", "simCount"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UserSimCount) in the input: " + _key)
