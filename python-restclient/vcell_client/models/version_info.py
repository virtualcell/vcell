...
class VersionInfo(BaseModel):
    ...
    version_type: Optional[VersionableType] = Field(default=None, alias="versionType")
    software_version: Optional[VCellSoftwareVersion] = Field(default=None, alias="softwareVersion")
    __properties: ClassVar[List[str]] = ["version", "versionType", "softwareVersion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of version_type
        if self.version_type:
            _dict['versionType'] = self.version_type.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in VersionInfo) in the input: " + _key)

        _obj = cls.model_validate({
            "version": Version.from_dict(obj.get("version")) if obj.get("version") is not None else None,
            "versionType": VersionableType.from_dict(obj.get("versionType")) if obj.get("versionType") is not None else None,
