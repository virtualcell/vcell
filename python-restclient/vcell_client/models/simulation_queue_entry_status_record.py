...
class SimulationQueueEntryStatusRecord(BaseModel):
    """
    SimulationQueueEntryStatusRecord
    """ # noqa: E501
    field_queue_priority: Optional[StrictInt] = Field(default=None, alias="fieldQueuePriority")
    field_queue_date: Optional[datetime] = Field(default=None, alias="fieldQueueDate")
    field_queue_id: Optional[SimulationQueueID] = Field(default=None, alias="fieldQueueID")
    __properties: ClassVar[List[str]] = ["fieldQueuePriority", "fieldQueueDate", "fieldQueueID"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SimulationQueueEntryStatusRecord) in the input: " + _key)
