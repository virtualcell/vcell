...
class DifferentParameterValues(BaseModel):
    """
    ...
    changed_value: Optional[StrictStr] = Field(default=None, alias="changedValue")
    __properties: ClassVar[List[str]] = ["parameterName", "originalValue", "changedValue"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DifferentParameterValues) in the input: " + _key)

        _obj = cls.model_validate({
            "parameterName": obj.get("parameterName"),
            "originalValue": obj.get("originalValue"),
            "changedValue": obj.get("changedValue")
        })
        return _obj
