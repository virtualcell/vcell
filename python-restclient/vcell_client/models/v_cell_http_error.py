...
class VCellHTTPError(BaseModel):
    """
    VCellHTTPError
    """ # noqa: E501
    exception_type: Optional[StrictStr] = Field(default=None, alias="exceptionType")
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["exceptionType", "message"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in VCellHTTPError) in the input: " + _key)
