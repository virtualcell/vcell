...
class CopasiOptimizationParameter(BaseModel):
    """
    CopasiOptimizationParameter
    """ # noqa: E501
    data_type: Optional[CopasiOptimizationParameterDataType] = Field(default=None, alias="dataType")
    param_type: Optional[CopasiOptimizationParameterParamType] = Field(default=None, alias="paramType")
    value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["dataType", "paramType", "value"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CopasiOptimizationParameter) in the input: " + _key)
