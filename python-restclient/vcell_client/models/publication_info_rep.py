...
class PublicationInfoRep(BaseModel):
    """
    PublicationInfoRep
    """ # noqa: E501
    ...
    vc_document_type: Optional[StrictStr] = Field(default=None, alias="vcDocumentType")
    user: Optional[UserRep] = None
    pub_date: Optional[StrictInt] = Field(default=None, alias="pubDate")
    __properties: ClassVar[List[str]] = ["publicationKey", "versionKey", "title", "authors", "citation", "pubmedid", "doi", "url", "vcDocumentType", "user", "pubDate"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PublicationInfoRep) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "user": UserRep.from_dict(obj.get("user")) if obj.get("user") is not None else None,
