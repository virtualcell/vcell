...
class ParameterDescription(BaseModel):
    ...
    """ # noqa: E501
    initial_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="initialValue")
    ...
    __properties: ClassVar[List[str]] = ["initialValue", "maxValue", "minValue", "name", "scale"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ParameterDescription) in the input: " + _key)
