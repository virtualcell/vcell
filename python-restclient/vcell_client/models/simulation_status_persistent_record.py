...
class SimulationStatusPersistentRecord(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SimulationStatusPersistentRecord) in the input: " + _key)
