...
class TestVCInfoContainerSummary(unittest.TestCase):
    """VCInfoContainerSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VCInfoContainerSummary:
        """Test VCInfoContainerSummary
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VCInfoContainerSummary`
        """
        model = VCInfoContainerSummary()
        if include_optional:
    ...
    def testVCInfoContainerSummary(self):
        """Test VCInfoContainerSummary"""
