...
class TestGeometrySpecDTO(unittest.TestCase):
    """GeometrySpecDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeometrySpecDTO:
        """Test GeometrySpecDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeometrySpecDTO`
        """
        model = GeometrySpecDTO()
        if include_optional:
            return GeometrySpecDTO(
                selections = [
