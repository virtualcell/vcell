...
class TestSpatialSelection(unittest.TestCase):
    """SpatialSelection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpatialSelection:
        """Test SpatialSelection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpatialSelection`
        """
        model = SpatialSelection()
        if include_optional:
