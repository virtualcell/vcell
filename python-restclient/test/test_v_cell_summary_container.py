...
class TestVCellSummaryContainer(unittest.TestCase):
    """VCellSummaryContainer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VCellSummaryContainer:
        """Test VCellSummaryContainer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VCellSummaryContainer`
        """
        model = VCellSummaryContainer()
        if include_optional:
    ...
    def testVCellSummaryContainer(self):
        """Test VCellSummaryContainer"""
