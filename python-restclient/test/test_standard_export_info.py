...
class TestStandardExportInfo(unittest.TestCase):
    """StandardExportInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardExportInfo:
        """Test StandardExportInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardExportInfo`
        """
        model = StandardExportInfo()
        if include_optional:
    ...
    def testStandardExportInfo(self):
        """Test StandardExportInfo"""
