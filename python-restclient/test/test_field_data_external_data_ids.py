...
class TestFieldDataExternalDataIDs(unittest.TestCase):
    """FieldDataExternalDataIDs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FieldDataExternalDataIDs:
        """Test FieldDataExternalDataIDs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FieldDataExternalDataIDs`
        """
        model = FieldDataExternalDataIDs()
        if include_optional:
    ...
    def testFieldDataExternalDataIDs(self):
        """Test FieldDataExternalDataIDs"""
