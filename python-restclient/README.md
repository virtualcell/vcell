...
*UsersResourceApi* | [**process_magic_link**](docs/UsersResourceApi.md#process_magic_link) | **POST** /api/v1/users/processMagicLink | Process the magic link and map the user
