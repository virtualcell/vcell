...
*SpatialResourceApi* | [**retrieve_finite_volume_input_from_spatial_model**](docs/SpatialResourceApi.md#retrieve_finite_volume_input_from_spatial_model) | **GET** /api/v1/spatial/retrieveFiniteVolumeInputFromSpatialModel | Retrieve finite volume input from spatial model
