 ...
 */
public GeneralConstraint(IExpression argExpression, int argConstraintType, String description) {
 ...
 * @see #getBounds
 */
public void setExpression(IExpression expression) throws java.beans.PropertyVetoException {
