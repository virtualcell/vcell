...
public static final void runTest() {
	...
	Node n3 = new Node(1,1,0);
	Node n4 = new Node(0,1,0);

	Node n5 = new Node(-1,2,0);
	Node n6 = new Node(0,2,0);
	Node n7 = new Node(1,2,0);
	Node n8 = new Node(2,2,0);
	Node n9 = new Node(-1,1,0);
	Node n10 = new Node(2,1,0);
	Node n11 = new Node(-1,0,0);
	Node n12 = new Node(2,0,0);
	Node n13 = new Node(-1,-1,0);
	Node n14 = new Node(0,-1,0);
	Node n15 = new Node(1,-1,0);
	Node n16 = new Node(2,-1,0);
	...
	SlowSurface surf = new SlowSurface(0,1,quad1);
