...
/**
 * The bean information class for cbit.vcell.modelopt.gui.ParameterMappingPanel.
 */
public class ParameterMappingPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.modelopt.gui.ParameterMappingPanel.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ParameterMappingPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.modelopt.gui.ParameterMappingPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
