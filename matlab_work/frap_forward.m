function [ solution fluorescence finalSourceTerms objFuncVal ] = frap_forward( refSolution, refImage, numVariables, solutionTimes, r, ir, rTimes, modelfunct)
...
%    t=clock; [solution,rates,val] = frap_forward(exactSolution,expData,2,exactTimes,basisResponses,basisResponses2DConv,basisTimes,@modelfunction_inverse); etime(clock,t)
%
