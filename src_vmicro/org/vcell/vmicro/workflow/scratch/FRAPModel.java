...
public class FRAPModel implements Matchable
{
	...
	public static final Parameter REF_DIFFUSION_RATE_PARAM = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_PRIMARY_DIFF_RATE], 0, 200, 1.0, 1.0);
	public static final Parameter REF_MOBILE_FRACTION_PARAM = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_PRIMARY_FRACTION], 0, 1, 1.0, 1.0);
	public static final Parameter REF_BLEACH_WHILE_MONITOR_PARAM = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_BLEACH_MONITOR_RATE], 0, 1, 1.0,  0);
	public static final Parameter REF_SECOND_DIFFUSION_RATE_PARAM = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_SECONDARY_DIFF_RATE], 0, 100, 1.0, 1.0);
	public static final Parameter REF_SECOND_MOBILE_FRACTION_PARAM = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_SECONDARY_FRACTION], 0, 1, 1.0, 1.0);
	//concentration parameter is used for reaction off rate model to store unuseful parameter A.
	public static final Parameter REF_BS_CONCENTRATION_OR_A = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_BINDING_SITE_CONCENTRATION], 0, 1000, 1.0, 1.0);
	public static final Parameter REF_REACTION_ON_RATE = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_BINDING_SITE_CONCENTRATION], 0.01, 100, 1.0, 1.0);
	public static final Parameter REF_REACTION_OFF_RATE = new Parameter(FRAPModel.MODEL_PARAMETER_NAMES[FRAPModel.INDEX_OFF_RATE], 0.01, 100, 1.0, 1.0);
	...
	public FRAPModel(ModelType modelType, Parameter[] arg_parameters, double[][] arg_data, double[] arg_timePoints)
	{
	...
	public ModelType getModelIdentifer() {
		return modelType;
	}
	...
	public static Parameter[] getInitialParameters(FRAPData frapData, ModelType modelType) throws ExpressionException, OptimizationException, IOException
	{
		...
		if(modelType == ModelType.DiffOne)
		{
		...
		else if(modelType == ModelType.DiffTwoWithPenalty)
		{
			Parameter diff = new Parameter(MODEL_PARAMETER_NAMES[INDEX_PRIMARY_DIFF_RATE], 
			                    REF_DIFFUSION_RATE_PARAM.getLowerBound(),
			                    REF_DIFFUSION_RATE_PARAM.getUpperBound(),
			...
			throw new RuntimeException("frap model "+modelType.name()+" not supported");
		}
	...
	public boolean compareEqual(Matchable obj) 
	{
		...
		if (obj != null && obj instanceof FRAPModel) 
		{
			...
			if (!modelType.equals(frapModel.getModelIdentifer()))
			{
				return false;
			}
