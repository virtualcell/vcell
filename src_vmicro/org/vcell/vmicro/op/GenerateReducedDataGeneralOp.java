...
public class GenerateReducedDataGeneralOp {
	
	public RowColumnResultSet generateReducedData(ImageTimeSeries<? extends Image> imageTimeSeries, String[] regionNames, FloatImage[] regionWeights) throws Exception {
//		int numROIs = regoinW.length;
//		
