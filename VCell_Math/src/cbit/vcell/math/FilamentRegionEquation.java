...
public class FilamentRegionEquation extends Equation {
	private IExpression filamentRateExpression = ExpressionFactory.createExpression(0.0);
 ...
 */
public FilamentRegionEquation(FilamentRegionVariable var, IExpression initialExp) {
...
void flatten(SymbolTable symbolTable, boolean bRoundCoefficients) throws org.vcell.expression.ExpressionException, MathException {
	...
	filamentRateExpression = getFlattenedExpression(symbolTable,filamentRateExpression,bRoundCoefficients);
}
 ...
 */
public IExpression getFilamentRateExpression() {
...
public Enumeration getTotalExpressions() throws ExpressionException {
	...
	IExpression lvalueExp = ExpressionFactory.createExpression("MembraneRate_"+getVariable().getName());
	IExpression rvalueExp = ExpressionFactory.createExpression(getFilamentRateExpression());
 ...
 */
public void setFilamentRateExpression(IExpression newFilamentRateExpression) {
