...
<center><h3>BioModel <a href="${pathPrefix}/biomodel/${biomodel.bmKey}">${biomodel.bmKey}</a></h3></center>
...
<td><#if biomodel.simulations??><#list biomodel.simulations as simulation><#if simulation.mathKey=application.mathKey><a href='${pathPrefix}/biomodel/${biomodel.bmKey}/simulation/${simulation.key}'>${simulation.name}</a>&nbsp;&nbsp;</#if></#list><#else>--</#if></td>
</tr>
</#list>
</table>
</#if>
