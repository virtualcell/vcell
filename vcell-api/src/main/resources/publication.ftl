...
<center>
<h3>Publication <a href="${pathPrefix}/publication/${publication.pubKey}">${publication.pubKey}</a></h3>
<form action="${pathPrefix}/publication/${publication.pubKey}" method="post">
...
<#if publication.biomodelReferences??>
	<#list publication.biomodelReferences as biomodel>
		<a href='${pathPrefix}/biomodel/${biomodel.bmKey}'>${biomodel.name}(${biomodel.bmKey})</a>
...
<#if publication.mathmodelReferences??>
	<#list publication.mathmodelReferences as mathmodel>
		<a href='${pathPrefix}/mathmodel/${mathmodel.mmKey}'>${mathmodel.name}(${mathmodel.mmKey})</a>
