...
public class N5Service {
    ...
    final UserLoginInfo.DigestedPassword testPassword;

    public N5Service(RestEventService eventService, String host, int port,
                     boolean bIgnoreCertProblems, boolean bIgnoreHostMismatch,
                     String testUserid, UserLoginInfo.DigestedPassword testPassword) {
    ...
    private void runsimLoop() {
        ...
        while (true) {
            ...
            try {
                ...
                templateBioModel.getSimulationContext(0).addNewSimulation("sim", callback, SimulationContext.NetworkGenerationRequirements.ComputeFullStandardTimeout);
