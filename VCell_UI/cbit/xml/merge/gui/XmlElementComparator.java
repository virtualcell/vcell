 ...
 */
public XmlElementComparator(XmlTreeDiff param, XmlComparePolicy argXmlComparePolicy) {
	super();
	xmlComparePolicy = argXmlComparePolicy;
	diffTree = param;
}
/**
...
public int compare(Element o1, Element o2) {
	...
	//
	if (xmlComparePolicy.ignoreElement(o1.getName())){
		return 0;
	}
	while ( baseiterator.hasNext() && moditerator.hasNext() ) {
