...
public static void main(java.lang.String[] args) {
	try {
		...
		XmlTreeDiff diffTree = XmlTreeDiff.compareMerge(baselineXML, modifiedXML, XmlTreeDiff.COMPARE_DOCS_SAVED, new VCellXMLComparePolicy(true));
...
private void setnodeInfo1(NodeInfo newValue) {
	if (ivjnodeInfo1 != newValue) {
		try {
			cbit.xml.merge.gui.NodeInfo oldValue = getnodeInfo1();
