...
©*/
/**
 * The bean information class for cbit.vcell.desktop.GeometryMetaDataPanel.
 */
public class GeometryMetaDataPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.desktop.GeometryMetaDataPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the GeometryMetaDataPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.desktop.GeometryMetaDataPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
