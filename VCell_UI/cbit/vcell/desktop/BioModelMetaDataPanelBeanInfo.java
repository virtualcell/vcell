...
©*/
/**
 * The bean information class for cbit.vcell.desktop.BioModelMetaDataPanel.
 */
public class BioModelMetaDataPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the bioModelInfo property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor bioModelInfoPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the bioModelInfo property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getBioModelInfo", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getBioModelInfo", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setBioModelInfo", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("bioModelInfo"
			, aGetMethod, aSetMethod);
		} catch (Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		aDescriptor.setBound(true);
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("bioModelInfo"); */
		/* aDescriptor.setShortDescription("bioModelInfo"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.desktop.BioModelMetaDataPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the BioModelMetaDataPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.desktop.BioModelMetaDataPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.PropertyDescriptor[] getPropertyDescriptors() {
	try {
		java.beans.PropertyDescriptor aDescriptorList[] = {
			...
			,bioModelInfoPropertyDescriptor()
