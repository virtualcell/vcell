...
©*/
/**
 * The bean information class for cbit.vcell.desktop.BioModelTreeModel.
 */
public class BioModelTreeModelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.desktop.BioModelTreeModel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the BioModelTreeModelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.desktop.BioModelTreeModel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
