...
/**
 * The bean information class for cbit.vcell.namescope.StructureMappingParameterTableModel.
 */
public class StructureMappingParameterTableModelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the bGeoMappingParams property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor bGeoMappingParamsPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the bGeoMappingParams property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getBGeoMappingParams", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getBGeoMappingParams", 0);
			};
			...
			try {
				...
				aSetMethod = getBeanClass().getMethod("setBGeoMappingParams", aSetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setBGeoMappingParams", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("bGeoMappingParams"
		...
		/* aDescriptor.setDisplayName("bGeoMappingParams"); */
		/* aDescriptor.setShortDescription("bGeoMappingParams"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.namescope.StructureMappingParameterTableModel.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.namescope.StructureMappingParameterTableModel";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the StructureMappingParameterTableModelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.namescope.StructureMappingParameterTableModel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the structureMapping property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor structureMappingPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the structureMapping property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getStructureMapping", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getStructureMapping", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setStructureMapping", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("structureMapping"
			, aGetMethod, aSetMethod);
		} catch (Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("structureMapping"); */
		/* aDescriptor.setShortDescription("structureMapping"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
		/* aDescriptor.setValue("ivjDesignTimeProperty", new Boolean(true)); */
