...
/**
 * The bean information class for cbit.vcell.namescope.ModelNameScopeDisplayPanel.
 */
public class ModelNameScopeDisplayPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.namescope.ModelNameScopeDisplayPanel.class;
}
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.namescope.ModelNameScopeDisplayPanel";
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ModelNameScopeDisplayPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.namescope.ModelNameScopeDisplayPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			setTableCellEditableMethodDescriptor()
		};
		return aDescriptorList;
	} catch (Throwable exception) {
		handleException(exception);
...
/**
 * Gets the setTableCellEditable() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor setTableCellEditableMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the setTableCellEditable() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("setTableCellEditable", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "setTableCellEditable", 0);
		};
		try {
		...
		/* aDescriptor.setDisplayName("setTableCellEditable()"); */
		/* aDescriptor.setShortDescription("setTableCellEditable()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
