...
/**
 * The bean information class for cbit.vcell.namescope.SimContextNameScopeCellRenderer.
 */
public class SimContextNameScopeCellRendererBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.namescope.SimContextNameScopeCellRenderer.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the SimContextNameScopeCellRendererBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.namescope.SimContextNameScopeCellRenderer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
