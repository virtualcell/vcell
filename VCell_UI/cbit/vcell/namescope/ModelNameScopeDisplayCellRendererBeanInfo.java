...
/**
 * The bean information class for cbit.vcell.namescope.ModelNameScopeDisplayCellRenderer.
 */
public class ModelNameScopeDisplayCellRendererBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.namescope.ModelNameScopeDisplayCellRenderer.class;
}
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.namescope.ModelNameScopeDisplayCellRenderer";
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ModelNameScopeDisplayCellRendererBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.namescope.ModelNameScopeDisplayCellRenderer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			...
			,setTableHash_javautilHashtableMethodDescriptor()
		};
		return aDescriptorList;
	} catch (java.lang.Throwable exception) {
		handleException(exception);
...
/**
 * Gets the setTableHash(java.util.Hashtable) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor setTableHash_javautilHashtableMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the setTableHash(java.util.Hashtable) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
			...
			aMethod = getBeanClass().getMethod("setTableHash", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "setTableHash", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			aParameterDescriptor1.setName("arg1");
			aParameterDescriptor1.setDisplayName("newTableHash");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
		...
		/* aDescriptor.setDisplayName("setTableHash(java.util.Hashtable)"); */
		/* aDescriptor.setShortDescription("setTableHash(java.util.Hashtable)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
	} catch (java.lang.Throwable exception) {
	...
	try {
		try {
			...
			try {
				...
				aSetMethod = getBeanClass().getMethod("setTableHash", aSetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setTableHash", 1);
			};
