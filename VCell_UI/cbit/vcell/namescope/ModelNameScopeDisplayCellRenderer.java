 ...
 */
private String getExpressionString(Expression expression, NameScope nameScope) {
	String str = null;
	try {
		ScopedExpression scopedExp = new cbit.vcell.parser.ScopedExpression(expression, nameScope);
