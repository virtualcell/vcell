...
©*/
/**
 * The bean information class for cbit.vcell.solver.ode.gui.TimeBoundsPanel.
 */
public class TimeBoundsPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.solver.ode.gui.TimeBoundsPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the TimeBoundsPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.solver.ode.gui.TimeBoundsPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
