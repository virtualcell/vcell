...
©*/
/**
 * The bean information class for cbit.vcell.solver.ode.gui.MathOverridesPanel.
 */
public class MathOverridesPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
 * Gets the applyChanges() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor applyChangesMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the applyChanges() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("applyChanges", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "applyChanges", 0);
		};
		try {
		...
		/* aDescriptor.setDisplayName("applyChanges()"); */
		/* aDescriptor.setShortDescription("applyChanges()"); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.solver.ode.gui.MathOverridesPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the MathOverridesPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.solver.ode.gui.MathOverridesPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the revertChanges() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor revertChangesMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the revertChanges() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("revertChanges", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "revertChanges", 0);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptors[] = {};
		...
		/* aDescriptor.setDisplayName("revertChanges()"); */
		/* aDescriptor.setShortDescription("revertChanges()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
