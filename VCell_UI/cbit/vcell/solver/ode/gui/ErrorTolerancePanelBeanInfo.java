...
©*/
/**
 * The bean information class for cbit.vcell.solver.ode.gui.ErrorTolerancePanel.
 */
public class ErrorTolerancePanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.solver.ode.gui.ErrorTolerancePanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ErrorTolerancePanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.solver.ode.gui.ErrorTolerancePanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
