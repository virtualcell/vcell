...
©*/
/**
 * The bean information class for cbit.vcell.solver.ode.gui.MathOverridesTableCellRenderer.
 */
public class MathOverridesTableCellRendererBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.solver.ode.gui.MathOverridesTableCellRenderer.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the MathOverridesTableCellRendererBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.solver.ode.gui.MathOverridesTableCellRenderer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.PropertyDescriptor[] getPropertyDescriptors() {
	try {
		java.beans.PropertyDescriptor aDescriptorList[] = {
			...
			,mathOverridesTableModelPropertyDescriptor()
		};
		return aDescriptorList;
	} catch (java.lang.Throwable exception) {
		handleException(exception);
...
/**
 * Gets the mathOverridesTableModel property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor mathOverridesTableModelPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the mathOverridesTableModel property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getMathOverridesTableModel", aGetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getMathOverridesTableModel", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					cbit.vcell.solver.ode.gui.MathOverridesTableModel.class
				};
				aSetMethod = getBeanClass().getMethod("setMathOverridesTableModel", aSetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setMathOverridesTableModel", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("mathOverridesTableModel"
			, aGetMethod, aSetMethod);
		} catch (java.lang.Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("mathOverridesTableModel"); */
		/* aDescriptor.setShortDescription("mathOverridesTableModel"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
