...
/**
 * The bean information class for cbit.vcell.webparser.WebSiteParserPanel.
 */
public class WebSiteParserPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.webparser.WebSiteParserPanel.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.webparser.WebSiteParserPanel";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the WebSiteParserPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.webparser.WebSiteParserPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
