...
/**
 * The bean information class for cbit.vcell.client.data.Kymograph.
 */
public class KymographPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the draw(java.awt.Graphics) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor draw_javaawtGraphicsMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the draw(java.awt.Graphics) method descriptor. */
		...
		try {
			...
			aMethod = getBeanClass().getMethod("draw", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "draw", 1);
		};
		try {
		...
		/* aDescriptor.setDisplayName("draw(java.awt.Graphics)"); */
		/* aDescriptor.setShortDescription("draw(java.awt.Graphics)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.data.KymographPanel.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.client.data.Kymograph";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the KymographBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.data.KymographPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			draw_javaawtGraphicsMethodDescriptor()
...
/**
 * Gets the initTimeSeries(double[][], double[], java.lang.String) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor initTimeSeries_double_____double___javalangStringMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the initTimeSeries(double[][], double[], java.lang.String) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
			...
			aMethod = getBeanClass().getMethod("initTimeSeries", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "initTimeSeries", 3);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
			aParameterDescriptor1.setName("arg1");
			aParameterDescriptor1.setDisplayName("timeSeries");
			...
			aParameterDescriptor2.setDisplayName("accumDistances");
			...
			aParameterDescriptor3.setDisplayName("info");
			java.beans.ParameterDescriptor aParameterDescriptors[] = {
				aParameterDescriptor1,
		...
		/* aDescriptor.setDisplayName("initTimeSeries(double[][], double[], java.lang.String)"); */
		/* aDescriptor.setShortDescription("initTimeSeries(double[][], double[], java.lang.String)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
