...
/**
 * The bean information class for cbit.vcell.client.desktop.biomodel.GeometrySummaryViewer.
 */
public class GeometrySummaryViewerBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.desktop.geometry.GeometrySummaryViewer.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the GeometrySummaryViewerBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.desktop.geometry.GeometrySummaryViewer.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
