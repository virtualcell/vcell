...
/**
 * The bean information class for cbit.vcell.client.desktop.ACLEditor.
 */
public class ACLEditorBeanInfo extends java.beans.SimpleBeanInfo {
/**
 * Gets the ACLState property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor ACLStatePropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the ACLState property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getACLState", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getACLState", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					cbit.vcell.client.desktop.ACLEditor.ACLState.class
				};
				aSetMethod = getBeanClass().getMethod("setACLState", aSetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setACLState", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("ACLState"
		...
		/* aDescriptor.setDisplayName("ACLState"); */
		/* aDescriptor.setShortDescription("ACLState"); */
...
/**
 * Gets the getAclEditorPanel() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor getAclEditorPanelMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the getAclEditorPanel() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("getAclEditorPanel", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "getAclEditorPanel", 0);
		};
		try {
		...
		/* aDescriptor.setDisplayName("getAclEditorPanel()"); */
		/* aDescriptor.setShortDescription("getAclEditorPanel()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.desktop.ACLEditor.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.client.desktop.ACLEditor";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the ACLEditorBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.desktop.ACLEditor.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
