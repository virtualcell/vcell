...
/**
 * The bean information class for cbit.vcell.client.desktop.TestingFrameworkWindowPanel.
 */
public class TestingFrameworkWindowPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.desktop.TestingFrameworkWindowPanel.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the TestingFrameworkWindowPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.desktop.TestingFrameworkWindowPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
