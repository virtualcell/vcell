...
/**
 * The bean information class for cbit.vcell.client.desktop.DocumentWindowAboutBox.
 */
public class DocumentWindowAboutBoxBeanInfo extends java.beans.SimpleBeanInfo {
/**
 * Gets the buildNumber property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor buildNumberPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the buildNumber property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getBuildNumber", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getBuildNumber", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			aDescriptor = new java.beans.PropertyDescriptor("buildNumber"
		...
		/* aDescriptor.setDisplayName("buildNumber"); */
		/* aDescriptor.setShortDescription("buildNumber"); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.client.desktop.DocumentWindowAboutBox.class;
}
...
public static java.lang.String getBeanClassName() {
	return "cbit.vcell.client.desktop.DocumentWindowAboutBox";
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the DocumentWindowAboutBoxBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.client.desktop.DocumentWindowAboutBox.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the getBuildNumber() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor getBuildNumberMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the getBuildNumber() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("getBuildNumber", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "getBuildNumber", 0);
		};
		try {
		...
		/* aDescriptor.setDisplayName("getBuildNumber()"); */
		/* aDescriptor.setShortDescription("getBuildNumber()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
...
public java.beans.MethodDescriptor[] getMethodDescriptors() {
	try {
		java.beans.MethodDescriptor aDescriptorList[] = {
			getBuildNumberMethodDescriptor()
