...
public TMLPanel compareWithOther(final VCDocumentInfo docInfo1, final VCDocumentInfo docInfo2) {
	...
	try {
		...
		TMLPanel comparePanel = compareDocuments(document1, document2, XmlTreeDiff.COMPARE_DOCS_OTHER);
...
public TMLPanel compareWithSaved(VCDocument document) {
	...
	try {
		...
		TMLPanel comparePanel = compareDocuments(savedVersion, document, XmlTreeDiff.COMPARE_DOCS_SAVED);
