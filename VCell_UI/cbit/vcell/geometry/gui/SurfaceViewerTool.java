   ...
   getSurfaceCanvas().setBQuickRender(true);
	...
	switch(getCurrentManipulation()){
		...
		//trackball.pan_xy(oldx*pangain,oldy*pangain,newx*pangain,newy*pangain);
			...
			fieldSurfaceCanvas.setDisplacement(new Vect3d(oldTranslation.getX()+x-pick.x,oldTranslation.getY()+y-pick.y,oldTranslation.getZ()));
			break;
		}
	} // end switch
...
public void resetView() {
    ...
    fieldSurfaceCanvas.setDisplacement(new Vect3d(0.0,0.0,0.0));
