 ...
 */
public static cbit.vcell.export.gui.ExportSettingsListener add(cbit.vcell.export.gui.ExportSettingsListener a, cbit.vcell.export.gui.ExportSettingsListener b) {
	return (cbit.vcell.export.gui.ExportSettingsListener)addInternal(a, b);
}
/**
 * Add new listener to support multicast events.
 ...
 */
public static cbit.vcell.export.gui.ExportSettingsListener remove(cbit.vcell.export.gui.ExportSettingsListener l, cbit.vcell.export.gui.ExportSettingsListener oldl) {
	if (l == oldl || l == null)
		return null;
	if(l instanceof ExportSettingsListenerEventMulticaster)
		return (cbit.vcell.export.gui.ExportSettingsListener)((cbit.vcell.export.gui.ExportSettingsListenerEventMulticaster) l).remove(oldl);
	return l;
}
/**
 * 
...
public void SettingsOK_ActionPerformed(java.util.EventObject newEvent) {
	((cbit.vcell.export.gui.ExportSettingsListener)a).SettingsOK_ActionPerformed(newEvent);
	((cbit.vcell.export.gui.ExportSettingsListener)b).SettingsOK_ActionPerformed(newEvent);
}
}
