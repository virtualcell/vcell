...
/**
 * The bean information class for cbit.vcell.mapping.gui.ElectricalStimulusParameterTableModel.
 */
public class ElectricalStimulusParameterTableModelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the electricalStimulus property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor electricalStimulusPropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the electricalStimulus property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getElectricalStimulus", aGetMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getElectricalStimulus", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				...
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setElectricalStimulus", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("electricalStimulus"
			, aGetMethod, aSetMethod);
		} catch (Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("electricalStimulus"); */
		/* aDescriptor.setShortDescription("electricalStimulus"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.mapping.gui.ElectricalStimulusParameterTableModel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ElectricalStimulusParameterTableModelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.mapping.gui.ElectricalStimulusParameterTableModel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.PropertyDescriptor[] getPropertyDescriptors() {
	try {
		java.beans.PropertyDescriptor aDescriptorList[] = {
			...
			,electricalStimulusPropertyDescriptor()
