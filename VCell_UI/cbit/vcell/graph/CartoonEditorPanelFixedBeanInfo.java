...
/**
 * The bean information class for cbit.vcell.graph.CartoonEditorPanelFixed.
 */
public class CartoonEditorPanelFixedBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.graph.CartoonEditorPanelFixed.class;
}
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the CartoonEditorPanelFixedBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.graph.CartoonEditorPanelFixed.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
