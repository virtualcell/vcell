...
©*/
/**
 * The bean information class for cbit.vcell.graph.ReactionCartoonEditorPanel.
 */
public class ReactionCartoonEditorPanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.vcell.graph.ReactionCartoonEditorPanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the ReactionCartoonEditorPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.vcell.graph.ReactionCartoonEditorPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the getCartoonThis() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor getCartoonThisMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the getCartoonThis() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("getCartoonThis", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "getCartoonThis", 0);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptors[] = {};
		...
		/* aDescriptor.setDisplayName("getCartoonThis()"); */
		/* aDescriptor.setShortDescription("getCartoonThis()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the init(cbit.vcell.model.Model, cbit.vcell.model.Structure) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor init_cbitvcellmodelModel_cbitvcellmodelStructureMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the init(cbit.vcell.model.Model, cbit.vcell.model.Structure) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
		...
		/* aDescriptor.setDisplayName("init(cbit.vcell.model.Model, cbit.vcell.model.Structure)"); */
		/* aDescriptor.setShortDescription("init(cbit.vcell.model.Model, cbit.vcell.model.Structure)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
	} catch (java.lang.Throwable exception) {
...
/**
 * Gets the setCartoonThis(cbit.vcell.graph.ReactionCartoon) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor setCartoonThis_cbitvcellgraphReactionCartoonMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the setCartoonThis(cbit.vcell.graph.ReactionCartoon) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
			...
			aMethod = getBeanClass().getMethod("setCartoonThis", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "setCartoonThis", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
		...
		/* aDescriptor.setDisplayName("setCartoonThis(cbit.vcell.graph.ReactionCartoon)"); */
		/* aDescriptor.setShortDescription("setCartoonThis(cbit.vcell.graph.ReactionCartoon)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
	} catch (java.lang.Throwable exception) {
