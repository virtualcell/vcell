...
©*/
/**
 * The bean information class for cbit.image.DisplayAdapterServicePanel.
 */
public class DisplayAdapterServicePanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return cbit.image.gui.DisplayAdapterServicePanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the DisplayAdapterServicePanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(cbit.image.gui.DisplayAdapterServicePanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
