...
public java.beans.MethodDescriptor addZoomListener_cbitimageZoomListenerMethodDescriptor() {
	...
	try {
		...
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.image.gui.ZoomListener.class
			};
	...
	try {
		try {
			...
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aSetMethodParameterTypes[] = {
					cbit.vcell.geometry.DrawPaneModel.class
				};
...
public static java.lang.Class getBeanClass() {
	return cbit.image.gui.ImagePaneView.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		...
		aDescriptor = new java.beans.BeanDescriptor(cbit.image.gui.ImagePaneView.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.MethodDescriptor panpanning_cbitimagePanEventMethodEventDescriptor() {
	...
	try {
		...
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.image.gui.PanEvent.class
			};
			aMethod = (PanListener.class).getMethod("panning", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((PanListener.class), "panning", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
...
public java.beans.MethodDescriptor zoomzooming_cbitimageZoomEventMethodEventDescriptor() {
	...
	try {
		...
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
				cbit.image.gui.ZoomEvent.class
			};
			aMethod = (cbit.image.gui.ZoomListener.class).getMethod("zooming", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((cbit.image.gui.ZoomListener.class), "zooming", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
