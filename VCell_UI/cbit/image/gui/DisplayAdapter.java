...
public abstract class DisplayAdapter {
	...
	public final static int MAX_VALID_PIXEL		= 249;
	
	public final static int PIXEL_BELOW_MIN		= 250; 
	public final static int PIXEL_ABOVE_MAX		= 251;
	public final static int PIXEL_NEGATIVE		= 252;
	public final static int PIXEL_NO_RANGE		= 253;
	public final static int PIXEL_NAN			= 254;
	public final static int PIXEL_NOT_DEFINED	= 255;
